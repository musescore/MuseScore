...
//      _articulationAnchor[int(ArticulationType::Espressivo)]      = ArticulationAnchor::CHORD;
      ...
      _articulationAnchor[int(ArticulationType::FadeIn)]          = ArticulationAnchor::TOP_STAFF;
      _articulationAnchor[int(ArticulationType::FadeOut)]         = ArticulationAnchor::TOP_STAFF;
      _articulationAnchor[int(ArticulationType::VolumeSwell)]     = ArticulationAnchor::TOP_STAFF;
      _articulationAnchor[int(ArticulationType::WiggleSawtooth)]  = ArticulationAnchor::TOP_STAFF;
      _articulationAnchor[int(ArticulationType::WiggleSawtoothWide)]        = ArticulationAnchor::TOP_STAFF;
      _articulationAnchor[int(ArticulationType::WiggleVibratoLargeFaster)]  = ArticulationAnchor::TOP_STAFF;
      _articulationAnchor[int(ArticulationType::WiggleVibratoLargeSlowest)] = ArticulationAnchor::TOP_STAFF;
