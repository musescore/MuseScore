...
static const StyleType styleTypes[] {
    ...
    { Sid::lyricsMelismaAlign, "lyricsMelismaAlign", QVariant::fromValue(
    ...
    { Sid::lyricsOddAlign, "lyricsOddAlign",
      QVariant::fromValue(Align::HCENTER | Align::BASELINE) },
    ...
    { Sid::lyricsEvenAlign, "lyricsEvenAlign",
      QVariant::fromValue(Align::HCENTER | Align::BASELINE) },
...
// { Sid::figuredBassFontSize,     "figuredBassFontSize",     QVariant(8.0) },
    ...
    { Sid::articulationAnchorLuteFingering, "articulationAnchorLuteFingering",
      int(ArticulationAnchor::BOTTOM_CHORD) },
    ...
    { Sid::hairpinTextAlign, "hairpinTextAlign",
      QVariant::fromValue(Align::LEFT | Align::BASELINE) },
    ...
    { Sid::chordSymbolAAlign, "chordSymbolAAlign",
      QVariant::fromValue(Align::LEFT | Align::BASELINE) },
    ...
    { Sid::chordSymbolBAlign, "chordSymbolBAlign",
      QVariant::fromValue(Align::LEFT | Align::BASELINE) },
    ...
    { Sid::romanNumeralAlign, "romanNumeralAlign",
      QVariant::fromValue(Align::LEFT | Align::BASELINE) },
    ...
    { Sid::ottava15MAContinueText, "ottava15MAContinueText",
      QString("<sym>quindicesimaAlta</sym>") },
    { Sid::ottava15MBText, "ottava15MBText", QString("<sym>quindicesimaBassa</sym>") },
    { Sid::ottava15MBContinueText, "ottava15MBContinueText",
      QString("<sym>quindicesimaBassa</sym>") },
    { Sid::ottava22MAText, "ottava22MAText", QString("<sym>ventiduesimaAlta</sym>") },
    { Sid::ottava22MAContinueText, "ottava22MAContinueText",
      QString("<sym>ventiduesimaAlta</sym>") },
    { Sid::ottava22MBText, "ottava22MBText", QString("<sym>ventiduesimaBassa</sym>") },
    { Sid::ottava22MBContinueText, "ottava22MBContinueText",
      QString("<sym>ventiduesimaBassa</sym>") },
    ...
    { Sid::ottava15MAnoContinueText, "ottava15MAnoContinueText",
      QString("<sym>quindicesima</sym>") },
    { Sid::ottava15MBnoText, "ottava15MBnoText", QString("<sym>quindicesima</sym>") },
    { Sid::ottava15MBnoContinueText, "ottava15MBnoContinueText",
      QString("<sym>quindicesima</sym>") },
    { Sid::ottava22MAnoText, "ottava22MAnoText", QString("<sym>ventiduesima</sym>") },
    { Sid::ottava22MAnoContinueText, "ottava22MAnoContinueText",
      QString("<sym>ventiduesima</sym>") },
    { Sid::ottava22MBnoText, "ottava22MBnoText", QString("<sym>ventiduesima</sym>") },
    { Sid::ottava22MBnoContinueText, "ottava22MBnoContinueText",
      QString("<sym>ventiduesima</sym>") },
    ...
    { Sid::autoplaceVerticalAlignRange, "autoplaceVerticalAlignRange",
      int(VerticalAlignRange::SYSTEM) },
    ...
    { Sid::lhGuitarFingeringFrameBgColor, "lhGuitarFingeringFrameBgColor",
    ...
    { Sid::rhGuitarFingeringFrameBgColor, "rhGuitarFingeringFrameBgColor",
      QColor(255, 255, 255, 0) },
    ...
    { Sid::repeatRightAlign, "repeatRightAlign",
      QVariant::fromValue(Align::RIGHT | Align::BASELINE) },
    ...
    { Sid::textLineTextAlign, "textLineTextAlign",
    ...
    { Sid::letRingTextAlign, "letRingTextAlign",
      QVariant::fromValue(Align::LEFT | Align::VCENTER) },
    ...
    { Sid::palmMuteTextAlign, "palmMuteTextAlign",
      QVariant::fromValue(Align::LEFT | Align::VCENTER) },
...
static constexpr std::array<TextStyleName, int(Tid::TEXT_STYLES)> textStyles { {
    ...
    { QT_TRANSLATE_NOOP("TextStyle", "Instrument Name (Long)"), &longInstrumentTextStyle,
      Tid::INSTRUMENT_LONG },
    { QT_TRANSLATE_NOOP("TextStyle", "Instrument Name (Short)"), &shortInstrumentTextStyle,
      Tid::INSTRUMENT_SHORT },
    { QT_TRANSLATE_NOOP("TextStyle", "Instrument Name (Part)"), &partInstrumentTextStyle,
    ...
    { QT_TRANSLATE_NOOP("TextStyle", "Measure Number"), &measureNumberTextStyle,
      Tid::MEASURE_NUMBER },
    ...
    { QT_TRANSLATE_NOOP("TextStyle", "Chord Symbol (Alternate)"), &chordSymbolTextStyleB,
      Tid::HARMONY_B },
    { QT_TRANSLATE_NOOP("TextStyle", "Roman Numeral Analysis"), &romanNumeralTextStyle,
      Tid::HARMONY_ROMAN },
    { QT_TRANSLATE_NOOP("TextStyle", "Nashville Number"), &nashvilleNumberTextStyle,
      Tid::HARMONY_NASHVILLE },
    { QT_TRANSLATE_NOOP("TextStyle", "Rehearsal Mark"), &rehearsalMarkTextStyle,
      Tid::REHEARSAL_MARK },

    { QT_TRANSLATE_NOOP("TextStyle", "Repeat Text Left"), &repeatLeftTextStyle, Tid::REPEAT_LEFT },
    { QT_TRANSLATE_NOOP("TextStyle", "Repeat Text Right"), &repeatRightTextStyle,
      Tid::REPEAT_RIGHT },
    ...
    { QT_TRANSLATE_NOOP("TextStyle", "Instrument Change"), &instrumentChangeTextStyle,
...
void MStyle::load(XmlReader& e)
{
    ...
    if (newChordDescriptionFile != oldChordDescriptionFile && !chordListTag) {
        if (!newChordDescriptionFile.startsWith("chords_")
            && value(Sid::chordStyle).toString() == "std") {
...
{
    for (const StyleType& st : styleTypes)
        score->undo(new ChangeStyleVal(score, st.styleIdx(),
                                       MScore::defaultStyle().value(st.styleIdx())));
}
