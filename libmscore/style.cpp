...
// User styles
      { QT_TRANSLATE_NOOP("TextStyle", "Album Front Title"),       &albumFrontTitleTextStyle,     Tid::ALBUM_FRONT_TITLE },
      { QT_TRANSLATE_NOOP("TextStyle", "Album Front Composer"),    &albumFrontComposerTextStyle,  Tid::ALBUM_FRONT_COMPOSER },
      { QT_TRANSLATE_NOOP("TextStyle", "Album Front Lyricist"),    &albumFrontLyricistTextStyle,  Tid::ALBUM_FRONT_LYRICIST },
      { QT_TRANSLATE_NOOP("TextStyle", "Album Contents Title"),    &albumContentsTitleTextStyle,  Tid::ALBUM_CONTENTS_TITLE },
      { QT_TRANSLATE_NOOP("TextStyle", "Album Contents Text"),     &albumContentsTextTextStyle,   Tid::ALBUM_CONTENTS_TEXT },
