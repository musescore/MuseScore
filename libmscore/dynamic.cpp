...
static Dyn dynList[] = {
    ...
    {  112, true, "sfz", "<sym>dynamicSforzando</sym><sym>dynamicForte</sym><sym>dynamicZ</sym>",
       -18 },
    {  126, true, "sff",
       "<sym>dynamicSforzando</sym><sym>dynamicForte</sym><sym>dynamicForte</sym>", -18 },
    {  126, true, "sffz",
       "<sym>dynamicSforzando</sym><sym>dynamicForte</sym><sym>dynamicForte</sym><sym>dynamicZ</sym>",
       -18 },
    {  112, true, "sfp",
       "<sym>dynamicSforzando</sym><sym>dynamicForte</sym><sym>dynamicPiano</sym>", -47 },
    {  112, true, "sfpp",
       "<sym>dynamicSforzando</sym><sym>dynamicForte</sym><sym>dynamicPiano</sym><sym>dynamicPiano</sym>",
       -79 },
    {  112, true, "rfz", "<sym>dynamicRinforzando</sym><sym>dynamicForte</sym><sym>dynamicZ</sym>",
       -18 },
...
{
    return _changeInVelocity
           >= 128 ? dynList[int(dynamicType())].changeInVelocity : _changeInVelocity;
}
...
Fraction Dynamic::velocityChangeLength() const
{
    ...
    double ratio = double(score()->tempomap()->tempo(segment()->tick().ticks()))
                   / double(Score::defaultTempo());
    double speedMult;
