...
public:
    ...
    TimeSig* clone() const override
    {
        return new TimeSig(*this);
    }
    ...
    int numerator() const
    {
        return _sig.numerator();
    }

    int denominator() const
    {
        return _sig.denominator();
    }
    ...
    {
        return _stretch.numerator();
    }

    int denominatorStretch() const
    {
        return _stretch.denominator();
    }
    ...
    {
        return (_sig * _stretch).reduced();
    }

    void setGlobalSig(const Fraction& f)
    {
        _stretch = (_sig / f).reduced();
    }

    bool isLocal() const
    {
        return _stretch != Fraction(1, 1);
    }
