...
public:
    ...
    {
        return _createSystemHeader;
    }

    void setCreateSystemHeader(bool val)
    {
        _createSystemHeader = val;
    }
...
public:
    ...
    FBox* clone() const override
    {
        return new FBox(*this);
    }

    ElementType type() const override
    {
        return ElementType::FBOX;
    }
