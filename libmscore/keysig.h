...
public:
    ...
    KeySig* clone() const override
    {
        return new KeySig(*this);
    }
    ...
    {
        return parent() ? (Measure*)parent()->parent() : nullptr;
    }
    ...
    {
        _sig.setForInstrumentChange(forInstrumentChange);
    }

    bool forInstrumentChange() const
    {
        return _sig.forInstrumentChange();
    }
