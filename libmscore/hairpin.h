...
public:
    ...
    HairpinSegment* clone() const override
    {
        return new HairpinSegment(*this);
    }

    ElementType type() const override
    {
        return ElementType::HAIRPIN_SEGMENT;
    }
    ...
    std::unique_ptr<ElementGroup> getDragGroup(std::function<bool(const Element*)> isDragged)
    override;
};
...
public:
    ...
    Hairpin* clone() const override
    {
        return new Hairpin(*this);
    }
    ...
    ChangeMethod veloChangeMethod() const
    {
        return _veloChangeMethod;
    }

    void setVeloChangeMethod(ChangeMethod val)
    {
        _veloChangeMethod = val;
    }

    bool isCrescendo() const
    {
        return _hairpinType == HairpinType::CRESC_HAIRPIN
               || _hairpinType == HairpinType::CRESC_LINE;
    }

    bool isDecrescendo() const
    {
        return _hairpinType == HairpinType::DECRESC_HAIRPIN
               || _hairpinType == HairpinType::DECRESC_LINE;
    }
