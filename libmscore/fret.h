...
public:
    struct Barre {
        ...
        Barre(int s, int e) : startString(s),
            endString(e)
        {
        }
    ...
    struct Dot {
        ...
        Dot(int f, FretDotType t = FretDotType::NORMAL) : fret(f),
            dtype(t)
        {
        }
    ...
    struct Marker {
        ...
        bool exists() const
        {
            return mtype != FretMarkerType::NONE;
        }
    };
...
public:
    ...
    FretDiagram* clone() const override
    {
        return new FretDiagram(*this);
    }
    ...
    {
        return ElementType::FRET_DIAGRAM;
    }
