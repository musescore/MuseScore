...
public:
    ...
    {
        return _durationType.dots();
    }

    Fraction durationTypeTicks()
    {
        return _crossMeasure
               == CrossMeasure::FIRST ? _crossMeasureTDur.ticks() : _durationType.ticks();
    }
    ...
    {
        return _durationType == TDuration::DurationType::V_MEASURE;
    }
