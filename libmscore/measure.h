...
public:
    ...
    {
        return _segments.first(t);
    }

    Segment* firstEnabled() const
    {
        return _segments.first(ElementFlag::ENABLED);
    }
    ...
    Segment* searchSegment(qreal x, SegmentType st, int strack, int etrack,
    ...
    void setEndBarLineType(BarLineType val, int track, bool visible = true,
                           QColor color = QColor());
    ...
    {
        return _breakMultiMeasureRest;
    }

    void setBreakMultiMeasureRest(bool val)
    {
        _breakMultiMeasureRest = val;
    }
    ...
    {
        return _mmRestCount;
    }                                                           // number of measures _mmRest spans
