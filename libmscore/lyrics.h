...
public:
    ...
    {
        return QObject::tr("Verse %1").arg(_no + 1);
    }
...
public:
    ...
    LyricsLine* clone() const override
    {
        return new LyricsLine(*this);
    }

    ElementType type() const override
    {
        return ElementType::LYRICSLINE;
    }
...
public:
    ...
    LyricsLineSegment* clone() const override
    {
        return new LyricsLineSegment(*this);
    }

    ElementType type() const override
    {
        return ElementType::LYRICSLINE_SEGMENT;
    }
