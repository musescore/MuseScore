...
void Score::cmdSplitMeasure(ChordRest* cr)
      ...
      Measure* m2 = static_cast<Measure*>(insertMeasure(ElementType::MEASURE, measure->next(), true));
      Measure* m1 = static_cast<Measure*>(insertMeasure(ElementType::MEASURE, m2, true));
