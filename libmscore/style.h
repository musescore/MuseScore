...
//      figuredBassFontSize,
    ...
    albumFrontTitleFontFace,
    albumFrontTitleFontSize,
    albumFrontTitleFontSpatiumDependent,
    albumFrontTitleFontStyle,
    albumFrontTitleColor,
    albumFrontTitleAlign,
    albumFrontTitleOffset,
    albumFrontTitlePlacement,
    albumFrontTitlePosAbove,
    albumFrontTitlePosBelow,
    albumFrontTitleMinDistance,
    albumFrontTitleFrameType,
    albumFrontTitleFramePadding,
    albumFrontTitleFrameWidth,
    albumFrontTitleFrameRound,
    albumFrontTitleFrameFgColor,
    albumFrontTitleFrameBgColor,

    albumFrontComposerFontFace,
    albumFrontComposerFontSize,
    albumFrontComposerFontSpatiumDependent,
    albumFrontComposerFontStyle,
    albumFrontComposerColor,
    albumFrontComposerAlign,
    albumFrontComposerOffset,
    albumFrontComposerPlacement,
    albumFrontComposerPosAbove,
    albumFrontComposerPosBelow,
    albumFrontComposerMinDistance,
    albumFrontComposerFrameType,
    albumFrontComposerFramePadding,
    albumFrontComposerFrameWidth,
    albumFrontComposerFrameRound,
    albumFrontComposerFrameFgColor,
    albumFrontComposerFrameBgColor,

    albumFrontLyricistFontFace,
    albumFrontLyricistFontSize,
    albumFrontLyricistFontSpatiumDependent,
    albumFrontLyricistFontStyle,
    albumFrontLyricistColor,
    albumFrontLyricistAlign,
    albumFrontLyricistOffset,
    albumFrontLyricistPlacement,
    albumFrontLyricistPosAbove,
    albumFrontLyricistPosBelow,
    albumFrontLyricistMinDistance,
    albumFrontLyricistFrameType,
    albumFrontLyricistFramePadding,
    albumFrontLyricistFrameWidth,
    albumFrontLyricistFrameRound,
    albumFrontLyricistFrameFgColor,
    albumFrontLyricistFrameBgColor,

    albumContentsTitleFontFace,
    albumContentsTitleFontSize,
    albumContentsTitleFontSpatiumDependent,
    albumContentsTitleFontStyle,
    albumContentsTitleColor,
    albumContentsTitleAlign,
    albumContentsTitleOffset,
    albumContentsTitlePlacement,
    albumContentsTitlePosAbove,
    albumContentsTitlePosBelow,
    albumContentsTitleMinDistance,
    albumContentsTitleFrameType,
    albumContentsTitleFramePadding,
    albumContentsTitleFrameWidth,
    albumContentsTitleFrameRound,
    albumContentsTitleFrameFgColor,
    albumContentsTitleFrameBgColor,

    albumContentsTextFontFace,
    albumContentsTextFontSize,
    albumContentsTextFontSpatiumDependent,
    albumContentsTextFontStyle,
    albumContentsTextColor,
    albumContentsTextAlign,
    albumContentsTextOffset,
    albumContentsTextPlacement,
    albumContentsTextPosAbove,
    albumContentsTextPosBelow,
    albumContentsTextMinDistance,
    albumContentsTextFrameType,
    albumContentsTextFramePadding,
    albumContentsTextFrameWidth,
    albumContentsTextFrameRound,
    albumContentsTextFrameFgColor,
    albumContentsTextFrameBgColor,
