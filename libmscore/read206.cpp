...
static void readAccidental(Accidental* a, XmlReader& e)
      ...
      while (e.readNextStartElement()) {
            ...
            else if (a->Element::readProperties300old(e))
                  ;
            else
                  e.unknown();
            }
...
static void readAmbitus(Ambitus* ambitus, XmlReader& e)
      ...
      while (e.readNextStartElement()) {
            ...
            else if (ambitus->readProperties300old(e))
                  ;
            else
                  e.unknown();
            }
...
static void readNote(Note* note, XmlReader& e)
      ...
      while (e.readNextStartElement()) {
            ...
            else if (note->readProperties300old(e))
                  ;
            else
                  e.unknown();
            }
...
static void readText206(XmlReader& e, TextBase* t, Element* be)
      ...
      while (e.readNextStartElement()) {
            ...
            else if (!t->readProperties300old(e))
                  e.unknown();
            }
      }
...
static void readTuplet(Tuplet* tuplet, XmlReader& e)
      ...
      while (e.readNextStartElement()) {
            ...
            else if (!tuplet->readProperties300old(e))
                  e.unknown();
            }
            ...
            if (tag == "Note") {
                  ...
                  while (e.readNextStartElement()) {
                        ...
                        if (tag == "subtype")        // obsolete
                              e.skipCurrentElement();
                        else if (!stem->readProperties300old(e))
                              e.unknown();
                        }
                  chord->add(stem);
                  }
            else if (chord->readProperties300old(e))
                  ;
            else
                  e.unknown();
            }
...
static bool readTextLineProperties(XmlReader& e, TextLineBase* tl)
      ...
      else if (tl->readProperties300old(e))
            return true;
      return true;
      }
...
static void readTrill(XmlReader& e, Trill* t)
      ...
      while (e.readNextStartElement()) {
            ...
            else if (!t->SLine::readProperties300old(e))
                  e.unknown();
            }
      }
...
static void readRest(Rest* rest, XmlReader& e)
      ...
      while (e.readNextStartElement()) {
            ...
            else if (rest->readProperties300old(e))
                  ;
            else
                  e.unknown();
            }
      ...
      while (e.readNextStartElement()) {
            ...
            if (tag == "move")
                  ...
                  while (e.readNextStartElement()) {
                        ...
                        else if (!bl->Element::readProperties300old(e))
                              e.unknown();
                        }
                  //
            ...
            // Annotation
                  ...
                  while (e.readNextStartElement()) {
                        ...
                        if (tag == "foregroundColor")
                              e.skipCurrentElement();
                        else if (!el->readProperties300old(e))
                              e.unknown();
                        }
            ...
            else if (m->MeasureBase::readProperties300old(e))
                  ;
            else
                  e.unknown();
            }
...
static void readBox(Box* b, XmlReader& e)
      ...
      while (e.readNextStartElement()) {
            ...
            else if (!b->readProperties300old(e))
                  e.unknown();
            }
                ...
                || (tag == "Pedal")) {
                  ...
                  if (MScore::noExcerpts)
                        ...
                        if (score->isMaster()) {
                              ...
                              qDebug("Score::read300old(): part cannot have parts");
                              e.skipCurrentElement();
                              }
                        }
                  }
