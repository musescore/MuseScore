...
struct SymElement {
    SymId sym;
    qreal x;
    SymElement(SymId _sym, qreal _x) : sym(_sym),
        x(_x)
    {
    }
};
...
public:
    ...
    Accidental* clone() const override
    {
        return new Accidental(*this);
    }
