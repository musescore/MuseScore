...
bool JianpuNote::readProperties(XmlReader& xml)
      ...
      if (tag == "pitch")
            ...
            setProperty(P_ID::MIRROR_HEAD, Ms::getProperty(P_ID::MIRROR_HEAD, xml));
      else if (tag == "dotPosition")
            setProperty(P_ID::DOT_POSITION, Ms::getProperty(P_ID::DOT_POSITION, xml));
      else if (tag == "fixed")
            setFixed(xml.readBool());
      else if (tag == "fixedLine")
            setFixedLine(xml.readInt());
      else if (tag == "head")
            setProperty(P_ID::HEAD_GROUP, Ms::getProperty(P_ID::HEAD_GROUP, xml));
            ...
            setProperty(P_ID::HEAD_TYPE, Ms::getProperty(P_ID::HEAD_TYPE, xml));
      else if (tag == "veloType")
            setProperty(P_ID::VELO_TYPE, Ms::getProperty(P_ID::VELO_TYPE, xml));
      else if (tag == "line")
            _line = xml.readInt();
