...
bool OttavaSegment::propertyIsStyled(P_ID id) const
      {
      switch (id) {
            case P_OTTAVA_TYPE:
                  return false;
...
bool Ottava::propertyIsStyled(P_ID id) const
      {
      switch (id) {
            case P_OTTAVA_TYPE:
                  return false;
