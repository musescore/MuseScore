...
public:
    ...
    {
        return lnhash.value(s, SymId::noSym);
    }                                                                                          // return noSym if not found

    static SymId oldName2id(const QString s)
    {
        return lonhash.value(s, SymId::noSym);
    }
    ...
    {
        return qApp->translate("symUserNames", symUserNames[int(id)]);
    }
...
public:
    ...
    void draw(const std::vector<SymId>&, QPainter*, qreal mag, const QPointF& pos,
              qreal scale) const;
    void draw(const std::vector<SymId>&, QPainter*, const QSizeF& mag, const QPointF& pos,
              qreal scale) const;
