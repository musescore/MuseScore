...
public:
    ...
    {
        return static_cast<int>(_tremoloType);
    }
    ...
    bool twoNotes() const
    {
        return tremoloType() >= TremoloType::C8;
    }                                                                    // is it a two note tremolo?
    ...
    TremoloPlacement tremoloPlacement() const
    {
        return _tremoloPlacement;
    }

    void setTremoloPlacement(TremoloPlacement v)
    {
        _tremoloPlacement = v;
    }

    TremoloStrokeStyle strokeStyle() const
    {
        return _strokeStyle;
    }

    void setStrokeStyle(TremoloStrokeStyle v)
    {
        _strokeStyle = v;
    }
