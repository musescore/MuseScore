...
class TieSegment final : public SlurTieSegment
{
    ...
    {
        setAutoAdjust(QPointF(x, y));
    }

    QPointF getAutoAdjust() const
    {
        return autoAdjustOffset;
    }
...
public:
    ...
    TieSegment* clone() const override
    {
        return new TieSegment(*this);
    }

    ElementType type() const override
    {
        return ElementType::TIE_SEGMENT;
    }

    int subtype() const override
    {
        return static_cast<int>(spanner()->type());
    }
...
public:
    ...
    {
        return toTieSegment(Spanner::frontSegment());
    }
    ...
    {
        return toTieSegment(Spanner::backSegment());
    }
    ...
    {
        return toTieSegment(Spanner::segmentAt(n));
    }
