...
{
    int _embelType;
    void drawGraceNote(QPainter*, const BEDrawingDataX&, const BEDrawingDataY&, SymId,
                       const qreal x, const bool drawFlag) const;

public:
    BagpipeEmbellishment(Score* s) : Element(s),
        _embelType(0)
    {
    }

    BagpipeEmbellishment* clone() const override
    {
        return new BagpipeEmbellishment(*this);
    }

    ElementType type() const override
    {
        return ElementType::BAGPIPE_EMBELLISHMENT;
    }
