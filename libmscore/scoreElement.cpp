...
static const ElementName elementNames[] = {
      ...
      { ElementType::SYSTEM_TEXTLINE_SEGMENT, "SystemTextLineSegment", QT_TRANSLATE_NOOP("elementName", "Text Line Segment") },
      ...
      { ElementType::SYSTEM_TEXTLINE,         "SystemTextLine",        QT_TRANSLATE_NOOP("elementName", "System Text Line") },
...
bool ScoreElement::isSLineSegment() const
      ...
      return isHairpinSegment() || isOttavaSegment() || isPedalSegment()
         || isTrillSegment() || isVoltaSegment() || isTextLineSegment() || isSystemTextLineSegment()
