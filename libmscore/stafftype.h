...
#define STAFFTYPE_TAB_SLASH_2STARTY_UP     ((STAFFTYPE_TAB_DEFAULTSTEMLEN_UP \
                                             -STAFFTYPE_TAB_SLASH_2TOTHEIGHT)*0.5)
// the initial Y coord for a double shash on an DN stem = topmost corner of topmost slash
#define STAFFTYPE_TAB_SLASH_2STARTY_DN     ((STAFFTYPE_TAB_DEFAULTSTEMLEN_UP \
                                             +STAFFTYPE_TAB_SLASH_2TOTHEIGHT)*0.5)
// same for a 4-ple slash
#define STAFFTYPE_TAB_SLASH_4TOTHEIGHT     (STAFFTYPE_TAB_SLASH_THICK+STAFFTYPE_TAB_SLASH_DISPL*3 \
                                            +STAFFTYPE_TAB_SLASH_SLANTY)
// the initial Y coord for a double shash on an UP stem = topmost corner of topmost slash
#define STAFFTYPE_TAB_SLASH_4STARTY_UP     ((STAFFTYPE_TAB_DEFAULTSTEMLEN_UP \
                                             -STAFFTYPE_TAB_SLASH_4TOTHEIGHT)*0.5)
// the initial Y coord for a double shash on an DN stem = topmost corner of topmost slash
#define STAFFTYPE_TAB_SLASH_4STARTY_DN     ((STAFFTYPE_TAB_DEFAULTSTEMLEN_UP \
                                             +STAFFTYPE_TAB_SLASH_4TOTHEIGHT)*0.5)
...
public:
    StaffType();
    StaffType(StaffGroup sg, const QString& xml, const QString& name, int lines, int stpOff,
              qreal lineDist, bool genClef, bool showBarLines, bool stemless, bool genTimeSig,
    ...
    void setNoteHeadScheme(NoteHead::Scheme s)
    {
        _noteHeadScheme = s;
    }

    NoteHead::Scheme noteHeadScheme() const
    {
        return _noteHeadScheme;
    }
    ...
    {
        return _durationFontSize;
    }

    qreal durationFontUserY() const
    {
        return _durationFontUserY;
    }
    ...
    {
        return _lineDistance.val() * SPATIUM20;
    }

    qreal fretMaskY() const
    {
        return (_onLines ? -0.5 : -1.0) * _lineDistance.val() * SPATIUM20;
    }
    ...
    {
        return _fretFontSize;
    }

    qreal fretFontUserY() const
    {
        return _fretFontUserY;
    }
    ...
    {
        return _genDurations;
    }

    bool  linesThrough() const
    {
        return _linesThrough;
    }
    ...
    {
        return STAFFTYPE_TAB_DEFAULTSTEMPOSX;
    }
    ...
    {
        return _group == StaffGroup::TAB;
    }

    bool isDrumStaff() const
    {
        return _group == StaffGroup::PERCUSSION;
    }

    // static functions for font config files
    static QList<QString> fontNames(bool bDuration);
    static bool fontData(bool bDuration, int nIdx, QString* pFamily, QString* pDisplayName,
...
public:
    ...
    TabDurationSymbol* clone() const override
    {
        return new TabDurationSymbol(*this);
    }
    ...
    {
        return ElementType::TAB_DURATION_SYMBOL;
    }
