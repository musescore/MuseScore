...
public:
    ...
    ChordLine* clone() const override
    {
        return new ChordLine(*this);
    }

    ElementType type() const override
    {
        return ElementType::CHORDLINE;
    }

    void setChordLineType(ChordLineType);
    ChordLineType chordLineType() const
    {
        return _chordLineType;
    }
    ...
    void setLengthX(qreal length)
    {
        _lengthX = length;
    }

    void setLengthY(qreal length)
    {
        _lengthY = length;
    }
    ...
    {
        return Element::EditBehavior::Edit;
    }
    ...
    {
        return Grip(gripsCount() - 1);
    }

    Grip defaultGrip() const override
    {
        return initialEditModeGrip();
    }
