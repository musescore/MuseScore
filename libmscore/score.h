...
class Score : public QObject, public ScoreElement {
   ...
   private:
      ...
      void moveICWarning(Part* part, Segment* currentSeg);
   ...
   public:
      ...
      void undoChangeClef(Staff* ostaff, Element*, ClefType st, bool forInstrumentChange = false, QPointF offset = QPointF());
