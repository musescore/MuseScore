...
struct instrString {
    ...
    {
        return d.pitch == pitch && d.open == open;
    }
};
...
// int         _frets = 19;
    ...
    void        sortChordNotes(QMap<int, Note*>& sortedNotes, const Chord* chord, int pitchOffset,
                               int* count) const;
...
public:
    ...
    {
        return d._frets == _frets && d.stringTable == stringTable;
    }
};
}     // namespace Ms
#endif
