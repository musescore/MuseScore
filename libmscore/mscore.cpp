...
std::vector<MScoreError> MScore::errorList {
    ...
    { CANNOT_INSERT_TUPLET, "t1",
      QT_TRANSLATE_NOOP("error",
                        "Cannot insert chord/rest in tuplet")                                    },
    { CANNOT_SPLIT_TUPLET, "t2",
      QT_TRANSLATE_NOOP("error",
                        "Cannot split tuplet")                                                   },
    ...
    { NO_DEST, "p1",
      QT_TRANSLATE_NOOP("error",
                        "No destination to paste")                                               },
    { DEST_TUPLET, "p2",
      QT_TRANSLATE_NOOP("error",
                        "Cannot paste into tuplet")                                              },
    { TUPLET_CROSSES_BAR, "p3",
      QT_TRANSLATE_NOOP("error",
                        "Tuplet cannot cross barlines")                                          },
    { DEST_LOCAL_TIME_SIGNATURE, "p4", QT_TRANSLATE_NOOP("error",
                                                         "Cannot paste in local time signature")                                  },
    { DEST_TREMOLO, "p5",
      QT_TRANSLATE_NOOP("error",
                        "Cannot paste in tremolo")                                               },
    { NO_MIME, "p6",
      QT_TRANSLATE_NOOP("error",
                        "Nothing to paste")                                                      },
    { DEST_NO_CR, "p7",
      QT_TRANSLATE_NOOP("error",
                        "Destination is not a chord or rest")                                    },
...
QString toUserString(Direction val)
{
    switch (val) {
    case Direction::AUTO: {
        return qApp->translate("Direction", "Auto");
    }
    case Direction::UP: {
        return qApp->translate("Direction", "Up");
    }
