...
public:
    ...
    SlurSegment* clone() const override
    {
...
public:
    ...
    Slur* clone() const override
    {
        return new Slur(*this);
    }
    ...
    {
        return toSlurSegment(Spanner::frontSegment());
    }
    ...
    {
        return toSlurSegment(Spanner::backSegment());
    }
    ...
    {
        return toSlurSegment(Spanner::segmentAt(n));
    }
