...
public:
    ...
    NoteHead* clone() const override
    {
        return new NoteHead(*this);
    }
...
public:
    ...
    Note* lastTiedNote()
    {
        return const_cast<Note*>(static_cast<const Note*>(this)->lastTiedNote());
    }
    ...
    static SymId noteHead(int direction, NoteHead::Group, NoteHead::Type, int tpc, Key key,
                          NoteHead::Scheme scheme);
