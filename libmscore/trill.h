...
protected:
public:
    TrillSegment(Spanner* sp, Score* s) : LineSegment(sp, s,
    ...
    TrillSegment* clone() const override
    {
        return new TrillSegment(*this);
    }
...
public:
    ...
    Trill* clone() const override
    {
        return new Trill(*this);
    }
