...
static const PropertyData propertyList[] = {
      ...
      { P_TIMESIG_ACTUAL,      true,  0,               T_FRACTION },
      ...
      { P_BREAK_MMR,           false, "breakMultiMeasureRest", T_BOOL },
      { P_REPEAT_COUNT,        true,  "endRepeat",       T_INT  },
      { P_USER_STRETCH,        false, "stretch",         T_REAL },
      { P_NO_OFFSET,           false, "noOffset",        T_INT  },
      { P_IRREGULAR,           true,  "irregular",       T_BOOL },
