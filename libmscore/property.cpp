...
static const PropertyData propertyList[] = {
      ...
      { P_ID::BARLINE_TYPE,            false, "subtype",               P_TYPE::BARLINE_TYPE    },
      { P_ID::BARLINE_SPAN,            false, "span",                  P_TYPE::BOOL            },
      { P_ID::BARLINE_SPAN_FROM,       false, "spanFromOffset",        P_TYPE::INT             },
      { P_ID::BARLINE_SPAN_TO,         false, "spanToOffset",          P_TYPE::INT             },
      ...
      { P_ID::STAFF_YOFFSET,           false, "",                      P_TYPE::SPATIUM         },
      { P_ID::STAFF_USERDIST,          false, "distOffset",            P_TYPE::SP_REAL         },
      { P_ID::STAFF_BARLINE_SPAN,      false, "barLineSpan",           P_TYPE::BOOL            },
