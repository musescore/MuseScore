...
#undef CONVERT
    ...
    {
        return isChordRest() || isTuplet();
    }

    bool isSlurTieSegment() const
    {
        return isSlurSegment() || isTieSegment();
    }
...
{
    Q_ASSERT(
        e == 0 || e->type() == ElementType::SLUR_SEGMENT
        || e->type() == ElementType::TIE_SEGMENT);
...
#define CONVERT(a)  \
    static inline a* to ## a(ScoreElement* e)             { Q_ASSERT(e == 0 || e->is ## a()); \
                                                            return (a*)e; } \
    static inline const a* to ## a(const ScoreElement* e) { Q_ASSERT(e == 0 || e->is ## a()); \
                                                            return (const a*)e; }
