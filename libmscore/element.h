 ...
 */
      ...
      void drawSymbols(const std::vector<std::pair<SymId, QPointF>>&, QPainter* p, const QPointF& o = QPointF(), qreal scale = 1.0) const;
      void drawSymbols(const std::vector<std::pair<SymId, QPointF>>&, QPainter* p, const QPointF& o, const QSizeF& scale) const;
