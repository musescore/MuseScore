...
///
//    @W Element
//    @P type     int                     Numeric type of element.
//    @P name     QString                 Human readable type of element
//    @P tick     int                     Midi tick position (read only)
//    @P readProperties array[QString]    List of properties names accessible using get
//    @P writeProperties array[QString]   List of properties names accessible using set
//    @P color    color                   Color of element
//    @P track    int                     the track the elment belongs to
//    @P selected bool                    element is selected
//    @P generated bool                   true if the element has been generated by layout
//    @P pos       point                  position relative to parent
//    @P placement int                    Placement in relaction to staff. Ms.ABOVE,.BELOW
//    @S track, generated, color, visible, selected, user_off, placement, autoplace, z, system_flag
//-------------------------------------------------------------------
...
class ElementW : public QObject {
   ...
   public:
      ...
      virtual int track();
      virtual void setTrack(int t);
      virtual bool selected();
      virtual void setSelected(bool v);
      virtual bool generated() {return get("generated").toBool();}
      virtual void setGenerated(bool v) {set("generated",v);}
      virtual QPointF pos();
      void setPos(const QPointF& p);
      virtual int placement() {return get("placement").toInt();}
      virtual void setPlacement(int v) {set("placement",v);}
      static ElementW* buildWrapper(ScoreElement* _e);
      };
//@E end of help parsing.
