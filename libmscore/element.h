...
public:
    ...
    bool isStartEndGrip()
    {
        return curGrip == Grip::START || curGrip == Grip::END;
    }
};
...
public:
    ...
    inline bool flag(ElementFlag f) const
    {
        return _flags & f;
    }
    ...
    bool visible() const
    {
        return !flag(ElementFlag::INVISIBLE);
    }
    ...
    {
        setFlag(ElementFlag::SIZE_SPATIUM_DEPENDENT, !v);
    }

    Placement placement() const
    {
        return Placement(!flag(ElementFlag::PLACE_ABOVE));
    }

    void setPlacement(Placement val)
    {
        setFlag(ElementFlag::PLACE_ABOVE, !bool(val));
    }
    ...
    virtual bool placeMultiple() const
    {
        return true;
    }
    ...
    {
        return flag(ElementFlag::GENERATED);
    }

    void setGenerated(bool val)
    {
        setFlag(ElementFlag::GENERATED, val);
    }
    ...
    QPointF mapFromCanvas(const QPointF& p) const
    {
        return p - canvasPos();
    }

    QPointF mapToCanvas(const QPointF& p) const
    {
        return p + canvasPos();
    }
...
// virtual ElementGroup getElementGroup() { return SingleElementGroup(this); }
    ...
    virtual QVector<QLineF> dragAnchorLines() const
    {
    ...
    virtual QVector<QLineF> gripAnchorLines(Grip) const
    {
        return QVector<QLineF>();
    }
    ...
    virtual std::vector<QPointF> gripsPositions(const EditData& = EditData()) const
    {
 ...
 */
    ...
    {
        return flag(ElementFlag::SYSTEM);
    }

    void setSystemFlag(bool v) const
    {
        setFlag(ElementFlag::SYSTEM, v);
    }

    bool header() const
    {
        return flag(ElementFlag::HEADER);
    }

    void setHeader(bool v)
    {
        setFlag(ElementFlag::HEADER, v);
    }

    bool trailer() const
    {
        return flag(ElementFlag::TRAILER);
    }

    void setTrailer(bool val)
    {
        setFlag(ElementFlag::TRAILER, val);
    }
    ...
    {
        setFlag(ElementFlag::NOT_SELECTABLE, !val);
    }

    bool dropTarget() const
    {
        return flag(ElementFlag::DROP_TARGET);
    }

    void setDropTarget(bool v) const
    {
        setFlag(ElementFlag::DROP_TARGET, v);
    }

    bool composition() const
    {
        return flag(ElementFlag::COMPOSITION);
    }

    void setComposition(bool v) const
    {
        setFlag(ElementFlag::COMPOSITION, v);
    }

    virtual bool isMovable() const
    {
        return flag(ElementFlag::MOVABLE);
    }

    bool enabled() const
    {
        return flag(ElementFlag::ENABLED);
    }

    void setEnabled(bool val)
    {
        setFlag(ElementFlag::ENABLED, val);
    }
    ...
    {
        setFlag(ElementFlag::NO_AUTOPLACE, !v);
    }

    bool addToSkyline() const
    {
        return !(_flags & (ElementFlag::INVISIBLE|ElementFlag::NO_AUTOPLACE));
    }
    ...
    {
        return 0;
    }                                                       // return Spanner for SpannerSegment for some properties
    ...
    void drawSymbols(const std::vector<SymId>&, QPainter* p,
                     const QPointF& o = QPointF(), qreal scale = 1.0) const;
    void drawSymbols(const std::vector<SymId>&, QPainter* p, const QPointF& o,
    ...
    {
        autoplaceSegmentElement(placeAbove(), add);
    }

    void autoplaceMeasureElement(bool add = true)
    {
        autoplaceMeasureElement(placeAbove(), add);
    }
...
public:
    ...
    virtual EditDataType type()
    {
        return EditDataType::ElementEditData;
    }
};
