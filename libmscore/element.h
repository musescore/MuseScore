...
//      bool isNudged() const                       { return !(_readPos.isNull() && _userOff.isNull()); }
      ...
      virtual void writeProperties300old(XmlWriter& xml) const { writeProperties(xml); }
 ...
 */
      ...
      virtual Fraction fpos() const; // utility, searches for segment
      virtual Fraction absfpos() const; // utility, searches for segment
