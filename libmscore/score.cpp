      ...
      switch (n) {
            ...
            case Pad::DOT:
                  if (_is.duration().dots() == 1)
                        _is.setDots(0);
                  else if (_is.duration() == TDuration::DurationType::V_1024TH)
                        return;
                  else
                        _is.setDots(1);
                  break;
            case Pad::DOTDOT:
                  if (_is.duration().dots() == 2)
                        _is.setDots(0);
                  else if (_is.duration() == TDuration::DurationType::V_512TH ||
            ...
            case Pad::DOT3:
                  if (_is.duration().dots() == 3)
                        _is.setDots(0);
                  else if (_is.duration() == TDuration::DurationType::V_256TH ||
            ...
            case Pad::DOT4:
                  if (_is.duration().dots() == 4)
                        _is.setDots(0);
                  else if (_is.duration() == TDuration::DurationType::V_128TH ||
