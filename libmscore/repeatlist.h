...
public:
    ...
    {
        return measureList.empty() ? nullptr : measureList.front().first;
    }

    Measure* lastMeasure() const
    {
        return measureList.empty() ? nullptr : measureList.back().first;
    }
...
class RepeatList : public QList<RepeatSegment*>
{
    ...
    bool isFinalPlaythrough(Measure* const measure,
