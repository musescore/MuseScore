...
public:
    ...
    Chord* clone() const override
    {
        return new Chord(*this, false);
    }

    Element* linkedClone() override
    {
        return new Chord(*this, true);
    }
    ...
    bool isGrace() const
    {
        return _noteType != NoteType::NORMAL;
    }
