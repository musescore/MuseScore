...
public:
    ...
    HChord(int a, int b, int c = -1, int d = -1, int e = -1, int f = -1, int g = -1, int h = -1,
           int i = -1, int k = -1, int l = -1);
...
public:
    ...
    QString fromXml(const QString&, const QString&, const QString&, const QString&,
                    const QList<HDegree>&, const ChordList*);
    ...
    const QStringList& modifierList() const
    {
...
public:
    ...
    void configureAutoAdjust(qreal emag = 1.0, qreal eadjust = 0.0, qreal mmag = 1.0,
                             qreal madjust = 0.0);
