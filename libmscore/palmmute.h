...
public:
    PalmMuteSegment(Spanner* sp, Score* s) : TextLineBaseSegment(sp, s,
                                                                 ElementFlag::MOVABLE
    ...
    {
        return ElementType::PALM_MUTE_SEGMENT;
    }

    PalmMuteSegment* clone() const override
    {
        return new PalmMuteSegment(*this);
    }

    PalmMute* palmMute() const
    {
        return (PalmMute*)spanner();
    }
...
public:
    ...
    PalmMute* clone() const override
    {
        return new PalmMute(*this);
    }
