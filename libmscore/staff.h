...
public:
    ...
    {
        return timeStretch(tick) != Fraction(1, 1);
    }
    ...
    {
        return _hideSystemBarLine;
    }

    void setHideSystemBarLine(bool val)
    {
        _hideSystemBarLine = val;
    }
    ...
    {
        _swingList.insert(tick.ticks(), sp);
    }
    ...
    {
        _capoList.insert(tick.ticks(), fretId);
    }
    ...
    {
        return _pitchOffsets;
    }

    int pitchOffset(const Fraction& tick)
    {
        return _pitchOffsets.pitchOffset(tick.ticks());
    }
