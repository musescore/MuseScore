...
function selectTab(tab)
{
    ...
    case "templates":
        ...
        break;
    default:
        api.testflow.error("instruments: unknown tab: " + tab)
    }
}
...
module.exports = {
    ...
    chooseRandomInstruments: function(count, see_msec)
    {
        ...
        for (var i = 0; i < count; i++) {
            ...
            // Choose instrument
            var instrCount = api.testflow.randomInt(0, 20);
