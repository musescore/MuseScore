...
var testCase = {
    ...
    steps: [
        ...
        {name: "Save", func: function() {
            api.testflow.saveProject("TC7_UsingExport.mscz")
        }},
...
{
    var size = api.testflow.fileSize(path)
    if (size === 0) {
        api.testflow.error("file not exists or zero, path: " + path)
    }
}
...
{
    var filePath = api.testflow.selectedFilePath()
