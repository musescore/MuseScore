...
<context>
    ...
    To enter notes into a different voice, click one of these icons.</source>
        ...
        <translation>使用多個聲部以在同一小節中輸入不同的節奏和旋律。
   每行譜表可以容納最多四個聲部。
   默認採用第 1 聲部。在任何譜表中輸入音符時都應當優先使用第 1 聲部。
   若要在其他的聲部中輸入音符，點擊這四個按鈕中與聲部相對應的按鈕。</translation>
    </message>
    <message>
    ...
    The main three are File Operations, Playback Controls, and Note Input.</source>
        <comment>welcome</comment>
        <translation>這是工具欄。
   最基本的三種工具是文件工具組，播放工具組與音符輸入工具組。</translation>
    </message>
    <message>
    ...
    The &quot;Advanced&quot; workspace contains more items than the &quot;Basic&quot; workspace.</source>
        <comment>show-palette</comment>
        <translation>不同的工作區有不同的面板組合。
   「高級」工作區比「基礎」工作區包含更多內容。</translation>
    </message>
    <message>
    ...
    You can also drag an item from the palette and drop it on a specific element in your score.</source>
        <comment>show-palette</comment>
        <translation>要往樂譜中添加符號，請先選中樂譜中的一個元素或一個區域，然後雙擊面板上的符號來添加。
        您亦可從符號面板中拖拽一個項目，將它拖放到您樂譜中的指定元素上。</translation>
    </message>
    <message>
    ...
    The set of properties available will differ according to the type of selected elements or elements.</source>
        <comment>inspector-tour</comment>
        <translation>首先，選中您樂譜上的一個或多個元素，然後使用復選框、轉盤框、下拉菜單等來調整不同屬性的值。
        此處的可用屬性會因所選元素的類型而有區別。</translation>
    </message>
    <message>
    ...
    You can click the &quot;Notes&quot; and other buttons at the bottom of the Inspector to limit the selection to just the elements of the specified type.</source>
        <comment>inspector-tour</comment>
        <translation>若您同時選擇了不同類型的元素，檢視器只會顯示所有選中元素共有的那幾項設置。
        您可點擊檢視器下部的「音符」或其他按鈕來篩選特定類型的元素。</translation>
    </message>
    <message>
        <source>The Inspector allows you to control various properties of the elements in your score.</source>
        <comment>welcome</comment>
        <translation>通過檢視器，您能夠管理樂譜中各種元素的不同屬性。</translation>
    </message>
    <message>
    ...
    Click &quot;Next&quot; to learn more.</source>
        ...
        <translation>自動佈局是一項新功能，可自動檢測元素以避免元素之間的佈局衝突。
        您也可以對已自動佈局元素的位置進行手動調整，或者為選定的元素關閉自動佈局功能。
        單擊「下一個」來瞭解詳情。</translation>
    </message>
    <message>
    ...
    In many cases, this means that no further adjustments will be required at all.</source>
        <comment>autoplace-tour</comment>
        <translation>自動佈局功能依據標準的音樂排版做法來擺放大多數元素，
   例如，將速度標記移到其他文字上方，或者縮短漸變符號以避讓力度標記。
   在很多情況下，這意味著無需任何進一步操作。</translation>
    </message>
    <message>
    ...
    This allows you to make adjustments while leaving autoplace enabled to continue avoiding collisions.</source>
        <comment>autoplace-tour</comment>
        <translation>必要的話，您可通過拖拽、在編輯模式使用光標鍵（請先雙擊），
        或者使用檢視器中的「偏移」來微調元素位置。
        這使得您可以在啓用自動佈局時作出調整，同時避免衝突。</translation>
    </message>
    <message>
    ...
    This will remove them from collision detection and allow you to place them more freely.</source>
        <comment>autoplace-tour</comment>
        <translation>對更複雜的調整，最好通過檢視器為選定元素關閉自動佈局。
        這將把它們排除在衝突檢測機制之外，而使您更加自由地擺放它們。</translation>
    </message>
    <message>
    ...
    Click &quot;Next&quot; to learn more.</source>
        ...
        <translation>歡迎來到「時間軸」，在這裡您可以瀏覽高度精簡的曲譜，輕鬆導覽。
        單擊「下一个」以瞭解詳情。</translation>
    </message>
    <message>
    ...
    You can click anywhere to jump to the corresponding location in your score.</source>
        <comment>timeline-tour</comment>
        <translation>「時間軸」展示排練記號，改變節奏、曲調、拍號以及其他你能想到的。
  你可以任意點擊跳轉到曲譜對應的地方。</translation>
    </message>
    <message>
    ...
    Boxes with a thin blue outline represent measures that are currently in view.</source>
        <comment>timeline-tour</comment>
        <translation>以下區域每一種樂器都有一行。
        行內每個方框代表了那個樂器的一個小節。
        如果方框高亮顯示了，則那一小節有音符。
        藍色邊框的方框代表當前所看到的小節。</translation>
    </message>
    <message>
        <source>MuseScore supports different types of selections: single, list, and range.
    Click &quot;Next&quot; to learn more.</source>
        <comment>select-tour</comment>
        <translation>MuseScore 支持多種形式的選取：單選、列選和框選。
    單擊「下一個」來瞭解更多。</translation>
    </message>
    <message>
        ...
        <comment>select-tour</comment>
        <translation>最後，過濾器（可以在頂部菜單欄的「視圖」中找到）讓您可以通過給定的類型排除選區中的元素。</translation>
    </message>
    <message>
    ...
    You can also set style defaults using Format &gt; Style….</source>
        <comment>inspector-tour</comment>
        <translation>如果您已修改過一個值，您可以單擊「重置」按鈕來將其恢復默認。
        若這個值是由樣式文件控制的，您可點擊「設為樣式」按鈕來將當前值設定為樣式文件的新的默認值。
        您亦可通過頂部菜單欄的「格式」&gt;「樣式」將所有的樣式恢復為默認。</translation>
    </message>
    <message>
    ...
    To scroll horizontally, hold &quot;Shift&quot; while using the mouse wheel or touch gesture.</source>
        <comment>navigate-tour</comment>
        <translation>要快捷地滾動樂譜，請使用鼠標滾輪或對應的觸控手勢（例如：雙指滑動）。
        要橫向地滾動，請在鼠標滾輪滾動或使用觸控手勢的同時按住 Shift。</translation>
    </message>
    <message>
    ...
    Keyboards that lack these keys often provide equivalents such as &quot;Fn+Up/Down/Left/Right&quot;.</source>
        <comment>navigate-tour</comment>
        <translation>鍵盤上的導航鍵，如 PgUp、PgDn、Home 和 End 可起到移動頁面的作用，正如在其他應用程序中的作用一樣。
        缺少這些鍵位的鍵盤通常可用 Fn + 上/下/左/右鍵來實現同等功能。</translation>
    </message>
    <message>
    ...
    By the way, you can also select regions by holding &quot;Shift&quot; while dragging.</source>
        <comment>navigate-tour</comment>
        <translation>您可以點擊頁面空白區域並拖拽來短距離移動譜面。
        此外，您還可以在拖拽時按住 Shift 來選中一個區域的元素。</translation>
    </message>
    <message>
    ...
    Press &quot;Ctrl+Up/Down&quot; (macOS: &quot;Cmd+Up/Down&quot;) to change octave.</source>
        <comment>note-input</comment>
        <translation>要輸入指定時值的音符，請鍵入音名字母（C、D、E……）或直接在音符輸入模式下的譜表中單擊即可。
    ...
    or click one of these icons.</source>
        <comment>note-input</comment>
        <translation>要向一個音符添加臨時升降號，按下鍵盤的上/下以使音高昇/降。
        也可點擊工具欄中的按鈕來添加臨時升降號。</translation>
    </message>
    <message>
        <source>To add a note to a chord, press &quot;Shift&quot; while typing its letter name, or click on the staff.</source>
        <comment>note-input</comment>
        <translation>要向一個和弦中添加音符，請按住 Shift 並鍵入音名，或直接在譜表中單擊。</translation>
    </message>
    <message>
        ...
        <comment>note-input</comment>
        <translation>要創建一個三連音或其他連音，請先選取連音的總時值，然後按下 Ctrl + 數字。也可使用頂部菜單欄里的「添加」&gt;「連音符」。</translation>
    </message>
    <message>
    ...
    and also move up and down from staff to staff.</source>
        <comment>select-tour</comment>
        <translation>要單選，單擊您要選擇的元素即可。
        選中的元素會高亮顯示以表明其被選中。
        你可以使用左/右箭頭來（在音符及休止符間）移動所選元素。
        小技巧：如果在按箭頭時一並按下 Alt 鍵（macOS 對應 Option 鍵），則所選元素也可在其他元素之中移動，還能夠在譜表與譜表間上下移動。</translation>
    </message>
    <message>
    ...
    and then choosing one of the &quot;Select&quot; options from the resulting popup menu.</source>
        <comment>select-tour</comment>
        <translation>列選是單選的復合形式。
    單擊或移除元素時按下 Ctrl（macOS：Cmd）即可多選。
    要快速選擇類似元素，請右鍵單擊 （macOS：Ctrl + 單擊）一個元素，
    接著選擇彈出菜單中的「選擇」選項即可。</translation>
    </message>
    <message>
    ...
    You can also extend range selections by holding the &quot;Shift&quot; key while moving the cursor.</source>
        <comment>select-tour</comment>
        <translation>框選囊括了同一時間點到點選中的一切。
    框選由一個藍色矩形框來提示，框內即為選距。
    要進行框選，單擊您想要選中部分的第一個音符、休止符或小節，然後在最後一個要選中的元素上單擊並按下 Shift。
    您也可在按下 Shift 的同時使用鍵盤上的箭頭來進行框選。</translation>
    </message>
    <message>
    ...
    otherwise it will be made as a list selection.</source>
        <comment>select-tour</comment>
        <translation>另一種框選方法是：按住 Shift 鍵的同時進行拖拽。
        若您的選擇囊括了音符，系統就會自動將其生成一個選區。
        否則，它將被視為列選。</translation>
    </message>
    <message>
    ...
    - Press &quot;Shift+Left&quot; to move that handle backward.</source>
        ...
        <translation>大多數在線性符號面板中的元素會從一個起始元素延伸到終端元素。

    要編輯它的延伸距離，請雙擊線條（此時會自動選擇其終端滑動柄）然後：

    - 按下Shift+右箭頭來右移。
    - 按下Shift+左箭頭來左移。</translation>
    </message>
    <message>
        ...
        <comment>spanner-drop-apply</comment>
        <translation>另外，先選中譜面內一個區域內的元素，接著雙擊符號面板中的任意一個線形元素即可將該元素應用到選區。</translation>
    </message>
    <message>
    ...
    If you have multiple scores open, you can switch between them using tabs at the top of your score view.</source>
        <comment>welcome</comment>
        <translation>這就是樂譜界面，在此您可以閱覽並編輯樂譜。
    使用鼠標滾輪或觸控板來滾動（同時按住&quot;Shift&quot;可以進行橫向滾動）。
    若您打開了多份樂譜，您可以點擊樂譜界面上方的標籤頁以在不同樂譜之間切換。</translation>
    </message>
    <message>
    ...
    The controls at the right of this toolbar control the display of your score.</source>
        <comment>welcome</comment>
        <translation>文件操作欄使您可以新建、保存、打開/打印文件以及撤銷、恢復更改。
        您亦可前往頂部菜單欄的「文件」&gt;「保存至在線空間」來將樂譜保存至您的 musescore.com 賬戶。
        這欄的右側是可控制您的樂譜的顯示方式。</translation>
    </message>
    <message>
    ...
    In addition, many commands can be accessed via keyboard shortcuts or by right-clicking (macOS: &quot;Ctrl&quot;+clicking) within the score view.</source>
        <comment>welcome</comment>
        <translation>主菜單包含大多數其他操作。
      除此之外，許多操作都可以通過在樂譜界面中鍵入快捷鍵或使用右鍵菜單（macOS：Ctrl + 單擊）來完成。</translation>
    </message>
    <message>
    ...
    You can also enable/disable and reset tours in Help &gt; Tours.</source>
        <comment>welcome</comment>
        <translation>教程導覽結束了！
        當您使用 MuseScore 時，更多的教程導覽會彈出來詳解更深入的功能。
        若您不希望再看到導覽，請在關閉本窗口前取消選中「繼續顯示導覽」。
        您還可以在頂部菜單欄的「幫助」&gt;「教程導覽」中啓用/關閉或者重置導覽的顯示。</translation>
    </message>
</context>
</TS>