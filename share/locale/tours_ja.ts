...
このツアーでは、MuseScoreのユーザインターフェースについて簡単に説明します。</translation>
    </message>
    <message>
    ...
    To enter notes into a different voice, click one of these icons.</source>
        ...
        <translation>同じ小節内で異なったリズムの音符を入力するには &quot;声部&quot; 機能を使います。
一つの譜表に対して最大、4声部まで対応します。
通常は声部1に入力されます。どのパートでも声部1は最初に使う必要があります。
...
基本は3種類。これによってファイル操作、再生、音符入力などができます。</translation>
    ...
    The &quot;Advanced&quot; workspace contains more items than the &quot;Basic&quot; workspace.</source>
        <comment>show-palette</comment>
        <translation>異なるパレットを持ったワークスペースが利用可能です。
&quot;アドバンス&quot; では &quot;基本&quot; のワークスペースに比べより多くのアイテムが入っています。</translation>
    </message>
    <message>
...
他にも、音楽記号を追加したい音符にドラッグアンドドロップすることでも追加することもできます。</translation>
    ...
    To toggle this setting again, press the shortcut &quot;M&quot;.</source>
        ...
        <translation>長休符の切替もできます。
全休符のある小節が連続している場合、長休符としてまとめることができます。
&quot; M &quot;キーを押すと切替られます。</translation>
    </message>
    <message>
...
詳細は &quot; 次へ &quot; をクリックしてください。</translation>
    ...
    <message>
        ...
        <comment>note-input</comment>
        <translation>音符を入力するには &quot; 音符入力（N） &quot;のアイコンをクリックするか &quot; N &quot; キーを押して入力モードにします。</translation>
    </message>
    <message>
...
詳細は &quot; 次へ &quot; をクリックしてください。</translation>
    ...
    Click &quot;Next&quot; to learn more.</source>
        ...
        <translation>インスペクタへようこそ。選択した個々の要素のプロパティを変更できます。
詳細は &quot; 次へ &quot; をクリックしてください。</translation>
    </message>
    <message>
 ...
 変更ができる項目は選択された要素、または要素の種類によって異なります。</translation>
    ...
    You can click the &quot;Notes&quot; and other buttons at the bottom of the Inspector to limit the selection to just the elements of the specified type.</source>
        <comment>inspector-tour</comment>
        <translation>異なる種類の要素を選択した場合は、すべての要素に共通のいくつかの設定のみが利用可能になります。
 インスペクタの下部にある &quot; 音符 &quot; やその他のボタンをクリックして、選択範囲を指定した種類の要素だけにできます。</translation>
    ...
    Click &quot;Next&quot; to learn more.</source>
        ...
        <translation>自動配置は、要素間のさまざまな種類の衝突を自動的に検出して回避する新機能です。
また、自動配置された要素の位置を手動で調整したり、選択した要素の自動配置を無効にしたりすることもできます。
詳細については、&quot; 次へ &quot; をクリックしてください。</translation>
    </message>
    <message>
    ...
    In many cases, this means that no further adjustments will be required at all.</source>
        <comment>autoplace-tour</comment>
        <translation>自動配置機能による配置は標準的な記譜法に則って行われます。
たとえば、速度記号を他のテキストより上に表示したり、ヘアピン線が強弱記号を避けて短くなります。
多くの場面で譜面のさらなる調整が不要になることでしょう。</translation>
    </message>
    <message>
    ...
    This allows you to make adjustments while leaving autoplace enabled to continue avoiding collisions.</source>
        <comment>autoplace-tour</comment>
        <translation>必要に応じて、要素を編集モード（その要素をダブルクリック）にすると、ドラッグや方向キーで微調整ができます。
インスペクタの&quot; オフセット &quot;欄を使うとさらに細かく調整することもできます。
この時も自動配置によって常に衝突を回避しながら調整することができます。</translation>
    </message>
    <message>
    ...
    This will remove them from collision detection and allow you to place them more freely.</source>
        <comment>autoplace-tour</comment>
        <translation>より大きな調整の場合は、インスペクタを使って選択した要素の自動配置を無効にするほうが便利かもしれません。
無効にするとその要素が衝突検出から除外され、より自由に配置できるようになります。</translation>
    </message>
    <message>
...
この四角の中で、細い青線で囲まれているところが現在楽譜ビューに見えている小節です。</translation>
    ...
    Click &quot;Next&quot; to learn more.</source>
        ...
        <translation>MuseScoreはさまざまな種類の選択をサポートしています。単一選択、リスト選択、範囲選択です。
詳細は &quot; 次へ &quot; をクリックしてください。</translation>
    </message>
    <message>
