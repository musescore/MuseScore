...
請按一下「下一頁」以了解更多。</translation>
    ...
    You can also set style defaults using Format &gt; Style….</source>
        <comment>inspector-tour</comment>
        <translation>如果您已修改過一個值，您可以單擊「重設」按鈕來將其恢復默認。
        若這個值是由樣式檔案控制的，您可點擊「設為樣式」按鈕來將當前值設定為樣式檔案的新的默認值。
...
你可以使用左/右箭頭來（在音符及休止符間）移動所選元素。
    ...
    The controls at the right of this toolbar control the display of your score.</source>
        <comment>welcome</comment>
        <translation>檔案操作欄使您可以新建、保存、打開/打印檔案以及撤銷、恢復更改。
        您亦可前往頂部菜單欄的「檔案」&gt;「保存至在線空間」來將樂譜保存至您的 musescore.com 賬戶。
    ...
    You can also enable/disable and reset tours in Help &gt; Tours.</source>
        ...
        您還可以在頂部菜單欄的「幫助」&gt;「教程導覽」中啓用/關閉或者重設導覽的顯示。</translation>
    </message>
</context>
</TS>
