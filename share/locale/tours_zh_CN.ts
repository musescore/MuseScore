...
<context>
    ...
    <message>
        ...
        <comment>show-palette</comment>
        <translation>欢迎来到工作面板，在这里您可以在乐谱中加入各种元素。点击“下一步”以详细了解。</translation>
    </message>
    <message>
    ...
    To enter notes into a different voice, click one of these icons.</source>
        ...
        <translation>使用多个声部以在同一小节中输入不同的旋律。
每行谱表可以容纳最多四个声部。
默认采用第 1 声部。在任何谱表中输入音符时都应当优先使用第 1 声部。
若要在其他的声部中输入音符，点击这四个按钮中与声部相对应的按钮。</translation>
    </message>
    <message>
    ...
    The main three are File Operations, Playback Controls, and Note Input.</source>
        <comment>welcome</comment>
        <translation>这是工具栏。
这里最基本的三种工具是文件工具组，播放工具组与音符输入工具组。</translation>
    </message>
    <message>
    ...
    The &quot;Advanced&quot; workspace contains more items than the &quot;Basic&quot; workspace.</source>
        <comment>show-palette</comment>
        <translation>不同的工作区有不同的面板组合。
“高级”工作区比“基础”工作区包含更多内容。</translation>
    </message>
    <message>
    ...
    You can also drag an item from the palette and drop it on a specific element in your score.</source>
        <comment>show-palette</comment>
        <translation>要往乐谱中添加符号，请先选中乐谱中的一个元素或一个区域，然后双击面板上的符号来添加。
您亦可从符号面板中拖拽一个符号到您乐谱中的指定元素上。</translation>
    </message>
    <message>
...
点击“下一步”以详细了解。</translation>
    ...
    Click &quot;Next&quot; to learn more.</source>
        ...
        <translation>欢迎来到元素检视器，您可以在此处更改所选元素的各项属性。
点击“下一步”以详细了解。</translation>
    </message>
    <message>
    ...
    The set of properties available will differ according to the type of selected elements or elements.</source>
        <comment>inspector-tour</comment>
        <translation>首先，选中您乐谱上的一个或多个元素，然后使用复选框、转盘框、下拉菜单等来调整不同属性的值。
此处的可用属性会因所选元素的类型而有区别。</translation>
    </message>
    <message>
    ...
    You can click the &quot;Notes&quot; and other buttons at the bottom of the Inspector to limit the selection to just the elements of the specified type.</source>
        <comment>inspector-tour</comment>
        <translation>若您同时选择了不同类型的元素，检视器只会显示所有选中元素共有的那几项设置。
您可点击检视器下部的“音符”或其他按钮来筛选特定类型的元素。</translation>
    </message>
    <message>
        <source>The Inspector allows you to control various properties of the elements in your score.</source>
        <comment>welcome</comment>
        <translation>通过检视器，您能够管理乐谱中各种元素的不同属性。</translation>
    </message>
    <message>
    ...
    Click &quot;Next&quot; to learn more.</source>
        ...
        <translation>自动布局是一项新功能，可自动检测元素以避免元素之间的布局冲突。
您也可以对已自动布局元素的位置进行手动调整，或者为选定的元素关闭自动布局功能。
点击“下一步”以详细了解。</translation>
    </message>
    <message>
    ...
    In many cases, this means that no further adjustments will be required at all.</source>
        <comment>autoplace-tour</comment>
        <translation>自动布局功能依据标准的音乐排版做法来放置大多数元素，
例如，将速度标记移到其他文字上方，或者缩短渐变符号以避让力度标记。
在很多情况下，这意味着无需任何进一步操作。</translation>
    </message>
    <message>
    ...
    This allows you to make adjustments while leaving autoplace enabled to continue avoiding collisions.</source>
        <comment>autoplace-tour</comment>
        <translation>必要的话，您可通过拖拽、在编辑模式使用光标键（请先双击），
或者使用检视器中的“偏移”来微调元素位置。
这使得您可以在启用自动布局时作出调整以进一步避免冲突。</translation>
    </message>
    <message>
    ...
    This will remove them from collision detection and allow you to place them more freely.</source>
        <comment>autoplace-tour</comment>
        <translation>对更复杂的调整，最好通过检视器为选定元素关闭自动布局。
这将把它们排除在冲突检测机制之外，而使您更加自由地摆放它们。</translation>
    </message>
    <message>
    ...
    Click &quot;Next&quot; to learn more.</source>
        ...
        <translation>欢迎来到“时间轴”，在这里您可以浏览高度精简的乐谱，轻松导航。
点击“下一步”以详细了解。</translation>
    </message>
    <message>
    ...
    You can click anywhere to jump to the corresponding location in your score.</source>
        <comment>timeline-tour</comment>
        <translation>“时间轴”展示排练记号，节奏、曲调、拍号的改变以及其它的重要节点。
你可以任意点击以跳转到乐谱对应的地方。</translation>
    </message>
    <message>
    ...
    Boxes with a thin blue outline represent measures that are currently in view.</source>
        <comment>timeline-tour</comment>
        <translation>以下区域中每一种乐器都有一行。
行内每个方框代表了该乐器的一个小节。
如果方框高亮显示，说明那一小节存在音符。
蓝色边框的方框代表当前所看到的小节。</translation>
    </message>
    <message>
        <source>MuseScore supports different types of selections: single, list, and range.
    Click &quot;Next&quot; to learn more.</source>
        <comment>select-tour</comment>
        <translation>MuseScore支持多种形式的选取：单选、列选和框选。
点击“下一步”以详细了解。</translation>
    </message>
    <message>
        ...
        <comment>select-tour</comment>
        <translation>最后，过滤器（可以在顶部菜单栏的“视图”中找到）让您可以通过类型选择排除选区中特定类型的元素。</translation>
    </message>
    <message>
    ...
    You can also set style defaults using Format &gt; Style….</source>
        <comment>inspector-tour</comment>
        <translation>如果您修改过一个值，您可以单击“重置”按钮来将其恢复默认。
若这个值是由样式设定控制的，您可点击“设为样式”按钮来将当前值设定为样式设定的新的默认值。
您亦可通过顶部菜单栏的“格式”&gt;“样式”将所有的样式恢复为默认。</translation>
    </message>
    <message>
    ...
    To scroll horizontally, hold &quot;Shift&quot; while using the mouse wheel or touch gesture.</source>
        <comment>navigate-tour</comment>
        <translation>要快速地滚动乐谱，请使用鼠标滚轮或对应的触控手势（例如：双指滑动）。
要横向地滚动，请在鼠标滚轮滚动或使用触控手势的同时按住Shift。</translation>
    </message>
    <message>
    ...
    Keyboards that lack these keys often provide equivalents such as &quot;Fn+Up/Down/Left/Right&quot;.</source>
        <comment>navigate-tour</comment>
        <translation>键盘上的导航键，如PgUp、PgDn、Home和End可起到移动页面的作用，
正如在其他应用程序中的作用一样。
缺少这些键位的键盘通常可用Fn + 上/下/左/右键来实现同等功能。</translation>
    </message>
    <message>
    ...
    By the way, you can also select regions by holding &quot;Shift&quot; while dragging.</source>
        <comment>navigate-tour</comment>
        <translation>您可以点击页面空白区域并拖拽来短距离移动谱面。
此外，您还可以在拖拽时按住Shift来选中一个区域的元素。</translation>
    </message>
    <message>
    ...
    Press &quot;Ctrl+Up/Down&quot; (macOS: &quot;Cmd+Up/Down&quot;) to change octave.</source>
        <comment>note-input</comment>
        <translation>若要输入指定时值的音符，请键入音名字母（C、D、E……）或直接在音符输入模式下的谱表中单击。
按Ctrl + 上/下（macOS：Cmd + 上/下）以升/降八度。</translation>
    </message>
    <message>
    ...
    or click one of these icons.</source>
        <comment>note-input</comment>
        <translation>若要对一个音符添加临时升降号，可按下键盘的上/下以使音高升/降。
也可点击工具栏中的按钮来添加临时升降号。</translation>
    </message>
    <message>
        <source>To add a note to a chord, press &quot;Shift&quot; while typing its letter name, or click on the staff.</source>
        <comment>note-input</comment>
        <translation>若要向一个和弦中添加音符，请按住Shift并键入音名，或直接在谱表中单击。</translation>
    </message>
    <message>
        ...
        <comment>note-input</comment>
        <translation>若要创建一个三连音或其他连音，请先选取连音的总时值，然后按下Ctrl + 数字。也可使用顶部菜单栏里的“添加”&gt;“连音符”。</translation>
    </message>
    <message>
...
小技巧：如果在按箭头时一并按下Alt键（macOS对应Option键），则所选元素也可在其他元素之中移动，还能够在谱表与谱表间上下移动。</translation>
    </message>
    <message>
    ...
    and then choosing one of the &quot;Select&quot; options from the resulting popup menu.</source>
        <comment>select-tour</comment>
        <translation>列选是单选的复合形式。
单击或移除元素时按下Ctrl（macOS：Cmd）即可多选。
若要快速选择类似元素，请右键单击（macOS：Ctrl + 单击）一个元素，
接着选择弹出菜单中的一个“选择”选项即可。</translation>
    </message>
    <message>
...
要编辑它的延伸距离，请双击线条（此时会自动选择其终端滑动柄）然后：

- 按下Shift+右箭头来右移。
- 按下Shift+左箭头来左移。</translation>
    </message>
    <message>
        ...
        <comment>spanner-drop-apply</comment>
        <translation>您也可以先选中谱面内一个区域内的元素，接着双击符号面板中的任意一个线性元素，即可将该元素应用到选区。</translation>
    </message>
    <message>
    ...
    If you have multiple scores open, you can switch between them using tabs at the top of your score view.</source>
        <comment>welcome</comment>
        <translation>这就是乐谱界面，在此您可以阅览并编辑乐谱。
使用鼠标滚轮或触控板来滚动（同时按住&quot;Shift&quot;可以进行横向滚动）。
若您打开了多份乐谱，您可以点击乐谱界面上方的标签页以在不同乐谱之间切换。</translation>
    </message>
    <message>
...
除此之外，许多操作都可以通过在乐谱界面中键入快捷键或使用右键菜单（macOS：Ctrl + 单击）来完成。</translation>
    ...
    You can also enable/disable and reset tours in Help &gt; Tours.</source>
        <comment>welcome</comment>
        <translation>教程导览结束了！
当您使用 MuseScore 时，更多的教程导览会弹出来详解更深入的功能。
若您不希望再看到导览，请在关闭本窗口前取消选中“继续显示导览”。
您还可以在顶部菜单栏的“帮助”&gt;“教程导览”中启用/关闭或者重置导览的显示。</translation>
    </message>
</context>
</TS>