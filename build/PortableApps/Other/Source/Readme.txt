...
The subfolders of -\Data\MuseScore3 (see above) are the default folders where MuseScore will 
...
The DisableSplashScreen entry allows you to run the launcher without the splash screen showing up.
