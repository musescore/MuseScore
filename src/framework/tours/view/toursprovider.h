...
signals:
    void openTourStep(const QQuickItem* parentItem, const QString& title, const QString& description, const QString& preferredPlacement,
                      const QString& previewImageOrGifUrl, const QString& videoExplanationUrl, size_t index, size_t total);
