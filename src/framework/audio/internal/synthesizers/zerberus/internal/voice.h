...
#ifndef MU_ZERBERUS_MVOICE_H
#define MU_ZERBERUS_MVOICE_H
...
struct Phase {
    ...
    void set(int b) { data = int64_t(b) * 256; }
    void set(double b) { data = int64_t(b * 256.0); }
    void setIndex(int b) { data = int64_t(b) * 256 + _fract; }
