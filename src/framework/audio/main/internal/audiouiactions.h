...
class AudioUiActions : public muse::ui::IUiActionsModule
{
public:
    AudioUiActions(const std::shared_ptr<AudioActionsController>& c);
...
private:
    ...
    const std::shared_ptr<AudioActionsController> m_controller;
};
}
