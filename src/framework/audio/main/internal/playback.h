...
public:
    ...
    async::Promise<bool> saveSoundTrack(const TrackSequenceId sequenceId, const SoundTrackFormat& format, io::IODevice& dstDevice,
                                        const secs_t startPosition, const secs_t duration) override;
