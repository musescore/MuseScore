 ...
 */
#ifndef MU_GLOBAL_AUDIOPLUGINMETAREADERREGISTERMOCK_H
#define MU_GLOBAL_AUDIOPLUGINMETAREADERREGISTERMOCK_H
...
#endif // MU_GLOBAL_AUDIOPLUGINMETAREADERREGISTERMOCK_H
