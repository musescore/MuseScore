...
MainWindowMDI::MainWindowMDI(int ctx, const QString &uniqueName, WidgetType *parent, Qt::WindowFlags flags)
    : MDIMainWindowBase(ctx, uniqueName, MainWindowOption_MDI, parent, flags)
{
}
