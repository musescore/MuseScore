...
bool DockPanelView::isTabAllowed(const DockPanelView* tab, bool allowClosed /* = false */) const
{
...
void DockPanelView::addPanelAsTab(DockPanelView* tab, bool addVisible /* = true */, int tabIndex /* = -1 */)
{
