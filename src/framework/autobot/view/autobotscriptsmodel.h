...
class AutobotScriptsModel : public QAbstractListModel, public LazyInjectable, public async::Asyncable
{
    Q_OBJECT
    ...
    LazyInject<IAutobotScriptsRepository> scriptsRepository = { this };
