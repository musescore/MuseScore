...
void QPainterProvider::setMask(const std::vector<RectF>& maskRects)
{
    if (maskRects.empty()) {
    ...
    background.addRect(QRectF(-1000000.0, -1000000.0, 2000000.0, 2000000.0)); // Start from arbitrary large area
    ...
    QPainterPath mask = background.subtracted(exclusionRegion);
