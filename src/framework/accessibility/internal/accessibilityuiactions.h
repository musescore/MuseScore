 ...
 */
#ifndef MU_ACCESSIBILITY_ACCESSIBILITYUIACTIONS_H
#define MU_ACCESSIBILITY_ACCESSIBILITYUIACTIONS_H

#include "ui/iuiactionsmodule.h"

namespace mu::accessibility {
class AccessibilityUiActions : public ui::IUiActionsModule
{
public:

    AccessibilityUiActions() = default;
...
#endif // MU_ACCESSIBILITY_ACCESSIBILITYUIACTIONS_H
