...
static constexpr ControllIdx SOSTENUTO_IDX = static_cast<ControllIdx>(Steinberg::Vst::kCtrlSustenutoOnOff);
...
void VstSequencer::appendParamChange(EventSequenceMap& destination, const mpe::timestamp_t timestamp,
                                     const ControllIdx controlIdx, const PluginParamValue value)
{
