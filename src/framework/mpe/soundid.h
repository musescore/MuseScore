...
inline const std::unordered_map<SoundId, String> ID_STRINGS
{
    ...
    { SoundId::Guzheng, String(u"guzheng") },
    { SoundId::Guqin, String(u"guqin") },
    { SoundId::Pipa, String(u"pipa") },
    { SoundId::Yangqin, String(u"yangqin") },
    ...
    { SoundId::Ajaeng, String(u"ajaeng") },
    { SoundId::Gayageum, String(u"gayageum") },
    ...
    { SoundId::SamulBuk, String(u"samul_buk") },
    { SoundId::SamulJanggu, String(u"samul_janggu") },
    { SoundId::SanjoJanggu, String(u"sanjo_janggu") },
    { SoundId::SoriBuk, String(u"sori_buk") },
...
inline const std::unordered_map<SoundSubCategory, String> SUBCATEGORY_STRINGS
{
    ...
    { SoundSubCategory::Korean, String(u"korean") },
