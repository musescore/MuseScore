...
inline bool isSingleNoteArticulation(const ArticulationType type)
{
    static const ArticulationTypeSet SINGLE_NOTE_TYPES = {
        ...
        ArticulationType::TriangleRoundDownNote, ArticulationType::PlusNote, ArticulationType::SlashNote, ArticulationType::SquareNote,
        ArticulationType::SlashedBackwardsNote, ArticulationType::SlashedForwardsNote,
        ArticulationType::DiamondNote, ArticulationType::MoonNote, ArticulationType::Fall, ArticulationType::QuickFall,
