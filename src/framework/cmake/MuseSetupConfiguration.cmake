...
foreach(NAME ${MUSE_FRAMEWORK_MODULES})
    if (NOT MUSE_MODULE_${NAME})
        ...
        # set(MUSE_MODULE_${NAME}_QML OFF) -- Stub has QML
...
if (NOT MUSE_MODULE_UI)
    set(MUSE_MODULE_UI_QML OFF) # Has no stub that has QML
endif()
...
if (NOT MUSE_MODULE_AUTOBOT)
    set(MUSE_MODULE_AUTOBOT_QML OFF) # Has no stub that has QML
endif()
