...
static const std::vector<MsBasicItem> msBasicPresetCategories {
    MsBasicItem {
        /*title=*/ u"Pipe",
        /*subItems=*/ {
    ...
    MsBasicItem {
        ...
        /*subItems=*/ {
            ...
            MsBasicItem { midi::Program(21, 45) },
            MsBasicItem { midi::Program(26, 45) },
            MsBasicItem { midi::Program(31, 45) },
            MsBasicItem { midi::Program(41, 45) },
            MsBasicItem { midi::Program(51, 45) },
