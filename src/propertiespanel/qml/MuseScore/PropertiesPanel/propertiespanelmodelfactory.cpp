...
PropertiesPanelAbstractModel* PropertiesPanelModelFactory::newPropertiesPanelListModel(PropertiesPanelModelType modelType, QObject* parent,
                                                                                       const muse::modularity::ContextPtr& iocCtx,
                                                                                       IElementRepositoryService* repository)
{
    switch (modelType) {
    case PropertiesPanelModelType::TYPE_NOTE:
        return new NoteSettingsProxyModel(parent, iocCtx, repository);
    case PropertiesPanelModelType::TYPE_NOTEHEAD:
        return new NoteheadSettingsModel(parent, iocCtx, repository);
    case PropertiesPanelModelType::TYPE_CHORD:
        return new ChordSettingsModel(parent, iocCtx, repository);
    case PropertiesPanelModelType::TYPE_STEM:
        return new StemSettingsModel(parent, iocCtx, repository);
    case PropertiesPanelModelType::TYPE_HOOK:
        return new HookSettingsModel(parent, iocCtx, repository);
    case PropertiesPanelModelType::TYPE_BEAM:
        return new BeamSettingsModel(parent, iocCtx, repository);
    case PropertiesPanelModelType::TYPE_FERMATA:
