...
GradualTempoChangePlaybackModel::GradualTempoChangePlaybackModel(QObject* parent, const muse::modularity::ContextPtr& iocCtx,
    ...
    : PropertiesPanelAbstractModel(parent, iocCtx, repository, ElementType::GRADUAL_TEMPO_CHANGE)
{
    setTitle(muse::qtrc("propertiespanel", "Tempo change"));
    setModelType(PropertiesPanelModelType::TYPE_GRADUAL_TEMPO_CHANGE);
...
QVariantList GradualTempoChangePlaybackModel::possibleEasingMethods() const
{
    QVariantList methods {
        object(ChangeMethod::NORMAL, muse::qtrc("propertiespanel", "Normal", "gradual tempo change method")),
        object(ChangeMethod::EASE_IN, muse::qtrc("propertiespanel", "Ease in", "gradual tempo change method")),
        object(ChangeMethod::EASE_OUT, muse::qtrc("propertiespanel", "Ease out", "gradual tempo change method"))
    };
