...
class GradualTempoChangePlaybackModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::PropertyItem * tempoChangeFactor READ tempoChangeFactor CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * tempoEasingMethod READ tempoEasingMethod CONSTANT)
