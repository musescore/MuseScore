    ...
    ColumnLayout {
        ...
        GridLayout {
            ...
            PropertyCheckBox {
                ...
                text: qsTrc("propertiespanel", "Visible")
            ...
            PropertyCheckBox {
                ...
                text: qsTrc("propertiespanel", "Auto-place")
            ...
            PropertyCheckBox {
                ...
                text: qsTrc("propertiespanel", "Play")
        ...
        GridLayout {
            ...
            PopupViewButton {
                ...
                icon: IconCode.AUDIO
                text: qsTrc("propertiespanel", "Playback")
            ...
            PopupViewButton {
                ...
                text: qsTrc("propertiespanel", "Appearance")
