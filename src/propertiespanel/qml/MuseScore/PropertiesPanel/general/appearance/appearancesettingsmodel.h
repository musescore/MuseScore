...
class AppearanceSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::PropertyItem * leadingSpace READ leadingSpace CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * measureWidth READ measureWidth CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * minimumDistance READ minimumDistance CONSTANT)
