...
Column {
    ...
    required property ModelWithVoiceAndPositionOptions model
    ...
    PropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Voice assignment")
        ...
        RowLayout {
            ...
            FlatButton {
                ...
                text: qsTrc("propertiespanel", "All")
                ...
                toolTipTitle: !isMenuButton ? qsTrc("propertiespanel", "All voices on instrument") : ""
                    ...
                    readonly property var model: [
                        {
                            ...
                            title: qsTrc("propertiespanel", "All voices on instrument"),
                            checkable: true,
                        ...
                        },
                        {
                            ...
                            title: qsTrc("propertiespanel", "All voices on this staff only"),
                            checkable: true,
            ...
            FlatRadioButtonList {
                ...
                model: [
                    { iconCode: IconCode.VOICE_1, value: 0, title: qsTrc("propertiespanel", "Voice 1"), shortcuts: root.model?.shortcutUseVoice1 ?? "" },
                    { iconCode: IconCode.VOICE_2, value: 1, title: qsTrc("propertiespanel", "Voice 2"), shortcuts: root.model?.shortcutUseVoice2 ?? "" },
                    { iconCode: IconCode.VOICE_3, value: 2, title: qsTrc("propertiespanel", "Voice 3"), shortcuts: root.model?.shortcutUseVoice3 ?? "" },
                    { iconCode: IconCode.VOICE_4, value: 3, title: qsTrc("propertiespanel", "Voice 4"), shortcuts: root.model?.shortcutUseVoice4 ?? "" },
                ]
