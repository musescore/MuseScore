...
PropertyView {
    ...
    Row {
        ...
        IncrementalPropertyControl {
            ...
            navigation.accessible.name: root.accessibleName + " " + qsTrc("propertiespanel", "Horizontal") + " " + currentValue
        ...
        IncrementalPropertyControl {
            ...
            navigation.accessible.name: root.accessibleName + " " + qsTrc("propertiespanel", "Vertical") + " " + currentValue
