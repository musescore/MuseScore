...
Column {
    ...
    FlatRadioButtonGroupPropertyView {
        id: frameSection
        titleText: qsTrc("propertiespanel", "Frame")
        ...
        model: [
            { text: qsTrc("propertiespanel", "None", "text frame type"), value: TextTypes.FRAME_TYPE_NONE, titleRole: qsTrc("propertiespanel", "None", "text frame type") },
            { iconCode: IconCode.FRAME_SQUARE, value: TextTypes.FRAME_TYPE_SQUARE, titleRole: qsTrc("propertiespanel", "Rectangle", "text frame type") },
            { iconCode: IconCode.FRAME_CIRCLE, value: TextTypes.FRAME_TYPE_CIRCLE, titleRole: qsTrc("propertiespanel", "Circle", "text frame type") }
        ]
    }
    ...
    Item {
        ...
        ColorSection {
            ...
            titleText: qsTrc("propertiespanel", "Border")
        ...
        ColorSection {
            ...
            titleText: qsTrc("propertiespanel", "Fill color")
    ...
    Item {
        ...
        SpinBoxPropertyView {
            ...
            titleText: qsTrc("propertiespanel", "Padding")
    ...
    SpinBoxPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Corner radius")
