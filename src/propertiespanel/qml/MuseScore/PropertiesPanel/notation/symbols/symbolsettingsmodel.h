...
class SymbolSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::PropertyItem * sym READ sym CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * scoreFont READ scoreFont CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * symbolSize READ symbolSize CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * symAngle READ symAngle CONSTANT)
