...
Column {
    ...
    required property ImageSettingsModel model
    ...
    Item {
        ...
        SpinBoxPropertyView {
            ...
            titleText: qsTrc("propertiespanel", "Image height")
        ...
        FlatToggleButton {
            ...
            navigation.accessible.name: qsTrc("propertiespanel", "Lock")
        ...
        SpinBoxPropertyView {
            ...
            titleText: qsTrc("propertiespanel", "Image width")
    ...
    PropertyCheckBox {
        text: qsTrc("propertiespanel", "Scale to frame size")
    ...
    PropertyCheckBox {
        ...
        text: qsTrc("propertiespanel", "Use staff space units")
