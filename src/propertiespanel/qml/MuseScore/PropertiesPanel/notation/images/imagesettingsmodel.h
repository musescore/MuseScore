...
class ImageSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::PropertyItem * shouldScaleToFrameSize READ shouldScaleToFrameSize CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * height READ height CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * width READ width CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * isAspectRatioLocked READ isAspectRatioLocked CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * isSizeInSpatiums READ isSizeInSpatiums CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * isImageFramed READ isImageFramed CONSTANT)
