...
Column {
    ...
    required property TupletSettingsModel model
    ...
    FlatRadioButtonGroupPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Number type")
    ...
    FlatRadioButtonGroupPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Bracket type")
    ...
    SpinBoxPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Line thickness")
