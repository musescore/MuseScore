...
class TupletSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::PropertyItem * directionType READ directionType CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * numberType READ numberType CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * bracketType READ bracketType CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * lineThickness READ lineThickness CONSTANT)
