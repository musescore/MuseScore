...
Column {
    ...
    PropertyView {
        ...
        Item {
            ...
            IncrementalPropertyControl {
                ...
                navigation.accessible.name: scaleSection.titleText + " " + qsTrc("propertiespanel", "Horizontal") + currentValue
            ...
            IncrementalPropertyControl {
                ...
                navigation.accessible.name: scaleSection.titleText + " " + qsTrc("propertiespanel", "Vertical") + currentValue
    ...
    PropertyCheckBox {
        text: qsTrc("propertiespanel", "Show courtesy time signature")
    ...
    FlatButton {
        ...
        text: qsTrc("propertiespanel", "Time signature properties")
