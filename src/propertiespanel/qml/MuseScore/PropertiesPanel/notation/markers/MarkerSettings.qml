...
Column {
    ...
    required property MarkerSettingsModel model
    ...
    StyledTextLabel {
        width: parent.width
        text: qsTrc("propertiespanel", "Marker type:") + " " + (root.model ? root.model.markerTypeName() : "--")
        horizontalAlignment: Text.AlignLeft
    }

    TextSection {
        id: labelSection
        titleText: qsTrc("propertiespanel", "Label")
    ...
    CheckBoxPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Align symbol with barline")
