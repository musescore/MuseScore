...
class FretDiagramSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    ...
    Q_PROPERTY(mu::propertiespanel::PropertyItem * stringsCount READ stringsCount CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * fretsCount READ fretsCount CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * fretNumber READ fretNumber CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * isNutVisible READ isNutVisible CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * placement READ placement CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * orientation READ orientation CONSTANT)
    ...
    Q_PROPERTY(mu::propertiespanel::PropertyItem * showFingerings READ showFingerings CONSTANT)
    Q_PROPERTY(QStringList fingerings READ fingerings NOTIFY fingeringsChanged)
    Q_PROPERTY(QStringList displayFingerings READ displayFingerings NOTIFY fingeringsChanged)
