    ...
    Column {
        ...
        Item {
            ...
            SpinBoxPropertyView {
                ...
                titleText: qsTrc("propertiespanel", "Strings")
        ...
        Item {
            ...
            SpinBoxPropertyView {
                ...
                titleText: qsTrc("propertiespanel", "Visible frets")
            ...
            SpinBoxPropertyView {
                ...
                titleText: qsTrc("propertiespanel", "Fret number")
        ...
        PropertyCheckBox {
            ...
            text: qsTrc("propertiespanel", "Show nut")
        ...
        FlatRadioButtonGroupPropertyView {
            ...
            titleText: qsTrc("propertiespanel", "Orientation")
            propertyItem: root.model ? root.model.orientation : null

            model: [
                { text: qsTrc("propertiespanel", "Vertical"), value: FretDiagramTypes.ORIENTATION_VERTICAL },
                { text: qsTrc("propertiespanel", "Horizontal"), value: FretDiagramTypes.ORIENTATION_HORIZONTAL }
            ]
        ...
        PropertyCheckBox {
            ...
            text: qsTrc("propertiespanel", "Exclude from vertical alignment")
