...
{
    setModelType(PropertiesPanelModelType::TYPE_FRET_DIAGRAM);
    setTitle(muse::qtrc("propertiespanel", "Fretboard diagram"));
...
{
    return m_elementList.count() == 1; // FretDiagram propertiespanel doesn't support multiple selection
}
