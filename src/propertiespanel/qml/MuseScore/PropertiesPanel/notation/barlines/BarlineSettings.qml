...
Column {
    ...
    DropdownPropertyView {
        id: styleSection
        titleText: qsTrc("propertiespanel", "Type")
        ...
        model: [
            { text: qsTrc("propertiespanel", "Single barline"), value: BarlineTypes.TYPE_NORMAL },
            { text: qsTrc("propertiespanel", "Double barline"), value: BarlineTypes.TYPE_DOUBLE },
            { text: qsTrc("propertiespanel", "Dashed barline"), value: BarlineTypes.TYPE_DASHED },
            { text: qsTrc("propertiespanel", "Final barline"), value: BarlineTypes.TYPE_FINAL },
            { text: qsTrc("propertiespanel", "Dotted barline"), value: BarlineTypes.TYPE_DOTTED },
            { text: qsTrc("propertiespanel", "Reverse final barline"), value: BarlineTypes.TYPE_REVERSE_END },
            { text: qsTrc("propertiespanel", "Heavy barline"), value: BarlineTypes.TYPE_HEAVY },
            { text: qsTrc("propertiespanel", "Heavy double barline"), value: BarlineTypes.TYPE_DOUBLE_HEAVY },
            { text: qsTrc("propertiespanel", "Left (start) repeat barline"), value: BarlineTypes.TYPE_START_REPEAT },
            { text: qsTrc("propertiespanel", "Right (end) repeat barline"), value: BarlineTypes.TYPE_END_REPEAT },
            { text: qsTrc("propertiespanel", "Right and left (end/start) repeat barline"), value: BarlineTypes.TYPE_END_START_REPEAT },
        ]
    }

    FlatRadioButtonGroupPropertyView {
        id: repeatStyleSection
        titleText: qsTrc("propertiespanel", "Repeat style")
    ...
    SpinBoxPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Play count")
    ...
    ExpandableBlank {
        ...
        contentItemComponent: Column {
            ...
            PropertyCheckBox {
                ...
                text: qsTrc("propertiespanel", "Span to next staff")
            ...
            Item {
                ...
                SpinBoxPropertyView {
                    ...
                    titleText: qsTrc("propertiespanel", "Span from")
                ...
                SpinBoxPropertyView {
                    ...
                    titleText: qsTrc("propertiespanel", "Span to")
            ...
            FlatButton {
                ...
                text: qsTrc("propertiespanel", "Set as staff default")
            ...
            Column {
                ...
                StyledTextLabel {
                    id: spanPresetsLabel
                    width: parent.width
                    text: qsTrc("propertiespanel", "Span presets")
                ...
                RowLayout {
                    ...
                    FlatButton {
                        text: qsTrc("propertiespanel", "Default")
                    ...
                    FlatButton {
                        text: qsTrc("propertiespanel", "Tick 1")
                        Layout.fillWidth: true
                    ...
                    FlatButton {
                        text: qsTrc("propertiespanel", "Tick 2")
                        Layout.fillWidth: true
                ...
                RowLayout {
                    ...
                    FlatButton {
                        text: qsTrc("propertiespanel", "Short 1")
                        Layout.fillWidth: true
                    ...
                    FlatButton {
                        text: qsTrc("propertiespanel", "Short 2")
                        Layout.fillWidth: true
