...
ExpressionSettingsModel::ExpressionSettingsModel(QObject* parent, const muse::modularity::ContextPtr& iocCtx,
    ...
    : ModelWithVoiceAndPositionOptions(parent, iocCtx, repository)
{
    setModelType(PropertiesPanelModelType::TYPE_EXPRESSION);
    setTitle(muse::qtrc("propertiespanel ", "Expression"));
...
{
    ModelWithVoiceAndPositionOptions::createProperties();
...
{
    ModelWithVoiceAndPositionOptions::loadProperties();
