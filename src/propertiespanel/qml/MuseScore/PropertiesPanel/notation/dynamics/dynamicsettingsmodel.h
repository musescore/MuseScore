...
class DynamicsSettingsModel : public ModelWithVoiceAndPositionOptions
{
    Q_OBJECT
    QML_ELEMENT;
    ...
    Q_PROPERTY(mu::propertiespanel::PropertyItem * frameType READ frameType CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * frameBorderColor READ frameBorderColor CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * frameFillColor READ frameFillColor CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * frameThickness READ frameThickness CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * frameMargin READ frameMargin CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * frameCornerRadius READ frameCornerRadius CONSTANT)
