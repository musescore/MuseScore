...
Column {
    ...
    required property TempoSettingsModel model
    ...
    PropertyCheckBox {
        ...
        text: qsTrc("propertiespanel", "Follow written tempo")
    ...
    SpinBoxPropertyView {
        titleText: qsTrc("propertiespanel", "Override written tempo")
        ...
        measureUnitsSymbol: qsTrc("propertiespanel", "BPM")
