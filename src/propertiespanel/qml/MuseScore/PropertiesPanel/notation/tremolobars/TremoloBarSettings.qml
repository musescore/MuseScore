...
Item {
    ...
    Column {
        ...
        DropdownPropertyView {
            ...
            titleText: qsTrc("propertiespanel", "Tremolo bar type")
            ...
            model: [
                { text: qsTrc("propertiespanel", "Dip"), value: TremoloBarTypes.TYPE_DIP },
                { text: qsTrc("propertiespanel", "Dive"), value: TremoloBarTypes.TYPE_DIVE },
                { text: qsTrc("propertiespanel", "Release (Up)"), value: TremoloBarTypes.TYPE_RELEASE_UP },
                { text: qsTrc("propertiespanel", "Inverted dip"), value: TremoloBarTypes.TYPE_INVERTED_DIP },
                { text: qsTrc("propertiespanel", "Return"), value: TremoloBarTypes.TYPE_RETURN },
                { text: qsTrc("propertiespanel", "Release (Down)"), value: TremoloBarTypes.TYPE_RELEASE_DOWN },
                { text: qsTrc("propertiespanel", "Custom"), value: TremoloBarTypes.TYPE_CUSTOM }
            ]
        }
        ...
        PropertyView {
            ...
            titleText: qsTrc("propertiespanel", "Click to add or remove points")
    ...
    StyledTextLabel {
        ...
        wrapMode: Text.Wrap
        text: qsTrc("propertiespanel", "You have multiple tremolo bars selected. Select a single one to edit its settings.")
        visible: root.model ? !root.model.areSettingsAvailable : false
    }
}
