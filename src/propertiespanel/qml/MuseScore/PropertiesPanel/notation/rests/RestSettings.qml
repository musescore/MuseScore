...
Column {
    ...
    readonly property RestBeamSettingsModel beamModel: model ? model.modelByType(PropertiesPanelAbstractModel.TYPE_BEAM) : null
    readonly property RestSettingsModel restModel: model ? model.modelByType(PropertiesPanelAbstractModel.TYPE_REST_REST) : null
    ...
    PropertyToggle {
        ...
        text: qsTrc("propertiespanel", "Align with other rests in the same voice")
    }
}
