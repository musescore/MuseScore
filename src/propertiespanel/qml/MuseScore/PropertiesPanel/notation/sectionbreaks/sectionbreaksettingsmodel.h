...
class SectionBreakSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::PropertyItem * shouldStartWithLongInstrNames READ shouldStartWithLongInstrNames CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * shouldResetBarNums READ shouldResetBarNums CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * pauseDuration READ pauseDuration CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * firstSystemIndent READ firstSystemIndent CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * showCourtesySignatures READ showCourtesySignatures CONSTANT)
