...
PropertyView {
    ...
    FocusableItem {
        ...
        StyledGridView {
            ...
            model: [
                { value: Beam.MODE_AUTO, iconCode: IconCode.AUTO_TEXT, hint: qsTrc("propertiespanel", "Auto") },
                { value: Beam.MODE_NONE, iconCode: IconCode.BEAM_NONE, hint: qsTrc("propertiespanel", "No beam") },
                { value: Beam.MODE_BEGIN, iconCode: IconCode.BEAM_BREAK_LEFT, hint: qsTrc("propertiespanel", "Break beam left") },
                { value: Beam.MODE_BEGIN32, iconCode: IconCode.BEAM_BREAK_INNER_8TH, hint: qsTrc("propertiespanel", "Break inner beams (8th)") },
                { value: Beam.MODE_BEGIN64, iconCode: IconCode.BEAM_BREAK_INNER_16TH, hint: qsTrc("propertiespanel", "Break inner beams (16th)") },
                { value: Beam.MODE_MID, iconCode: IconCode.BEAM_JOIN, hint: qsTrc("propertiespanel", "Join beams") },
            ]
