...
class BeamModesModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    ...
    Q_PROPERTY(mu::propertiespanel::PropertyItem * isFeatheringAvailable READ isFeatheringAvailable CONSTANT)
