...
Column {
    ...
    required property PropertiesPanelAbstractModel model
    ...
    FlatRadioButtonGroupPropertyView {
        ...
        titleLabelComponent: Component {
            ...
            StyledTextLabel {
                width: parent.width
                text: qsTrc("propertiespanel", "Play count text")
        ...
        model: [
            { text: qsTrc("propertiespanel", "Auto"), value: BarlineTypes.COUNT_AUTO },
            { text: qsTrc("propertiespanel", "Custom"), value: BarlineTypes.COUNT_CUSTOM },
            { text: qsTrc("propertiespanel", "Hide"), value: BarlineTypes.COUNT_HIDE }
        ]
    }
