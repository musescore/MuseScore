...
class MMRestSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::PropertyItem * isNumberVisible READ isNumberVisible CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * numberPosition READ numberPosition CONSTANT)
