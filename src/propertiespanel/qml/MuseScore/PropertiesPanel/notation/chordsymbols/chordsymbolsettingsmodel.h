...
class ChordSymbolSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::PropertyItem * isLiteral READ isLiteral CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * voicingType READ voicingType CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * durationType READ durationType CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * verticalAlign READ verticalAlign CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * bassScale READ bassScale CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * doNotStackModifiers READ doNotStackModifiers CONSTANT)
