...
Column {
    ...
    Item {
        ...
        DropdownPropertyView {
            ...
            titleText: qsTrc("propertiespanel", "Top note")
            showButton: false
    ...
    Item {
        ...
        DropdownPropertyView {
            ...
            titleText: qsTrc("propertiespanel", "Bottom note")
            showButton: false
    ...
    FlatButton {
        id: updateButton
        width: parent.width
        text: qsTrc("propertiespanel", "Update to match the notes on the staff")
    ...
    ExpandableBlank {
        ...
        contentItemComponent: Column {
            ...
            FlatRadioButtonGroupPropertyView {
                ...
                model: [
                    { iconCode: IconCode.AMBITUS, value: DirectionTypes.HORIZONTAL_AUTO, title: qsTrc("propertiespanel", "Auto") },
                    { iconCode: IconCode.AMBITUS_LEANING_LEFT, value: DirectionTypes.HORIZONTAL_LEFT, title: qsTrc("propertiespanel", "Left") },
                    { iconCode: IconCode.AMBITUS_LEANING_RIGHT, value: DirectionTypes.HORIZONTAL_RIGHT, title: qsTrc("propertiespanel", "Right") }
                ]
            }
