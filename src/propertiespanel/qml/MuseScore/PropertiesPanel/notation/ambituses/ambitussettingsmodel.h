...
class AmbitusSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::PropertyItem * noteheadGroup READ noteheadGroup CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * noteheadType READ noteheadType CONSTANT)

    Q_PROPERTY(mu::propertiespanel::PropertyItem * topTpc READ topTpc CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * bottomTpc READ bottomTpc CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * topOctave READ topOctave CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * bottomOctave READ bottomOctave CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * topPitch READ topPitch CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * bottomPitch READ bottomPitch CONSTANT)
