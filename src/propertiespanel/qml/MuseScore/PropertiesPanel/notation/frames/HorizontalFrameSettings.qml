...
Column {
    ...
    PropertyCheckBox {
        ...
        text: qsTrc("propertiespanel", "Scale with staff size")
    ...
    SpinBoxPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Width")
    ...
    PropertyCheckBox {
        text: qsTrc("propertiespanel", "Display brackets, clefs and key signatures in the next measure")
