...
class FretFrameChordsSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::FretFrameChordListModel * chordListModel READ chordListModel CONSTANT)

    Q_PROPERTY(mu::propertiespanel::PropertyItem * listOrder READ listOrder CONSTANT)
