...
{
    setModelType(PropertiesPanelModelType::TYPE_FRET_FRAME);
    setTitle(muse::qtrc("propertiespanel", "Fretboard diagram legend"));
    setIcon(muse::ui::IconCode::Code::FRET_FRAME);

    QList<PropertiesPanelAbstractModel*> models {
        PropertiesPanelModelFactory::newPropertiesPanelListModel(PropertiesPanelModelType::TYPE_FRET_FRAME_CHORDS, this, iocCtx,
                                                                 repository),
        PropertiesPanelModelFactory::newPropertiesPanelListModel(PropertiesPanelModelType::TYPE_FRET_FRAME_SETTINGS, this, iocCtx,
                                                                 repository)
    };
