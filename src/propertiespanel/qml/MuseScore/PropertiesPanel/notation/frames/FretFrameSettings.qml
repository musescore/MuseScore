...
Column {
    ...
    readonly property FretFrameChordsSettingsModel frameChordsModel: model ? model.modelByType(PropertiesPanelAbstractModel.TYPE_FRET_FRAME_CHORDS) : null
    readonly property FretFrameSettingsModel frameSettingsModel: model ? model.modelByType(PropertiesPanelAbstractModel.TYPE_FRET_FRAME_SETTINGS) : null
