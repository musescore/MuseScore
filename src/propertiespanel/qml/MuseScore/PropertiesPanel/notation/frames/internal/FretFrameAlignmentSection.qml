...
PropertyView {
    ...
    titleText: qsTrc("propertiespanel", "Alignment")
        ...
        model: [
            {
                ...
                title: qsTrc("propertiespanel", "Align left"),
                description: qsTrc("propertiespanel", "Align left edge of legend to reference point")
            },
            {
                iconCode: IconCode.ALIGN_HORIZONTAL_CENTER,
                value: CommonTypes.HCENTER,
                title: qsTrc("propertiespanel", "Align center"),
                description: qsTrc("propertiespanel", "Align horizontal center of legend to reference point")
            },
            {
                iconCode: IconCode.ALIGN_RIGHT,
                value: CommonTypes.RIGHT,
                title: qsTrc("propertiespanel", "Align right"),
                description: qsTrc("propertiespanel", "Align right edge of legend to reference point")
            }
        ]
