...
Item {
    ...
    StyledTextLabel {
        ...
        text: qsTrc("propertiespanel", "Gap to staff/frames")
    ...
    SpinBoxPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Above")
        ...
        accessibleName: qsTrc("propertiespanel", "Gap to staff/frames above")
    }
    ...
    SpinBoxPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Below")
        ...
        accessibleName: qsTrc("propertiespanel", "Gap to staff/frames below")
    }
    ...
    StyledTextLabel {
        ...
        horizontalAlignment: Text.AlignLeft
        text: qsTrc("propertiespanel", "Clearance for notation")
        font: ui.theme.bodyBoldFont
    }
    ...
    SpinBoxPropertyView {
        ...
        accessibleName: qsTrc("propertiespanel", "Clearance for notation above")
    }
    ...
    SpinBoxPropertyView {
        ...
        accessibleName: qsTrc("propertiespanel", "Clearance for notation below")
    }
}
