...
GlissandoSettingsModel::GlissandoSettingsModel(QObject* parent, const muse::modularity::ContextPtr& iocCtx,
    ...
    : PropertiesPanelAbstractModel(parent, iocCtx, repository, mu::engraving::ElementType::GLISSANDO)
{
    setModelType(PropertiesPanelModelType::TYPE_GLISSANDO);
    setTitle(muse::qtrc("propertiespanel", "Glissando"));
...
QVariantList GlissandoSettingsModel::possibleLineTypes() const
{
    QMap<mu::engraving::GlissandoType, QString> types {
        { mu::engraving::GlissandoType::STRAIGHT, muse::qtrc("propertiespanel", "Straight") },
        { mu::engraving::GlissandoType::WAVY, muse::qtrc("propertiespanel", "Wavy") }
    };
