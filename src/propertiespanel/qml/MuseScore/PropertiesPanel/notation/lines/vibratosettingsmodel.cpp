...
VibratoSettingsModel::VibratoSettingsModel(QObject* parent, const muse::modularity::ContextPtr& iocCtx,
    ...
    : PropertiesPanelAbstractModel(parent, iocCtx, repository, mu::engraving::ElementType::VIBRATO)
{
    setModelType(PropertiesPanelModelType::TYPE_VIBRATO);
    setTitle(muse::qtrc("propertiespanel", "Vibrato"));
...
QVariantList VibratoSettingsModel::possibleLineTypes() const
{
    QMap<mu::engraving::VibratoType, QString> types {
        { mu::engraving::VibratoType::GUITAR_VIBRATO, muse::qtrc("propertiespanel", "Vibrato") },
        { mu::engraving::VibratoType::GUITAR_VIBRATO_WIDE, muse::qtrc("propertiespanel", "Vibrato wide") },
        { mu::engraving::VibratoType::VIBRATO_SAWTOOTH, muse::qtrc("propertiespanel", "Vibrato sawtooth") },
        { mu::engraving::VibratoType::VIBRATO_SAWTOOTH_WIDE, muse::qtrc("propertiespanel", "Vibrato sawtooth wide") }
    };
