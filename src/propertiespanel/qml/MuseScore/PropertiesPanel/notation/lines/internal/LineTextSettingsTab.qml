...
FocusableItem {
    ...
    Column {
        ...
        TextSection {
            ...
            titleText: qsTrc("propertiespanel", "Beginning text")
        ...
        TextSection {
            ...
            titleText: qsTrc("propertiespanel", "Text when continuing to a new system")
        ...
        TextSection {
            id: endTextSection
            titleText: qsTrc("propertiespanel", "End text")
        ...
        SpinBoxPropertyView {
            ...
            titleText: qsTrc("propertiespanel", "Gap between text and line")
