...
FocusableItem {
    ...
    required property VoltaSettingsModel model
    ...
    Column {
        ...
        TextSection {
            ...
            titleText: qsTrc("propertiespanel", "Repeat list")
        ...
        Column {
            ...
            PropertyCheckBox {
                text: qsTrc("propertiespanel", "Show line")
            ...
            PropertyCheckBox {
                text: qsTrc("propertiespanel", "Allow diagonal")
