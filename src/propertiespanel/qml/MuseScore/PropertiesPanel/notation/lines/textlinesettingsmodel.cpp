...
TextLineSettingsModel::TextLineSettingsModel(QObject* parent, const muse::modularity::ContextPtr& iocCtx,
    ...
    : ModelWithVoiceAndPositionOptions(parent, iocCtx, repository, elementType)
{
    setModelType(PropertiesPanelModelType::TYPE_TEXT_LINE);
    setTitle(muse::qtrc("propertiespanel", "Text line"));
...
void TextLineSettingsModel::updateStartAndEndHookTypes()
{
    static const QList<HookTypeInfo> startHookTypes {
        ...
        { mu::engraving::HookType::HOOK_90, IconCode::LINE_WITH_START_HOOK, muse::qtrc("propertiespanel", "Hooked 90°", "hook type") },
        { mu::engraving::HookType::HOOK_45, IconCode::LINE_WITH_ANGLED_START_HOOK,
          muse::qtrc("propertiespanel", "Hooked 45°", "hook type") },
        { mu::engraving::HookType::HOOK_90T, IconCode::LINE_WITH_T_LINE_START_HOOK,
          muse::qtrc("propertiespanel", "Hooked 90° T-style", "hook type") },
        { mu::engraving::HookType::ARROW, IconCode::LINE_ARROW_LEFT, muse::qtrc("propertiespanel", "Line arrow", "hook type") },
        { mu::engraving::HookType::ARROW_FILLED, IconCode::FILLED_ARROW_LEFT, muse::qtrc("propertiespanel", "Filled arrow", "hook type") }
    };
...
void TextLineSettingsModel::onNotationChanged(const PropertyIdSet& changedPropertyIdSet, const StyleIdSet& styleIdSet)
{
    ...
    ModelWithVoiceAndPositionOptions::onNotationChanged(changedPropertyIdSet, styleIdSet);
}
