...
Column {
    ...
    LineStyleSection {
        ...
        lineStyleTitleText: qsTrc("propertiespanel", "Style")
    }
    ...
    FlatRadioButtonGroupPropertyView {
        ...
        titleText: root.isLaissezVib ? qsTrc("propertiespanel", "Laissez vibrer placement") : qsTrc("propertiespanel", "Tie placement")

        navigationPanel: root.navigationPanel
        navigationRowStart: placementSection.navigationRowEnd + 1

        model: [
            { text: qsTrc("propertiespanel", "Auto"), value: SlurTieTypes.TIE_PLACEMENT_AUTO, title: qsTrc("propertiespanel", "Auto")  },
            { iconCode: root.isLaissezVib ? IconCode.LV_INSIDE : IconCode.TIE_INSIDE, value: SlurTieTypes.TIE_PLACEMENT_INSIDE, title: qsTrc("propertiespanel", "Inside") },
            { iconCode: root.isLaissezVib ? IconCode.LV_OUTSIDE : IconCode.TIE_OUTSIDE, value: SlurTieTypes.TIE_PLACEMENT_OUTSIDE, title: qsTrc("propertiespanel", "Outside")  }
        ]
    }
    ...
    SpinBoxPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Minimum length")
