...
class OttavaSettingsModel : public TextLineSettingsModel
{
    ...
    Q_PROPERTY(mu::propertiespanel::PropertyItem * ottavaType READ ottavaType CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * showNumbersOnly READ showNumbersOnly CONSTANT)
