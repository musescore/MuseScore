...
{
    setModelType(PropertiesPanelModelType::TYPE_PEDAL);
    setTitle(muse::qtrc("propertiespanel", "Pedal"));
...
void PedalSettingsModel::updateStartAndEndHookTypes()
{
    ...
    static const QList<HookTypeInfo> endHookTypes {
        { mu::engraving::HookType::NONE, IconCode::LINE_NORMAL, muse::qtrc("propertiespanel", "Normal", "hook type") },
        { mu::engraving::HookType::ROSETTE, IconCode::LINE_PEDAL_STAR_ENDING, muse::qtrc("propertiespanel", "Asterisk", "hook type") },
