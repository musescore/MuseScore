...
{
    setModelType(PropertiesPanelModelType::TYPE_VOLTA);
    setTitle(muse::qtrc("propertiespanel", "Volta"));
...
void VoltaSettingsModel::updateStartAndEndHookTypes()
{
    ...
    static const QList<HookTypeInfo> endHookTypes {
        { mu::engraving::HookType::NONE, IconCode::LINE_WITH_INVERTED_START_HOOK,
          muse::qtrc("propertiespanel", "Normal", "volta hook type") },
        { mu::engraving::HookType::HOOK_90, IconCode::LINE_WITH_TWO_INVERTED_HOOKS,
          muse::qtrc("propertiespanel", "Hooked 90°", "volta hook type") }
    };
