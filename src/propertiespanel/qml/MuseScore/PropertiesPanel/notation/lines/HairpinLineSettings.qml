    ...
    StackLayout {
        ...
        Loader {
            ...
            sourceComponent: {
                ...
                switch (modelType) {
                case PropertiesPanelAbstractModel.TYPE_HAIRPIN: return hairpinStyleSettings
                case PropertiesPanelAbstractModel.TYPE_CRESCENDO: return crescendoDiminuendoSettings
                case PropertiesPanelAbstractModel.TYPE_DIMINUENDO: return crescendoDiminuendoSettings
                }
