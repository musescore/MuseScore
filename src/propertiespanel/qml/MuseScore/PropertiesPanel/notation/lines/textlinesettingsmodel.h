...
class TextLineSettingsModel : public ModelWithVoiceAndPositionOptions
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::PropertyItem * isLineVisible READ isLineVisible CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * allowDiagonal READ allowDiagonal CONSTANT)
    ...
    Q_PROPERTY(mu::propertiespanel::PropertyItem * dashLineLength READ dashLineLength CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * dashGapLength READ dashGapLength CONSTANT)

    Q_PROPERTY(mu::propertiespanel::PropertyItem * startHookType READ startHookType CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * endHookType READ endHookType CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * startHookHeight READ startHookHeight CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * endHookHeight READ endHookHeight CONSTANT)

    Q_PROPERTY(mu::propertiespanel::PropertyItem * startLineArrowHeight READ startLineArrowHeight CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * startLineArrowWidth READ startLineArrowWidth CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * endLineArrowHeight READ endLineArrowHeight CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * endLineArrowWidth READ endLineArrowWidth CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * startFilledArrowHeight READ startFilledArrowHeight CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * startFilledArrowWidth READ startFilledArrowWidth CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * endFilledArrowHeight READ endFilledArrowHeight CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * endFilledArrowWidth READ endFilledArrowWidth CONSTANT)

    Q_PROPERTY(mu::propertiespanel::PropertyItem * gapBetweenTextAndLine READ gapBetweenTextAndLine CONSTANT)

    Q_PROPERTY(mu::propertiespanel::PropertyItem * placement READ placement CONSTANT)

    Q_PROPERTY(mu::propertiespanel::PropertyItem * beginningText READ beginningText CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * beginningTextOffset READ beginningTextOffset CONSTANT)

    Q_PROPERTY(mu::propertiespanel::PropertyItem * continuousText READ continuousText CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * continuousTextOffset READ continuousTextOffset CONSTANT)

    Q_PROPERTY(mu::propertiespanel::PropertyItem * endText READ endText CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * endTextOffset READ endTextOffset CONSTANT)
