...
Column {
    ...
    required property BracketSettingsModel model
    ...
    Item {
        ...
        SpinBoxPropertyView {
            ...
            titleText: qsTrc("propertiespanel", "Column")
        ...
        SpinBoxPropertyView {
            ...
            titleText: qsTrc("propertiespanel", "Span")
    ...
    Column {
        ...
        PropertyCheckBox {
            text: qsTrc("propertiespanel", "Show text")
            propertyItem: root.model ? root.model.showText : null
        }

        PropertyCheckBox {
            text: qsTrc("propertiespanel", "Show bracket")
            propertyItem: root.model ? root.model.showBracket : null
        }

        StyledTextLabel {
            text: qsTrc("propertiespanel", "Long name")
        }
        ...
        StyledTextLabel {
            text: qsTrc("propertiespanel", "Abbreviated name")
        }
    ...
    StyledTextLabel {
        ...
        text: qsTrc("propertiespanel", "You have multiple brackets selected. Select a single bracket to edit its settings.")
        wrapMode: Text.Wrap
    }
}
