...
class BracketSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::PropertyItem * bracketColumnPosition READ bracketColumnPosition CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * bracketSpanStaves READ bracketSpanStaves CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * longName READ longName CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * shortName READ shortName CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * showText READ showText CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * showBracket READ showBracket CONSTANT)
