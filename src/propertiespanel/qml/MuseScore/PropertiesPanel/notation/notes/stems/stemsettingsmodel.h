...
class StemSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    ...
    Q_PROPERTY(mu::propertiespanel::PropertyItem * length READ length CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * offset READ offset CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * stemDirection READ stemDirection CONSTANT)
