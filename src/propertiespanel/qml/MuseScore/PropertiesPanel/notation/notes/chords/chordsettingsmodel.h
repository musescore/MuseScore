...
class ChordSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    ...
    Q_PROPERTY(mu::propertiespanel::PropertyItem * showStemSlash READ showStemSlash CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * combineVoice READ combineVoice CONSTANT)
