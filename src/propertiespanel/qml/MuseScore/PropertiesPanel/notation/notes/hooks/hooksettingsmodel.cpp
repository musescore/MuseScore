...
{
    setModelType(PropertiesPanelModelType::TYPE_HOOK);
    setTitle(muse::qtrc("propertiespanel", "Flag")); // internally called "Hook", but "Flag" in SMuFL, so here externally too
