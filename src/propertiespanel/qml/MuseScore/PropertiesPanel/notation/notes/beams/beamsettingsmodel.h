...
class BeamSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::BeamModesModel * beamModesModel READ beamModesModel CONSTANT)

    Q_PROPERTY(mu::propertiespanel::PropertyItem * featheringHeightLeft READ featheringHeightLeft CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * featheringHeightRight READ featheringHeightRight CONSTANT)
    Q_PROPERTY(
        mu::propertiespanel::BeamTypes::FeatheringMode featheringMode READ featheringMode WRITE setFeatheringMode NOTIFY
    ...
    Q_PROPERTY(mu::propertiespanel::PropertyItem * beamHeightLeft READ beamHeightLeft CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * beamHeightRight READ beamHeightRight CONSTANT)
    Q_PROPERTY(bool isBeamHeightLocked READ isBeamHeightLocked WRITE setIsBeamHeightLocked NOTIFY isBeamHeightLockedChanged)

    Q_PROPERTY(mu::propertiespanel::PropertyItem * isBeamHidden READ isBeamHidden CONSTANT)

    Q_PROPERTY(mu::propertiespanel::PropertyItem * forceHorizontal READ forceHorizontal CONSTANT)

    Q_PROPERTY(mu::propertiespanel::PropertyItem * customPositioned READ customPositioned CONSTANT)

    Q_PROPERTY(mu::propertiespanel::PropertyItem * stemDirection READ stemDirection CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * crossStaffMove READ crossStaffMove CONSTANT)
    Q_PROPERTY(
        bool isCrossStaffMoveAvailable READ isCrossStaffMoveAvailable WRITE setIsCrossStaffMoveAvailable NOTIFY
