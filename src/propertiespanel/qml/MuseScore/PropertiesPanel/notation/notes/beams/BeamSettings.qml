...
FocusableItem {
    ...
    Column {
        ...
        BeamTypeSelector {
            id: beamTypeSection
            titleText: qsTrc("propertiespanel", "Beam type")
        ...
        Column {
            ...
            Column {
                ...
                StyledTextLabel {
                    ...
                    width: parent.width
                    text: qsTrc("propertiespanel", "Feathered beams")
                ...
                RadioButtonGroup {
                    ...
                    model: [
                        { text: qsTrc("propertiespanel", "None", "beam feathering type"), value: Beam.FEATHERING_NONE, title: qsTrc("propertiespanel", "None", "beam feathering type") },
                        { iconCode: IconCode.BEAM_FEATHERED_DECELERATE, value: Beam.FEATHERED_DECELERATE, title: qsTrc("propertiespanel", "Decelerate", "beam feathering type") },
                        { iconCode: IconCode.BEAM_FEATHERED_ACCELERATE, value: Beam.FEATHERED_ACCELERATE, title: qsTrc("propertiespanel", "Accelerate", "beam feathering type") }
                    ]
                ...
                Item {
                    ...
                    SpinBoxPropertyView {
                        ...
                        titleText: qsTrc("propertiespanel", "Feathering left")
                    ...
                    SpinBoxPropertyView {
                        ...
                        titleText: qsTrc("propertiespanel", "Feathering right")
            ...
            DirectionSection {
                ...
                titleText: qsTrc("propertiespanel", "Beam direction")
            ...
            PropertyView {
                ...
                titleText: qsTrc("propertiespanel", "Move cross-staff beam")
            ...
            PropertyCheckBox {
                ...
                text: qsTrc("propertiespanel", "Force horizontal")
            ...
            ExpandableBlank {
                ...
                contentItemComponent: Column {
                    ...
                    PropertyView {
                        id: beamHeight
                        titleText: qsTrc("propertiespanel", "Beam height")
                        ...
                        Item {
                            ...
                            IncrementalPropertyControl {
                                ...
                                navigation.accessible.name: beamHeight.titleText + " " + qsTrc("propertiespanel", "Left") + " " + currentValue
                            ...
                            IncrementalPropertyControl {
                                ...
                                navigation.accessible.name: beamHeight.titleText + " " + qsTrc("propertiespanel", "Right") + " " + currentValue
