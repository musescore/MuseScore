...
class NoteSettingsProxyModel : public PropertiesPanelAbstractProxyModel
{
    Q_OBJECT
    QML_ELEMENT;
...
private:
    ...
    PropertiesPanelModelType resolveDefaultSubModelType(const QList<mu::engraving::EngravingItem*>& newElements) const;
};
}
