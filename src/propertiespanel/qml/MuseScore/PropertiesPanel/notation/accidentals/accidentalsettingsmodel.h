...
class AccidentalSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::PropertyItem * bracketType READ bracketType CONSTANT)
    ...
    Q_PROPERTY(mu::propertiespanel::PropertyItem * stackingOrderOffset READ stackingOrderOffset CONSTANT)
