...
{
    setModelType(PropertiesPanelModelType::TYPE_BEND);
    setTitle(muse::qtrc("propertiespanel", "Bend/dive"));
...
void BendSettingsModel::loadBendCurve()
{
    ...
    QString startPointName = muse::qtrc("propertiespanel", "Start point");
    QString midPointName = muse::qtrc("propertiespanel", "Midpoint");
    QString endPointName = muse::qtrc("propertiespanel", "End point");
