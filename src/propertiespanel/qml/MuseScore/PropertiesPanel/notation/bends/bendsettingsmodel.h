...
class BendSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::PropertyItem * bendDirection READ bendDirection CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * showHoldLine READ showHoldLine CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * diveTabPos READ diveTabPos CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * dipVibratoType READ dipVibratoType CONSTANT)
