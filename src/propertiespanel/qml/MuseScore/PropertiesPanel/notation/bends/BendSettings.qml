...
Column {
    ...
    FlatRadioButtonGroupPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Hold line")
        ...
        model: [
            { text: qsTrc("propertiespanel", "Auto"), value: BendTypes.SHOW_HOLD_AUTO},
            { text: qsTrc("propertiespanel", "Show"), value: BendTypes.SHOW_HOLD_SHOW},
            { text: qsTrc("propertiespanel", "Hide"), value: BendTypes.SHOW_HOLD_HIDE},
        ]
    }
    ...
    FlatRadioButtonGroupPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Tremolo line")
        ...
        model: [
            { text: qsTrc("propertiespanel", "None"), value: BendTypes.VIBRATO_NONE },
            { text: qsTrc("propertiespanel", "Normal"), value: BendTypes.VIBRATO_VIBRATO },
            { text: qsTrc("propertiespanel", "Wide"), value: BendTypes.VIBRATO_VIBRATO_WIDE },
        ]
    }
    ...
    FlatRadioButtonGroupPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Tablature staff layout")
        ...
        model: [
            { text: qsTrc("propertiespanel", "Auto"), value: DirectionTypes.VERTICAL_AUTO},
            { text: qsTrc("propertiespanel", "On staff"), value: DirectionTypes.VERTICAL_DOWN},
            { text: qsTrc("propertiespanel", "Above staff"), value: DirectionTypes.VERTICAL_UP},
        ]
    }
    ...
    FlatRadioButtonGroupPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Line style")
    ...
    PropertyView {
        id: bend
        titleText: root.model && root.model.isDive ? qsTrc("propertiespanel", "Customize dive") : qsTrc("propertiespanel", "Customize bend")
        ...
        Item {
            ...
            NavigationControl {
                ...
                accessible.name: bend.titleText + "; " + qsTrc("propertiespanel", "Press Enter to start editing")
