...
{
    setSectionType(PropertiesPanelSectionType::SECTION_TEXT);
    setTitle(muse::qtrc("propertiespanel", "Text"));
    createProperties();
...
void TextSettingsModel::updateLeftPositionText()
{
    for (EngravingItem* item : m_elementList) {
        ...
        if (item->parent()->isBox()) {
            setLeftPositionText(muse::qtrc("propertiespanel", "Left-align text box within frame"));
        } else if (item->isTextBase() && toTextBase(item)->positionRelativeToNoteheadRest()) {
            setLeftPositionText(muse::qtrc("propertiespanel", "Left-align text box to note/rest"));
        } else {
            setLeftPositionText(muse::qtrc("propertiespanel", "Left-align text box to barline"));
        }
        return;
    }
}
...
void TextSettingsModel::updateCenterPositionText()
{
    for (EngravingItem* item : m_elementList) {
        ...
        if (item->parent()->isBox()) {
            setCenterPositionText(muse::qtrc("propertiespanel", "Horizontally center text box within frame"));
        } else if (item->isTextBase() && toTextBase(item)->positionRelativeToNoteheadRest()) {
            setCenterPositionText(muse::qtrc("propertiespanel", "Horizontally center text box to note/rest"));
        } else {
            setCenterPositionText(muse::qtrc("propertiespanel", "Horizontally center text box to barline"));
        }
        return;
    }
}
...
void TextSettingsModel::updateRightPositionText()
{
    for (EngravingItem* item : m_elementList) {
        ...
        if (item->parent()->isBox()) {
            setRightPositionText(muse::qtrc("propertiespanel", "Right-align text box within frame"));
        } else if (item->isTextBase() && toTextBase(item)->positionRelativeToNoteheadRest()) {
            setRightPositionText(muse::qtrc("propertiespanel", "Right-align text box to note/rest"));
        } else {
            setRightPositionText(muse::qtrc("propertiespanel", "Right-align text box to barline"));
        }
        return;
    }
}
