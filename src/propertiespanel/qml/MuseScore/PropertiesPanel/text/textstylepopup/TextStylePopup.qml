...
AbstractElementPopup {
    ...
    RowLayout {
        ...
        NavigationPanel {
            ...
            accessible.name: qsTrc("propertiespanel", "Text style settings buttons")
        }
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                FontDropdown { // 1
                    ...
                    navigation.row: 1
                    navigation.accessible.name: qsTrc("propertiespanel", "Font")
                ...
                IncrementalPropertyControl { // 2
                    ...
                    navigation.accessible.name: qsTrc("propertiespanel", "Font size")
                ...
                RadioButtonGroup { // 3
                    ...
                    delegate: FlatRadioButton {
                        ...
                        navigation.accessible.name: qsTrc("propertiespanel", "Vertical alignment buttons")
            ...
            RowLayout {
                ...
                RadioButtonGroup { // 6
                    ...
                    delegate: FlatToggleButton {
                        ...
                        navigation.accessible.name: qsTrc("propertiespanel", "Text style buttons")
                ...
                RadioButtonGroup { // 7
                    ...
                    model: [
                        {
                            ...
                            description: qsTrc("propertiespanel", "Align left edge of text to reference point")
                        },
                        {
                            iconRole: IconCode.TEXT_ALIGN_CENTER,
                            typeRole: TextTypes.FONT_ALIGN_H_CENTER,
                            title: qsTrc("propertiespanel", "Align center"),
                            description: qsTrc("propertiespanel", "Align horizontal center of text to reference point")
                        },
                        {
                            iconRole: IconCode.TEXT_ALIGN_RIGHT,
                            typeRole: TextTypes.FONT_ALIGN_H_RIGHT,
                            title: qsTrc("propertiespanel", "Align right"),
                            description: qsTrc("propertiespanel", "Align right edge of text to reference point")
                        },
                        {
                    ...
                    delegate: FlatRadioButton {
                        ...
                        navigation.accessible.name: qsTrc("propertiespanel", "Horizontal alignment buttons")
                ...
                RadioButtonGroup { // 8
                    ...
                    model: [
                        {
                            ...
                            titleRole: qsTrc("propertiespanel", "Subscript")
                        },
                        {
                            iconRole: IconCode.TEXT_SUPERSCRIPT,
                            typeRole: TextTypes.TEXT_SUBSCRIPT_TOP,
                            titleRole: qsTrc("propertiespanel", "Superscript")
                        }
                    ]
                    ...
                    delegate: FlatRadioButton {
                        ...
                        navigation.accessible.name: qsTrc("propertiespanel", "Subscript buttons")
                ...
                RowLayout {
                    ...
                    StyledTextLabel {
                        ...
                        text: qsTrc("propertiespanel", "Line spacing:")
                    }
                    ...
                    IncrementalPropertyControl {
                        ...
                        navigation.accessible.name: qsTrc("propertiespanel", "Line spacing")
        ...
        RowLayout {
            ...
            FlatButton { // 4
                ...
                icon: IconCode.FLAT
                text: qsTrc("propertiespanel", "Add symbols")
                maximumLineCount: 2
            ...
            ColumnLayout {
                ...
                FlatButton { // 5
                    ...
                    text: qsTrc("propertiespanel", "Text style")
