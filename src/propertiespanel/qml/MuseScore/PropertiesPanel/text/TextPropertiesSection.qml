...
PropertiesPanelSection {
    ...
    Column {
        ...
        DropdownPropertyView {
            ...
            titleText: qsTrc("propertiespanel", "Font")
                        ...
                        model: [
                            {
                                ...
                                description: qsTrc("propertiespanel", "Left-align text within its bounding box")
                            },
                            {
                                iconCode: IconCode.TEXT_ALIGN_CENTER,
                                value: TextTypes.FONT_ALIGN_H_CENTER,
                                title: qsTrc("propertiespanel", "Align center"),
                                description: qsTrc("propertiespanel", "Horizontally center text within its bounding box")
                            },
                            {
                                iconCode: IconCode.TEXT_ALIGN_RIGHT,
                                value: TextTypes.FONT_ALIGN_H_RIGHT,
                                title: qsTrc("propertiespanel", "Align right"),
                                description: qsTrc("propertiespanel", "Right-align text within its bounding box")
                            },
                            {
                                iconCode: IconCode.TEXT_ALIGN_JUSTIFY,
                                value: TextTypes.FONT_ALIGN_H_JUSTIFY,
                                title: qsTrc("propertiespanel", "Justify"),
                                description: qsTrc("propertiespanel", "Justify text to fill the available width")
                            }
                        ]
                ...
                model: [
                    {
                        ...
                        title: qsTrc("propertiespanel", "Align top"),
                        description: qsTrc("propertiespanel", "Align top edge of text to reference point")
                    },
                    {
                        iconCode: IconCode.TEXT_ALIGN_MIDDLE,
                        value: TextTypes.FONT_ALIGN_V_CENTER,
                        title: qsTrc("propertiespanel", "Align middle"),
                        description: qsTrc("propertiespanel", "Align vertical center of text to reference point")
                    },
                    {
                        iconCode: IconCode.TEXT_ALIGN_BOTTOM,
                        value: TextTypes.FONT_ALIGN_V_BOTTOM,
                        title:qsTrc("propertiespanel", "Align bottom"),
                        description: qsTrc("propertiespanel", "Align bottom edge of text to reference point")
                    },
                    {
                        iconCode: IconCode.TEXT_ALIGN_BASELINE,
                        value: TextTypes.FONT_ALIGN_V_BASELINE,
                        title: qsTrc("propertiespanel", "Align baseline"),
                        description: qsTrc("propertiespanel", "Align baseline of text to reference point")
                    }
                ]
        ...
        FlatButton {
            ...
            text: qsTrc("propertiespanel", "Insert special characters")
