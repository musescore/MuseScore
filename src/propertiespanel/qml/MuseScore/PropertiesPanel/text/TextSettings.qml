...
Column {
    ...
    SpinBoxPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Symbol size")
    ...
    Item {
        ...
        RadioButtonGroup {
            ...
            model: [
                { iconCode: IconCode.TEXT_SUBSCRIPT, value: TextTypes.TEXT_SUBSCRIPT_BOTTOM, title: qsTrc("propertiespanel", "Subscript") },
                { iconCode: IconCode.TEXT_SUPERSCRIPT, value: TextTypes.TEXT_SUBSCRIPT_TOP, title: qsTrc("propertiespanel", "Superscript") }
            ]
    ...
    SpinBoxPropertyView {
        ...
        titleText: qsTrc("propertiespanel", "Line spacing")
