...
class TextSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::PropertyItem * fontFamily READ fontFamily CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * fontStyle READ fontStyle CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * fontSize READ fontSize CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * textLineSpacing READ textLineSpacing CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * horizontalAlignment READ horizontalAlignment CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * verticalAlignment READ verticalAlignment CONSTANT)

    Q_PROPERTY(mu::propertiespanel::PropertyItem * horizontalPosition READ horizontalPosition CONSTANT)
    ...
    Q_PROPERTY(mu::propertiespanel::PropertyItem * textType READ textType CONSTANT)
    ...
    Q_PROPERTY(
        bool isSpecialCharactersInsertionAvailable READ isSpecialCharactersInsertionAvailable NOTIFY
