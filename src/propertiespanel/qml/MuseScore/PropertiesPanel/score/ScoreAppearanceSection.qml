    ...
    Column {
        ...
        RowLayout {
            ...
            CheckBox {
                ...
                text: qsTrc("propertiespanel", "Automatically hide all empty staves")
            ...
            PropertiesPanelPopupButton {
                ...
                accessible.name: qsTrc("propertiespanel", "Show options for hiding empty staves")
        ...
        FlatButton {
            ...
            text: qsTrc("propertiespanel", "Page settings")
        ...
        FlatButton {
            ...
            text: qsTrc("propertiespanel", "Style settings")
