...
class ScoreAppearanceSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    ...
    Q_PROPERTY(
        bool dontHideEmptyStavesInFirstSystem READ dontHideEmptyStavesInFirstSystem WRITE setDontHideEmptyStavesInFirstSystem NOTIFY
        dontHideEmptyStavesInFirstSystemChanged)
    Q_PROPERTY(
        bool showBracketsWhenSpanningSingleStaff READ showBracketsWhenSpanningSingleStaff WRITE setShowBracketsWhenSpanningSingleStaff
        NOTIFY showBracketsWhenSpanningSingleStaffChanged)
