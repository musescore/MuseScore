...
class SystemLayoutSettingsModel : public PropertiesPanelAbstractModel
{
    ...
    Q_PROPERTY(QString shortcutMoveSystemUpPage READ shortcutMoveSystemUpPage CONSTANT)
    Q_PROPERTY(QString shortcutMoveSystemDownPage READ shortcutMoveSystemDownPage CONSTANT)
...
public:
    ...
    Q_INVOKABLE void moveSystemUpPage();
    QString shortcutMoveSystemUpPage() const;
    Q_INVOKABLE void moveMeasureUpSystem();
    QString shortcutMoveMeasureUpSystem() const;

    Q_INVOKABLE void moveSystemDownPage();
    QString shortcutMoveSystemDownPage() const;
