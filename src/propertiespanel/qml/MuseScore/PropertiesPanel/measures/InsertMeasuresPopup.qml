...
Column {
    ...
    RowLayout {
        ...
        IncrementalPropertyControl {
            ...
            navigation.accessible.name: qsTrc("propertiespanel", "Number of measures to insert:") + " " + currentValue
        ...
        StyledDropdown {
            ...
            navigation.accessible.name: qsTrc("propertiespanel", "Where to insert measures:") + " " + currentText
    ...
    FlatButton {
        ...
        navigation.accessible.name: qsTrc("propertiespanel", "Insert measures")
