...
#include "propertiespanelpopupcontroller.h"
...
PropertiesPanelPopupController::PropertiesPanelPopupController(const kors::modularity::ContextPtr& iocCtx)
    :  QObject(nullptr), muse::Contextable(iocCtx)
{
}

PropertiesPanelPopupController::~PropertiesPanelPopupController()
{
    closePopup();
}

void PropertiesPanelPopupController::init()
{
...
void PropertiesPanelPopupController::setNotationView(const QQuickItem* view)
{
    m_notationView = view;
}

PopupView* PropertiesPanelPopupController::popup() const
{
    return m_popup;
}

void PropertiesPanelPopupController::setPopup(PopupView* popup, QQuickItem* control)
{
...
Notification PropertiesPanelPopupController::popupChanged() const
{
    return m_popupChanged;
}

DropdownView* PropertiesPanelPopupController::dropdown() const
{
    return m_dropdown;
}

void PropertiesPanelPopupController::setDropdown(DropdownView* dropdown)
{
...
Notification PropertiesPanelPopupController::dropdownChanged() const
{
    return m_dropdownChanged;
}

MenuView* PropertiesPanelPopupController::menu() const
{
    return m_menu;
}

void PropertiesPanelPopupController::setMenu(MenuView* menu)
{
    if (m_menu == menu) {
        return;
    }
...
Notification PropertiesPanelPopupController::menuChanged() const
{
    return m_menuChanged;
}

bool PropertiesPanelPopupController::eventFilter(QObject* watched, QEvent* event)
{
    if (m_popup) {
...
void PropertiesPanelPopupController::closePopupIfNeed(const QPointF& mouseGlobalPos)
{
...
void PropertiesPanelPopupController::closePopup()
{
    QMetaObject::invokeMethod(this, "doClosePopup");
}

void PropertiesPanelPopupController::doClosePopup()
{
    if (m_popup) {
        m_popup->close();
    }
