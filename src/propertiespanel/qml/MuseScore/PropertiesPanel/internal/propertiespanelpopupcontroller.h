...
#include "ipropertiespanelpopupcontroller.h"
...
class PropertiesPanelPopupController : public QObject, public IPropertiesPanelPopupController, public muse::Contextable
{
    Q_OBJECT
...
public:
    explicit PropertiesPanelPopupController(const muse::modularity::ContextPtr& iocCtx);
    ~PropertiesPanelPopupController() override;
