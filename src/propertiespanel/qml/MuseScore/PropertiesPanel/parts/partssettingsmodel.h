...
class PartsSettingsModel : public PropertiesPanelAbstractModel
{
    Q_OBJECT
    QML_ELEMENT;
    QML_UNCREATABLE("Not creatable from QML")

    Q_PROPERTY(mu::propertiespanel::PropertyItem * positionLinkedToMaster READ positionLinkedToMaster CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * appearanceLinkedToMaster READ appearanceLinkedToMaster CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * textLinkedToMaster READ textLinkedToMaster CONSTANT)
    Q_PROPERTY(mu::propertiespanel::PropertyItem * excludeFromOtherParts READ excludeFromOtherParts CONSTANT)
