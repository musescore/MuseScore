...
#include "qml/MuseScore/PropertiesPanel/types/texttypes.h"
...
QList<mu::engraving::EngravingItem*> ElementRepositoryService::findElementsByType(const mu::engraving::ElementType elementType) const
{
    ...
    case mu::engraving::ElementType::LAYOUT_BREAK: return findSectionBreaks(); //Page breaks and line breaks are of type LAYOUT_BREAK, but they don't appear in the propertiespanel for now.
...
const
{
    ...
    for (mu::engraving::EngravingItem* element : rawElementList) {
        ...
        //! crashes on invalid pointers in the propertiespanel
