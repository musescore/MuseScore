...
#ifndef MU_CLOUD_CLOUDUIACTIONS_H
#define MU_CLOUD_CLOUDUIACTIONS_H
...
namespace mu::cloud {
class CloudUiActions : public ui::IUiActionsModule, public async::Asyncable
{
    INJECT(palette, context::IUiContextResolver, uicontextResolver)

public:
    CloudUiActions(std::shared_ptr<CloudActionsController> controller);
