...
#ifndef MU_PIANOROLL_AUTOMATIONDURATIONMULT_H
#define MU_PIANOROLL_AUTOMATIONDURATIONMULT_H

#include "../ipianorollautomationmodel.h"

namespace mu::pianoroll {
class AutomationDurationMult : public IPianorollAutomationModel
{
public:
    AutomationDurationMult();
...
#endif // MU_PIANOROLL_AUTOMATIONDURATIONMULT_H
