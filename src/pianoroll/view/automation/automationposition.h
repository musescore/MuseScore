...
#ifndef MU_PIANOROLL_AUTOMATIONPOSITION_H
#define MU_PIANOROLL_AUTOMATIONPOSITION_H

#include "../ipianorollautomationmodel.h"

namespace mu::pianoroll {
class AutomationPosition : public IPianorollAutomationModel
{
public:
    AutomationPosition();
...
#endif // MU_PIANOROLL_AUTOMATIONPOSITION_H
