...
private:
    ...
    QRect boundingRect(engraving::Note* note);
    QRect boundingRect(engraving::Note* note, engraving::NoteEvent* evt);
    ...
    engraving::Fraction roundDownToSubdivision(double wholeNote);
