...
static constexpr UnicodeRange unicodeRanges[] = {
    { 0x0020, 0x007F, QT_TRANSLATE_NOOP("textpalette", "Basic Latin") },
    ...
    { 0x1400, 0x167F, QT_TRANSLATE_NOOP("textpalette", "Unified Canadian Aboriginal Syllabics Extended") },
    ...
    { 0x18B0, 0x18FF, QT_TRANSLATE_NOOP("textpalette", "Unified Canadian Aboriginal Syllabics") },
    ...
    { 0x20D0, 0x20FF, QT_TRANSLATE_NOOP("textpalette", "Combining Diacritical Marks for Symbol") },
