...
static const QString SOLOISTS_SCOREORDERGROUP("<soloists>");
static const QString UNSORTED_SCOREORDERGROUP("<unsorted>");
...
{
    QString id = m_selectedScoreOrderIndex <= 0 ? QString("---") : m_scoreOrders[m_selectedScoreOrderIndex].id;
