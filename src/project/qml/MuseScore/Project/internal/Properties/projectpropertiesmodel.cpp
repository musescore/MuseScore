...
void ProjectPropertiesModel::load()
{
    ...
    m_properties = {
        ...
        { COPYRIGHT_TAG, muse::qtrc("project", "Copyright"), m_projectMetaInfo.copyright, /*isStandard*/ true,
          /*isMultiLineEdit*/ true },
        { WORK_NUMBER_TAG, muse::qtrc("project", "Work number"), additionalProperties[WORK_NUMBER_TAG].toString(), true },
        { MOVEMENT_TITLE_TAG, muse::qtrc("project", "Movement title"), additionalProperties[MOVEMENT_TITLE_TAG].toString(),
          true },
