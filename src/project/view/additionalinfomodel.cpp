...
{
    setKeySignature(KeySignature(qtrc("project", "C major"), qtrc("project", "A minor"), IconCode::Code::KEY_SIGNATURE_NONE,
                                 Key::C).toMap());
...
QVariantList AdditionalInfoModel::keySignatureList() const
{
    QVariantList list = {
        ...
        KeySignature(qtrc("project", "F♯ major"), qtrc("project", "D♯ minor"), IconCode::Code::KEY_SIGNATURE_6_SHARPS, Key::F_S).toMap(),
        KeySignature(qtrc("project", "C♯ major"), qtrc("project", "A♯ minor"), IconCode::Code::KEY_SIGNATURE_7_SHARPS, Key::C_S).toMap(),
        KeySignature(qtrc("project", "Open/Atonal"), qtrc("project", "Open/Atonal"), IconCode::Code::KEY_SIGNATURE_NONE,
                     Key::INVALID).toMap(),
