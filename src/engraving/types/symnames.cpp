...
const std::array<muse::TranslatableString, size_t(SymId::lastSym) + 1> SymNames::s_symUserNames { {
    ...
    muse::TranslatableString("engraving/sym", "Dashed"),
    muse::TranslatableString("engraving/sym", "Dotted"),
    muse::TranslatableString("engraving/sym", "Double"),
    muse::TranslatableString("engraving/sym", "Final"),
    muse::TranslatableString("engraving/sym", "Heavy"),
    muse::TranslatableString("engraving/sym", "Heavy double"),
    muse::TranslatableString("engraving/sym", "Reverse final"),
    muse::TranslatableString("engraving/sym", "Short"),
    muse::TranslatableString("engraving/sym", "Single"),
    muse::TranslatableString("engraving/sym", "Tick"),
    ...
    muse::TranslatableString("engraving/sym", "Start repeat sign"),
    muse::TranslatableString("engraving/sym", "End repeat sign"),
