...
static const std::array<Item<NoteHeadType>, 5> NOTEHEAD_TYPES = { {
    ...
    { NoteHeadType::HEAD_WHOLE,     "whole",   TranslatableString("engraving", "Whole") },
    { NoteHeadType::HEAD_HALF,      "half",    TranslatableString("engraving", "Half") },
    { NoteHeadType::HEAD_QUARTER,   "quarter", TranslatableString("engraving", "Quarter") },
    { NoteHeadType::HEAD_BREVIS,    "breve",   TranslatableString("engraving", "Breve") },
} };
...
static const std::vector<Item<NoteHeadScheme> > NOTEHEAD_SCHEMES = {
    ...
    { NoteHeadScheme::HEAD_NORMAL,              "normal",              TranslatableString("engraving", "Normal") },
    { NoteHeadScheme::HEAD_PITCHNAME,           "name-pitch",          TranslatableString("engraving", "Pitch names") },
    { NoteHeadScheme::HEAD_PITCHNAME_GERMAN,    "name-pitch-german",   TranslatableString("engraving", "German pitch names") },
    { NoteHeadScheme::HEAD_SOLFEGE,             "solfege-movable",     TranslatableString("engraving", "Solf\u00e8ge movable Do") },  // &egrave;
    { NoteHeadScheme::HEAD_SOLFEGE_FIXED,       "solfege-fixed",       TranslatableString("engraving", "Solf\u00e8ge fixed Do") },    // &egrave;
    { NoteHeadScheme::HEAD_SHAPE_NOTE_4,        "shape-4",             TranslatableString("engraving", "4-shape (Walker)") },
    { NoteHeadScheme::HEAD_SHAPE_NOTE_7_AIKIN,  "shape-7-aikin",       TranslatableString("engraving", "7-shape (Aikin)") },
    { NoteHeadScheme::HEAD_SHAPE_NOTE_7_FUNK,   "shape-7-funk",        TranslatableString("engraving", "7-shape (Funk)") },
    { NoteHeadScheme::HEAD_SHAPE_NOTE_7_WALKER, "shape-7-walker",      TranslatableString("engraving", "7-shape (Walker)") }
};
...
static const std::vector<Item<NoteHeadGroup> > NOTEHEAD_GROUPS = {
    { NoteHeadGroup::HEAD_NORMAL,           "normal",         TranslatableString("engraving", "Normal") },
    { NoteHeadGroup::HEAD_CROSS,            "cross",          TranslatableString("engraving", "Cross") },
    { NoteHeadGroup::HEAD_PLUS,             "plus",           TranslatableString("engraving", "Plus") },
    { NoteHeadGroup::HEAD_XCIRCLE,          "xcircle",        TranslatableString("engraving", "XCircle") },
    { NoteHeadGroup::HEAD_WITHX,            "withx",          TranslatableString("engraving", "With X") },
    { NoteHeadGroup::HEAD_TRIANGLE_UP,      "triangle-up",    TranslatableString("engraving", "Triangle up") },
    { NoteHeadGroup::HEAD_TRIANGLE_DOWN,    "triangle-down",  TranslatableString("engraving", "Triangle down") },
    { NoteHeadGroup::HEAD_SLASHED1,         "slashed1",       TranslatableString("engraving", "Slashed (forwards)") },
    { NoteHeadGroup::HEAD_SLASHED2,         "slashed2",       TranslatableString("engraving", "Slashed (backwards)") },
    { NoteHeadGroup::HEAD_DIAMOND,          "diamond",        TranslatableString("engraving", "Diamond") },
    { NoteHeadGroup::HEAD_DIAMOND_OLD,      "diamond-old",    TranslatableString("engraving", "Diamond (old)") },
    { NoteHeadGroup::HEAD_CIRCLED,          "circled",        TranslatableString("engraving", "Circled") },
    { NoteHeadGroup::HEAD_CIRCLED_LARGE,    "circled-large",  TranslatableString("engraving", "Circled large") },
    { NoteHeadGroup::HEAD_LARGE_ARROW,      "large-arrow",    TranslatableString("engraving", "Large arrow") },
    { NoteHeadGroup::HEAD_BREVIS_ALT,       "altbrevis",      TranslatableString("engraving", "Alt. brevis") },

    { NoteHeadGroup::HEAD_SLASH,            "slash",          TranslatableString("engraving", "Slash") },

    { NoteHeadGroup::HEAD_HEAVY_CROSS,      "heavy-cross",    TranslatableString("engraving", "Heavy cross") },
    { NoteHeadGroup::HEAD_HEAVY_CROSS_HAT,  "heavy-cross-hat",    TranslatableString("engraving", "Heavy cross hat") },

    // shape notes
    { NoteHeadGroup::HEAD_SOL,  "sol",       TranslatableString("engraving", "Sol") },
    { NoteHeadGroup::HEAD_LA,   "la",        TranslatableString("engraving", "La") },
    { NoteHeadGroup::HEAD_FA,   "fa",        TranslatableString("engraving", "Fa") },
    { NoteHeadGroup::HEAD_MI,   "mi",        TranslatableString("engraving", "Mi") },
    { NoteHeadGroup::HEAD_DO,   "do",        TranslatableString("engraving", "Do") },
    { NoteHeadGroup::HEAD_RE,   "re",        TranslatableString("engraving", "Re") },
    { NoteHeadGroup::HEAD_TI,   "ti",        TranslatableString("engraving", "Ti") },

    // not exposed
    { NoteHeadGroup::HEAD_DO_WALKER,    "do-walker", TranslatableString("engraving", "Do (Walker)") },
    { NoteHeadGroup::HEAD_RE_WALKER,    "re-walker", TranslatableString("engraving", "Re (Walker)") },
    { NoteHeadGroup::HEAD_TI_WALKER,    "ti-walker", TranslatableString("engraving", "Ti (Walker)") },
    { NoteHeadGroup::HEAD_DO_FUNK,      "do-funk",   TranslatableString("engraving", "Do (Funk)") },
    { NoteHeadGroup::HEAD_RE_FUNK,      "re-funk",   TranslatableString("engraving", "Re (Funk)") },
    { NoteHeadGroup::HEAD_TI_FUNK,      "ti-funk",   TranslatableString("engraving", "Ti (Funk)") },

    // note name
    { NoteHeadGroup::HEAD_DO_NAME,      "do-name",  TranslatableString("engraving",  "Do (Name)") },
    { NoteHeadGroup::HEAD_DI_NAME,      "di-name",  TranslatableString("engraving",  "Di (Name)") },
    { NoteHeadGroup::HEAD_RA_NAME,      "ra-name",  TranslatableString("engraving",  "Ra (Name)") },
    { NoteHeadGroup::HEAD_RE_NAME,      "re-name",  TranslatableString("engraving",  "Re (Name)") },
    { NoteHeadGroup::HEAD_RI_NAME,      "ri-name",  TranslatableString("engraving",  "Ri (Name)") },
    { NoteHeadGroup::HEAD_ME_NAME,      "me-name",  TranslatableString("engraving",  "Me (Name)") },
    { NoteHeadGroup::HEAD_MI_NAME,      "mi-name",  TranslatableString("engraving",  "Mi (Name)") },
    { NoteHeadGroup::HEAD_FA_NAME,      "fa-name",  TranslatableString("engraving",  "Fa (Name)") },
    { NoteHeadGroup::HEAD_FI_NAME,      "fi-name",  TranslatableString("engraving",  "Fi (Name)") },
    { NoteHeadGroup::HEAD_SE_NAME,      "se-name",  TranslatableString("engraving",  "Se (Name)") },
    { NoteHeadGroup::HEAD_SOL_NAME,     "sol-name", TranslatableString("engraving",  "Sol (Name)") },
    { NoteHeadGroup::HEAD_LE_NAME,      "le-name",  TranslatableString("engraving",  "Le (Name)") },
    { NoteHeadGroup::HEAD_LA_NAME,      "la-name",  TranslatableString("engraving",  "La (Name)") },
    { NoteHeadGroup::HEAD_LI_NAME,      "li-name",  TranslatableString("engraving",  "Li (Name)") },
    { NoteHeadGroup::HEAD_TE_NAME,      "te-name",  TranslatableString("engraving",  "Te (Name)") },
    { NoteHeadGroup::HEAD_TI_NAME,      "ti-name",  TranslatableString("engraving",  "Ti (Name)") },
    { NoteHeadGroup::HEAD_SI_NAME,      "si-name",  TranslatableString("engraving",  "Si (Name)") },

    { NoteHeadGroup::HEAD_A_SHARP,      "a-sharp-name", TranslatableString("engraving",  "A♯ (Name)") },
    { NoteHeadGroup::HEAD_A,            "a-name",       TranslatableString("engraving",  "A (Name)") },
    { NoteHeadGroup::HEAD_A_FLAT,       "a-flat-name",  TranslatableString("engraving",  "A♭ (Name)") },
    { NoteHeadGroup::HEAD_B_SHARP,      "b-sharp-name", TranslatableString("engraving",  "B♯ (Name)") },
    { NoteHeadGroup::HEAD_B,            "b-name",       TranslatableString("engraving",  "B (Name)") },
    { NoteHeadGroup::HEAD_B_FLAT,       "b-flat-name",  TranslatableString("engraving",  "B♭ (Name)") },
    { NoteHeadGroup::HEAD_C_SHARP,      "c-sharp-name", TranslatableString("engraving",  "C♯ (Name)") },
    { NoteHeadGroup::HEAD_C,            "c-name",       TranslatableString("engraving",  "C (Name)") },
    { NoteHeadGroup::HEAD_C_FLAT,       "c-flat-name",  TranslatableString("engraving",  "C♭ (Name)") },
    { NoteHeadGroup::HEAD_D_SHARP,      "d-sharp-name", TranslatableString("engraving",  "D♯ (Name)") },
    { NoteHeadGroup::HEAD_D,            "d-name",       TranslatableString("engraving",  "D (Name)") },
    { NoteHeadGroup::HEAD_D_FLAT,       "d-flat-name",  TranslatableString("engraving",  "D♭ (Name)") },
    { NoteHeadGroup::HEAD_E_SHARP,      "e-sharp-name", TranslatableString("engraving",  "E♯ (Name)") },
    { NoteHeadGroup::HEAD_E,            "e-name",       TranslatableString("engraving",  "E (Name)") },
    { NoteHeadGroup::HEAD_E_FLAT,       "e-flat-name",  TranslatableString("engraving",  "E♭ (Name)") },
    { NoteHeadGroup::HEAD_F_SHARP,      "f-sharp-name", TranslatableString("engraving",  "F♯ (Name)") },
    { NoteHeadGroup::HEAD_F,            "f-name",       TranslatableString("engraving",  "F (Name)") },
    { NoteHeadGroup::HEAD_F_FLAT,       "f-flat-name",  TranslatableString("engraving",  "F♭ (Name)") },
    { NoteHeadGroup::HEAD_G_SHARP,      "g-sharp-name", TranslatableString("engraving",  "G♯ (Name)") },
    { NoteHeadGroup::HEAD_G,            "g-name",       TranslatableString("engraving",  "G (Name)") },
    { NoteHeadGroup::HEAD_G_FLAT,       "g-flat-name",  TranslatableString("engraving",  "G♭ (Name)") },
    { NoteHeadGroup::HEAD_H,            "h-name",       TranslatableString("engraving",  "H (Name)") },
    { NoteHeadGroup::HEAD_H_SHARP,      "h-sharp-name", TranslatableString("engraving",  "H♯ (Name)") },
...
static const std::vector<Item<ClefType> > CLEF_TYPES = {
    { ClefType::G,          "G",        TranslatableString("engraving", "Treble clef") },
    { ClefType::G15_MB,     "G15mb",    TranslatableString("engraving", "Treble clef 15ma bassa") },
    { ClefType::G8_VB,      "G8vb",     TranslatableString("engraving", "Treble clef 8va bassa") },
    { ClefType::G8_VA,      "G8va",     TranslatableString("engraving", "Treble clef 8va alta") },
    { ClefType::G15_MA,     "G15ma",    TranslatableString("engraving", "Treble clef 15ma alta") },
    { ClefType::G8_VB_O,    "G8vbo",    TranslatableString("engraving", "Double treble clef 8va bassa on 2nd line") },
    { ClefType::G8_VB_P,    "G8vbp",    TranslatableString("engraving", "Treble clef optional 8va bassa") },
    { ClefType::G_1,        "G1",       TranslatableString("engraving", "French violin clef") },
    { ClefType::C1,         "C1",       TranslatableString("engraving", "Soprano clef") },
    { ClefType::C2,         "C2",       TranslatableString("engraving", "Mezzo-soprano clef") },
    { ClefType::C3,         "C3",       TranslatableString("engraving", "Alto clef") },
    { ClefType::C4,         "C4",       TranslatableString("engraving", "Tenor clef") },
    { ClefType::C5,         "C5",       TranslatableString("engraving", "Baritone clef (C clef)") },
    { ClefType::C_19C,      "C_19C",    TranslatableString("engraving", "C clef, H shape (19th century)") },
    { ClefType::C1_F18C,    "C1_F18C",  TranslatableString("engraving", "Soprano clef (French, 18th century)") },
    { ClefType::C3_F18C,    "C3_F18C",  TranslatableString("engraving", "Alto clef (French, 18th century)") },
    { ClefType::C4_F18C,    "C4_F18C",  TranslatableString("engraving", "Tenor clef (French, 18th century)") },
    { ClefType::C1_F20C,    "C1_F20C",  TranslatableString("engraving", "Soprano clef (French, 20th century)") },
    { ClefType::C3_F20C,    "C3_F20C",  TranslatableString("engraving", "Alto clef (French, 20th century)") },
    { ClefType::C4_F20C,    "C4_F20C",  TranslatableString("engraving", "Tenor clef (French, 20th century)") },
    { ClefType::F,          "F",        TranslatableString("engraving", "Bass clef") },
    { ClefType::F15_MB,     "F15mb",    TranslatableString("engraving", "Bass clef 15ma bassa") },
    { ClefType::F8_VB,      "F8vb",     TranslatableString("engraving", "Bass clef 8va bassa") },
    { ClefType::F_8VA,      "F8va",     TranslatableString("engraving", "Bass clef 8va alta") },
    { ClefType::F_15MA,     "F15ma",    TranslatableString("engraving", "Bass clef 15ma alta") },
    { ClefType::F_B,        "F3",       TranslatableString("engraving", "Baritone clef (F clef)") },
    { ClefType::F_C,        "F5",       TranslatableString("engraving", "Subbass clef") },
    { ClefType::F_F18C,     "F_F18C",   TranslatableString("engraving", "F clef (French, 18th century)") },
    { ClefType::F_19C,      "F_19C",    TranslatableString("engraving", "F clef (19th century)") },

    { ClefType::PERC,       "PERC",     TranslatableString("engraving", "Percussion") },
    { ClefType::PERC2,      "PERC2",    TranslatableString("engraving", "Percussion 2") },

    { ClefType::TAB,        "TAB",      TranslatableString("engraving", "Tablature") },
    { ClefType::TAB4,       "TAB4",     TranslatableString("engraving", "Tablature 4 lines") },
    { ClefType::TAB_SERIF,  "TAB2",     TranslatableString("engraving", "Tablature Serif") },
    { ClefType::TAB4_SERIF, "TAB4_SERIF", TranslatableString("engraving", "Tablature Serif 4 lines") },
};
...
{
    return findUserNameByType<ChangeMethod>(CHANGE_METHODS, v).translated();
}
...
static const std::vector<EmbelItem> EMBELLISHMENT_TYPES = {
    // Single Grace notes
    { TranslatableString("engraving", "Single grace low G"), "LG" },
    { TranslatableString("engraving", "Single grace low A"), "LA" },
    { TranslatableString("engraving", "Single grace B"), "B" },
    { TranslatableString("engraving", "Single grace C"), "C" },
    { TranslatableString("engraving", "Single grace D"), "D" },
    { TranslatableString("engraving", "Single grace E"), "E" },
    { TranslatableString("engraving", "Single grace F"), "F" },
    { TranslatableString("engraving", "Single grace high G"), "HG" },
    { TranslatableString("engraving", "Single grace high A"), "HA" },

    // Double Grace notes
    { TranslatableString("engraving", "Double grace"), "D LG" },
    { TranslatableString("engraving", "Double grace"), "D LA" },
    { TranslatableString("engraving", "Double grace"), "D B" },
    { TranslatableString("engraving", "Double grace"), "D C" },
    { TranslatableString("engraving", "Double grace"), "E LG" },
    { TranslatableString("engraving", "Double grace"), "E LA" },
    { TranslatableString("engraving", "Double grace"), "E B" },
    { TranslatableString("engraving", "Double grace"), "E C" },
    { TranslatableString("engraving", "Double grace"), "E D" },

    { TranslatableString("engraving", "Double grace"), "F LG" },
    { TranslatableString("engraving", "Double grace"), "F LA" },
    { TranslatableString("engraving", "Double grace"), "F B" },
    { TranslatableString("engraving", "Double grace"), "F C" },
    { TranslatableString("engraving", "Double grace"), "F D" },
    { TranslatableString("engraving", "Double grace"), "F E" },

    { TranslatableString("engraving", "Double grace"), "HG LG" },
    { TranslatableString("engraving", "Double grace"), "HG LA" },
    { TranslatableString("engraving", "Double grace"), "HG B" },
    { TranslatableString("engraving", "Double grace"), "HG C" },
    { TranslatableString("engraving", "Double grace"), "HG D" },
    { TranslatableString("engraving", "Double grace"), "HG E" },
    { TranslatableString("engraving", "Double grace"), "HG F" },

    { TranslatableString("engraving", "Double grace"), "HA LG" },
    { TranslatableString("engraving", "Double grace"), "HA LA" },
    { TranslatableString("engraving", "Double grace"), "HA B" },
    { TranslatableString("engraving", "Double grace"), "HA C" },
    { TranslatableString("engraving", "Double grace"), "HA D" },
    { TranslatableString("engraving", "Double grace"), "HA E" },
    { TranslatableString("engraving", "Double grace"), "HA F" },
    { TranslatableString("engraving", "Double grace"), "HA HG" },

    // Half Doublings
    { TranslatableString("engraving", "Half doubling on low G"), "LG D" },
    { TranslatableString("engraving", "Half doubling on low A"), "LA D" },
    { TranslatableString("engraving", "Half doubling on B"), "B D" },
    { TranslatableString("engraving", "Half doubling on C"), "C D" },
    { TranslatableString("engraving", "Half doubling on D"), "D E" },
    { TranslatableString("engraving", "Half doubling on E"), "E F" },
    { TranslatableString("engraving", "Half doubling on F"), "F HG" },
    // ? { TranslatableString("engraving", "Half doubling on high G"), "HG F" },
    // ? { TranslatableString("engraving", "Half doubling on high A"), "HA HG" },

    // Regular Doublings
    { TranslatableString("engraving", "Doubling on high G"), "HG F" },
    { TranslatableString("engraving", "Doubling on high A"), "HA HG" },

    // Half Strikes
    { TranslatableString("engraving", "Half strike on low A"), "LA LG" },
    { TranslatableString("engraving", "Half strike on B"), "B LG" },
    { TranslatableString("engraving", "Half strike on C"), "C LG" },
    { TranslatableString("engraving", "Half strike on D"), "D LG" },
    { TranslatableString("engraving", "Half strike on D"), "D C" },
    { TranslatableString("engraving", "Half strike on E"), "E LA" },
    { TranslatableString("engraving", "Half strike on F"), "F E" },
    { TranslatableString("engraving", "Half strike on high G"), "HG F" },

    // Regular Grip
    { TranslatableString("engraving", "Grip"), "D LG" },

    // D Throw
    { TranslatableString("engraving", "Half D throw"), "D C" },

    // Regular Doublings (continued)
    { TranslatableString("engraving", "Doubling on low G"),  "HG LG D" },
    { TranslatableString("engraving", "Doubling on low A"),  "HG LA D" },
    { TranslatableString("engraving", "Doubling on B"),      "HG B D" },
    { TranslatableString("engraving", "Doubling on C"),      "HG C D" },
    { TranslatableString("engraving", "Doubling on D"),      "HG D E" },
    { TranslatableString("engraving", "Doubling on E"),      "HG E F" },
    { TranslatableString("engraving", "Doubling on F"),      "HG F HG" },

    // Thumb Doublings
    { TranslatableString("engraving", "Thumb doubling on low G"), "HA LG D" },
    { TranslatableString("engraving", "Thumb doubling on low A"), "HA LA D" },
    { TranslatableString("engraving", "Thumb doubling on B"), "HA B D" },
    { TranslatableString("engraving", "Thumb doubling on C"), "HA C D" },
    { TranslatableString("engraving", "Thumb doubling on D"), "HA D E" },
    { TranslatableString("engraving", "Thumb doubling on E"), "HA E F" },
    { TranslatableString("engraving", "Thumb doubling on F"), "HA F HG" },
    // ? { TranslatableString("engraving", "Thumb doubling on high G"), "HA HG F" },

    // G Grace note Strikes
    { TranslatableString("engraving", "G grace note on low A"), "HG LA LG" },
    { TranslatableString("engraving", "G grace note on B"), "HG B LG" },
    { TranslatableString("engraving", "G grace note on C"), "HG C LG" },
    { TranslatableString("engraving", "G grace note on D"), "HG D LG" },
    { TranslatableString("engraving", "G grace note on D"), "HG D C" },
    { TranslatableString("engraving", "G grace note on E"), "HG E LA" },
    { TranslatableString("engraving", "G grace note on F"), "HG F E" },

    // Regular Double Strikes
    { TranslatableString("engraving", "Double strike on low A"), "LG LA LG" },
    { TranslatableString("engraving", "Double strike on B"), "LG B LG" },
    { TranslatableString("engraving", "Double strike on C"), "LG C LG" },
    { TranslatableString("engraving", "Double strike on D"), "LG D LG" },
    { TranslatableString("engraving", "Double strike on D"), "C D C" },
    { TranslatableString("engraving", "Double strike on E"), "LA E LA" },
    { TranslatableString("engraving", "Double strike on F"), "E F E" },
    { TranslatableString("engraving", "Double strike on high G"), "F HG F" },
    { TranslatableString("engraving", "Double strike on high A"), "HG HA HG" },

    // Thumb Strikes
    { TranslatableString("engraving", "Thumb strike on low A"), "HA LA LG" },
    { TranslatableString("engraving", "Thumb strike on B"), "HA B LG" },
    { TranslatableString("engraving", "Thumb strike on C"), "HA C LG" },
    { TranslatableString("engraving", "Thumb strike on D"), "HA D LG" },
    { TranslatableString("engraving", "Thumb strike on D"), "HA D C" },
    { TranslatableString("engraving", "Thumb strike on E"), "HA E LA" },
    { TranslatableString("engraving", "Thumb strike on F"), "HA F E" },
    { TranslatableString("engraving", "Thumb strike on high G"), "HA HG F" },

    // Regular Grips (continued)
    { TranslatableString("engraving", "Grip"), "LG D LG" },
    { TranslatableString("engraving", "Grip"), "LG B LG" },

    // Taorluath and Birl
    { TranslatableString("engraving", "Birl"), "LG LA LG" },
    { TranslatableString("engraving", "D throw"), "LG D C" },
    { TranslatableString("engraving", "Half heavy D throw"), "D LG C" },
    { TranslatableString("engraving", "Taorluath"), "D LG E" },

    // Birl, Bubbly, D Throws (continued) and Taorluaths (continued)
    { TranslatableString("engraving", "Birl"), "LA LG LA LG" },
    { TranslatableString("engraving", "Bubbly"), "D LG C LG" },
    { TranslatableString("engraving", "Heavy D throw"), "LG D LG C" },
    { TranslatableString("engraving", "Taorluath"), "LG D LG E" },
    { TranslatableString("engraving", "Taorluath"), "LG B LG E" },

    // Half Double Strikes
    { TranslatableString("engraving", "Half double strike on low A"), "LA LG LA LG" },
    { TranslatableString("engraving", "Half double strike on B"), "B LG B LG" },
    { TranslatableString("engraving", "Half double strike on C"), "C LG C LG" },
    { TranslatableString("engraving", "Half double strike on D"), "D LG D LG" },
    { TranslatableString("engraving", "Half double strike on D"), "D C D C" },
    { TranslatableString("engraving", "Half double strike on E"), "E LA E LA" },
    { TranslatableString("engraving", "Half double strike on F"), "F E F E" },
    { TranslatableString("engraving", "Half double strike on high G"), "HG F HG F" },
    { TranslatableString("engraving", "Half double strike on high A"), "HA HG HA HG" },

    // Half Grips
    { TranslatableString("engraving", "Half grip on low A"), "LA LG D LG" },
    { TranslatableString("engraving", "Half grip on B"), "B LG D LG" },
    { TranslatableString("engraving", "Half grip on C"), "C LG D LG" },
    { TranslatableString("engraving", "Half grip on D"), "D LG D LG" },
    { TranslatableString("engraving", "Half grip on D"), "D LG B LG" },
    { TranslatableString("engraving", "Half grip on E"), "E LG D LG" },
    { TranslatableString("engraving", "Half grip on F"), "F LG F LG" },
    { TranslatableString("engraving", "Half grip on high G"), "HG LG D LG" },
    { TranslatableString("engraving", "Half grip on high A"), "HA LG D LG" },

    // Half Peles
    { TranslatableString("engraving", "Half pele on low A"), "LA E LA LG" },
    { TranslatableString("engraving", "Half pele on B"), "B E B LG" },
    { TranslatableString("engraving", "Half pele on C"), "C E C LG" },
    { TranslatableString("engraving", "Half pele on D"), "D E D LG" },
    { TranslatableString("engraving", "Half pele on D"), "D E D C" },
    { TranslatableString("engraving", "Half pele on E"), "E F E LA" },
    { TranslatableString("engraving", "Half pele on F"), "F HG F E" },
    { TranslatableString("engraving", "Half pele on high G"), "HG HA HG F" },

    // G Grace note Grips
    { TranslatableString("engraving", "G grace note grip on low A"), "HG LA LG D LG" },
    { TranslatableString("engraving", "G grace note grip on B"), "HG B LG D LG" },
    { TranslatableString("engraving", "G grace note grip on C"), "HG C LG D LG" },
    { TranslatableString("engraving", "G grace note grip on D"), "HG D LG D LG" },
    { TranslatableString("engraving", "G grace note grip on D"), "HG D LG B LG" },
    { TranslatableString("engraving", "G grace note grip on E"), "HG E LG D LG" },
    { TranslatableString("engraving", "G grace note grip on F"), "HG F LG F LG" },

    // Thumb Grips
    { TranslatableString("engraving", "Thumb grip on low A"), "HA LA LG D LG" },
    { TranslatableString("engraving", "Thumb grip on B"), "HA B LG D LG" },
    { TranslatableString("engraving", "Thumb grip on C"), "HA C LG D LG" },
    { TranslatableString("engraving", "Thumb grip on D"), "HA D LG D LG" },
    { TranslatableString("engraving", "Thumb grip on D"), "HA D LG B LG" },
    { TranslatableString("engraving", "Thumb grip on E"), "HA E LG D LG" },
    { TranslatableString("engraving", "Thumb grip on F"), "HA F LG F LG" },
    { TranslatableString("engraving", "Thumb grip on high G"), "HA HG LG F LG" },

    // Bubbly
    { TranslatableString("engraving", "Bubbly"), "LG D LG C LG" },

    //  Birls
    { TranslatableString("engraving", "Birl"), "HG LA LG LA LG" },
    { TranslatableString("engraving", "Birl"), "HA LA LG LA LG" },

    // Regular Peles
    { TranslatableString("engraving", "Pele on low A"), "HG LA E LA LG" },
    { TranslatableString("engraving", "Pele on B"), "HG B E B LG" },
    { TranslatableString("engraving", "Pele on C"), "HG C E C LG" },
    { TranslatableString("engraving", "Pele on D"), "HG D E D LG" },
    { TranslatableString("engraving", "Pele on D"), "HG D E D C" },
    { TranslatableString("engraving", "Pele on E"), "HG E F E LA" },
    { TranslatableString("engraving", "Pele on F"), "HG F HG F E" },

    // Thumb Grace Note Peles
    { TranslatableString("engraving", "Thumb grace note pele on low A"), "HA LA E LA LG" },
    { TranslatableString("engraving", "Thumb grace note pele on B"), "HA B E B LG" },
    { TranslatableString("engraving", "Thumb grace note pele on C"), "HA C E C LG" },
    { TranslatableString("engraving", "Thumb grace note pele on D"), "HA D E D LG" },
    { TranslatableString("engraving", "Thumb grace note pele on D"), "HA D E D C" },
    { TranslatableString("engraving", "Thumb grace note pele on E"), "HA E F E LA" },
    { TranslatableString("engraving", "Thumb grace note pele on F"), "HA F HG F E" },
    { TranslatableString("engraving", "Thumb grace note pele on high G"), "HA HG HA HG F" },

    // G Grace note Double Strikes
    { TranslatableString("engraving", "G grace note double strike on low A"), "HG LA LG LA LG" },
    { TranslatableString("engraving", "G grace note double strike on B"), "HG B LG B LG" },
    { TranslatableString("engraving", "G grace note double strike on C"), "HG C LG C LG" },
    { TranslatableString("engraving", "G grace note double strike on D"), "HG D LG D LG" },
    { TranslatableString("engraving", "G grace note double strike on D"), "HG D C D C" },
    { TranslatableString("engraving", "G grace note double strike on E"), "HG E LA E LA" },
    { TranslatableString("engraving", "G grace note double strike on F"), "HG F E F E" },

    // Thumb Double Strikes
    { TranslatableString("engraving", "Thumb double strike on low A"), "HA LA LG LA LG" },
    { TranslatableString("engraving", "Thumb double strike on B"), "HA B LG B LG" },
    { TranslatableString("engraving", "Thumb double strike on C"), "HA C LG C LG" },
    { TranslatableString("engraving", "Thumb double strike on D"), "HA D LG D LG" },
    { TranslatableString("engraving", "Thumb double strike on D"), "HA D C D C" },
    { TranslatableString("engraving", "Thumb double strike on E"), "HA E LA E LA" },
    { TranslatableString("engraving", "Thumb double strike on F"), "HA F E F E" },
    { TranslatableString("engraving", "Thumb double strike on high G"), "HA HG F HG F" },

    // Regular Triple Strikes
    { TranslatableString("engraving", "Triple strike on low A"), "LG LA LG LA LG" },
    { TranslatableString("engraving", "Triple strike on B"), "LG B LG B LG" },
    { TranslatableString("engraving", "Triple strike on C"), "LG C LG C LG" },
    { TranslatableString("engraving", "Triple strike on D"), "LG D LG D LG" },
    { TranslatableString("engraving", "Triple strike on D"), "C D C D C" },
    { TranslatableString("engraving", "Triple strike on E"), "LA E LA E LA" },
    { TranslatableString("engraving", "Triple strike on F"), "E F E F E" },
    { TranslatableString("engraving", "Triple strike on high G"), "F HG F HG F" },
    { TranslatableString("engraving", "Triple strike on high A"), "HG HA HG HA HG" },

    // Half Triple Strikes
    { TranslatableString("engraving", "Half triple strike on low A"), "LA LG LA LG LA LG" },
    { TranslatableString("engraving", "Half triple strike on B"), "B LG B LG B LG" },
    { TranslatableString("engraving", "Half triple strike on C"), "C LG C LG C LG" },
    { TranslatableString("engraving", "Half triple strike on D"), "D LG D LG D LG" },
    { TranslatableString("engraving", "Half triple strike on D"), "D C D C D C" },
    { TranslatableString("engraving", "Half triple strike on E"), "E LA E LA E LA" },
    { TranslatableString("engraving", "Half triple strike on F"), "F E F E F E" },
    { TranslatableString("engraving", "Half triple strike on high G"), "HG F HG F HG F" },
    { TranslatableString("engraving", "Half triple strike on high A"), "HA HG HA HG HA HG" },

    // G Grace note Triple Strikes
    { TranslatableString("engraving", "G grace note triple strike on low A"), "HG LA LG LA LG LA LG" },
    { TranslatableString("engraving", "G grace note triple strike on B"), "HG B LG B LG B LG" },
    { TranslatableString("engraving", "G grace note triple strike on C"), "HG C LG C LG C LG" },
    { TranslatableString("engraving", "G grace note triple strike on D"), "HG D LG D LG D LG" },
    { TranslatableString("engraving", "G grace note triple strike on D"), "HG D C D C D C" },
    { TranslatableString("engraving", "G grace note triple strike on E"), "HG E LA E LA E LA" },
    { TranslatableString("engraving", "G grace note triple strike on F"), "HG F E F E F E" },

    // Thumb Triple Strikes
    { TranslatableString("engraving", "Thumb triple strike on low A"),  "HA LA LG LA LG LA LG" },
    { TranslatableString("engraving", "Thumb triple strike on B"),      "HA B LG B LG B LG" },
    { TranslatableString("engraving", "Thumb triple strike on C"),      "HA C LG C LG C LG" },
    { TranslatableString("engraving", "Thumb triple strike on D"),      "HA D LG D LG D LG" },
    { TranslatableString("engraving", "Thumb triple strike on D"),      "HA D C D C D C" },
    { TranslatableString("engraving", "Thumb triple strike on E"),      "HA E LA E LA E LA" },
    { TranslatableString("engraving", "Thumb triple strike on F"),      "HA F E F E F E" },
    { TranslatableString("engraving", "Thumb triple strike on high G"), "HA HG F HG F HG F" },
};
...
static const std::vector<DrumPitchItem> DRUMPITCHS = {
    { DrumNum(27),       TranslatableString("engraving", "High Q") },
    { DrumNum(28),       TranslatableString("engraving", "Slap") },
    { DrumNum(29),       TranslatableString("engraving", "Scratch Push") },

    { DrumNum(30),       TranslatableString("engraving", "Scratch Pull") },
    { DrumNum(31),       TranslatableString("engraving", "Sticks") },
    { DrumNum(32),       TranslatableString("engraving", "Square Click") },
    { DrumNum(33),       TranslatableString("engraving", "Metronome Click") },
    { DrumNum(34),       TranslatableString("engraving", "Metronome Bell") },
    { DrumNum(35),       TranslatableString("engraving", "Acoustic Bass Drum") },
    { DrumNum(36),       TranslatableString("engraving", "Bass Drum 1") },
    { DrumNum(37),       TranslatableString("engraving", "Side Stick") },
    { DrumNum(38),       TranslatableString("engraving", "Acoustic Snare") },
    { DrumNum(39),       TranslatableString("engraving", "Hand Clap") },

    { DrumNum(40),       TranslatableString("engraving", "Electric Snare") },
    { DrumNum(41),       TranslatableString("engraving", "Low Floor Tom") },
    { DrumNum(42),       TranslatableString("engraving", "Closed Hi-Hat") },
    { DrumNum(43),       TranslatableString("engraving", "High Floor Tom") },
    { DrumNum(44),       TranslatableString("engraving", "Pedal Hi-Hat") },
    { DrumNum(45),       TranslatableString("engraving", "Low Tom") },
    { DrumNum(46),       TranslatableString("engraving", "Open Hi-Hat") },
    { DrumNum(47),       TranslatableString("engraving", "Low-Mid Tom") },
    { DrumNum(48),       TranslatableString("engraving", "Hi-Mid Tom") },
    { DrumNum(49),       TranslatableString("engraving", "Crash Cymbal 1") },

    { DrumNum(50),       TranslatableString("engraving", "High Tom") },
    { DrumNum(51),       TranslatableString("engraving", "Ride Cymbal 1") },
    { DrumNum(52),       TranslatableString("engraving", "Chinese Cymbal") },
    { DrumNum(53),       TranslatableString("engraving", "Ride Bell") },
    { DrumNum(54),       TranslatableString("engraving", "Tambourine") },
    { DrumNum(55),       TranslatableString("engraving", "Splash Cymbal") },
    { DrumNum(56),       TranslatableString("engraving", "Cowbell") },
    { DrumNum(57),       TranslatableString("engraving", "Crash Cymbal 2") },
    { DrumNum(58),       TranslatableString("engraving", "Vibraslap") },
    { DrumNum(59),       TranslatableString("engraving", "Ride Cymbal 2") },

    { DrumNum(60),       TranslatableString("engraving", "Hi Bongo") },
    { DrumNum(61),       TranslatableString("engraving", "Low Bongo") },
    { DrumNum(62),       TranslatableString("engraving", "Mute Hi Conga") },
    { DrumNum(63),       TranslatableString("engraving", "Open Hi Conga") },
    { DrumNum(64),       TranslatableString("engraving", "Low Conga") },
    { DrumNum(65),       TranslatableString("engraving", "High Timbale") },
    { DrumNum(66),       TranslatableString("engraving", "Low Timbale") },
    { DrumNum(67),       TranslatableString("engraving", "High Agogo") },
    { DrumNum(68),       TranslatableString("engraving", "Low Agogo") },
    { DrumNum(69),       TranslatableString("engraving", "Cabasa") },

    { DrumNum(70),       TranslatableString("engraving", "Maracas") },
    { DrumNum(71),       TranslatableString("engraving", "Short Whistle") },
    { DrumNum(72),       TranslatableString("engraving", "Long Whistle") },
    { DrumNum(73),       TranslatableString("engraving", "Short Güiro") },
    { DrumNum(74),       TranslatableString("engraving", "Long Güiro") },
    { DrumNum(75),       TranslatableString("engraving", "Claves") },
    { DrumNum(76),       TranslatableString("engraving", "Hi Wood Block") },
    { DrumNum(77),       TranslatableString("engraving", "Low Wood Block") },
    { DrumNum(78),       TranslatableString("engraving", "Mute Cuica") },
    { DrumNum(79),       TranslatableString("engraving", "Open Cuica") },

    { DrumNum(80),       TranslatableString("engraving", "Mute Triangle") },
    { DrumNum(81),       TranslatableString("engraving", "Open Triangle") },
    { DrumNum(82),       TranslatableString("engraving", "Shaker") },
    { DrumNum(83),       TranslatableString("engraving", "Sleigh Bell") },
    { DrumNum(84),       TranslatableString("engraving", "Mark Tree") },
    { DrumNum(85),       TranslatableString("engraving", "Castanets") },
    { DrumNum(86),       TranslatableString("engraving", "Mute Surdo") },
    { DrumNum(87),       TranslatableString("engraving", "Open Surdo") },

    { DrumNum(91),       TranslatableString("engraving", "Snare (Rim shot)") },

    { DrumNum(93),       TranslatableString("engraving", "Ride (Edge)") },

    { DrumNum(99),       TranslatableString("engraving", "Cowbell Low") },

    { DrumNum(102),      TranslatableString("engraving", "Cowbell High") },
};
...
{
    return findUserNameByType<GlissandoType>(GLISSANDO_TYPES, v).str;
}
...
static const std::array<Item<StaffGroup>, 3> STAFFGROUP_TYPES = { {
    { StaffGroup::STANDARD,     "pitched",    TranslatableString("engraving", "Standard") },
    { StaffGroup::PERCUSSION,   "percussion", TranslatableString("engraving", "Percussion") },
    { StaffGroup::TAB,          "tablature",  TranslatableString("engraving", "Tablature") },
} };
