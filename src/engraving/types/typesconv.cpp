...
static const std::vector<Item<ClefType> > CLEF_TYPES = {
    ...
    { ClefType::G8_VB_O,    "G8vbo",    muse::TranslatableString("engraving/cleftype", "G clef ottava bassa with C clef") },
    { ClefType::G8_VB_C,    "G8vbc",    muse::TranslatableString("engraving/cleftype", "Double treble clef 8va bassa on 2nd line") },
