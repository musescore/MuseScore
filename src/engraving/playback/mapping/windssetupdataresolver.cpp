...
PlaybackSetupData WindsSetupDataResolver::doResolve(const Instrument* instrument)
{
    static const std::unordered_map<std::string, PlaybackSetupData> SETUP_DATA_MAP = {
        ...
        { "double-contrabass-flute",
          { SoundId::Flute, SoundCategory::Winds, { SoundSubCategory::Double_Contra_Bass } } },
        ...
        { "mezzo-soprano-saxophone",
          { SoundId::Saxophone, SoundCategory::Winds, { SoundSubCategory::Mezzo_Soprano } } },
        ...
        { "subcontrabass-saxophone",
          { SoundId::Saxophone, SoundCategory::Winds, { SoundSubCategory::Sub_Contra_Bass } } },
        ...
        { "contrabass-sarrusophone",
          { SoundId::Sarrusophone, SoundCategory::Winds, { SoundSubCategory::Contra_Bass } } },
        ...
        { "baritone-horn-central-europe-treble",
          { SoundId::Horn, SoundCategory::Winds, { SoundSubCategory::CentralEuropean,
        ...
        { "eb-contrabass-ophicleide",
          { SoundId::Ophicleide, SoundCategory::Winds, { SoundSubCategory::Contra_Bass } } },
