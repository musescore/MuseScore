...
public:
    ...
    virtual draw::Color selectionColor(voice_idx_t voiceIndex = 0, bool itemVisible = true, bool itemIsUnlinkedFromScore = false,
                                       bool applyToAllVoices = false) const = 0;
