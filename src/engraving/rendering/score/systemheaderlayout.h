...
private:
    static Bracket* createBracket(System* system, LayoutContext& ctx, BracketItem* bi, size_t column,
                                  staff_idx_t staffIdx, std::vector<Bracket*>& bl, Measure* measure);
    ...
    static void computeStackedBracketsWidth(Bracket* first,
                                            const std::vector<Bracket*>& allGroupBracketsOrderedByColumn, double& width,
