...
private:
    ...
    static void doRenderSingleHarmony(Harmony* item, Harmony::LayoutData* ldata, HarmonyRenderCtx& harmonyCtx,
                                      int rootTpc, int bassTpc, const LayoutContext& ctx);
    ...
    static void renderAction(Harmony* item, Harmony::LayoutData* ldata, const RenderActionPtr& a,
    ...
    static void renderActionMoveXHeight(Harmony* item, const RenderActionMoveXHeightPtr& a,
