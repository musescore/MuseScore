...
private:
    ...
    static Parenthesis* findOrCreateParenthesis(EngravingItem* item, const DirectionH direction, const track_idx_t track);
    ...
    static void placeParentheses(EngravingItem* item, LayoutContext& ctx);
