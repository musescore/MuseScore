 ...
 */
#ifndef MU_ENGRAVING_SCOREVERTICALVIEWLAYOUT_STABLE_H
#define MU_ENGRAVING_SCOREVERTICALVIEWLAYOUT_STABLE_H
...
#endif // MU_ENGRAVING_SCOREVERTICALVIEWLAYOUT_STABLE_H
