 ...
 */
#ifndef MU_ENGRAVING_LAYOUTCHORDS_STABLE_H
#define MU_ENGRAVING_LAYOUTCHORDS_STABLE_H
...
public:
    ...
    static void layoutChordBaseOrganPedalMark(Chord* chord, System* system, LayoutContext& ctx);
...
#endif // MU_ENGRAVING_LAYOUTCHORDS_STABLE_H
