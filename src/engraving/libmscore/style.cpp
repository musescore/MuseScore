...
static const StyleType styleTypes[] {
    ...
    { Sid::hairpinLineStyle,        "hairpinLineStyle",        QVariant(int(Qt::PenStyle::SolidLine)) },
    { Sid::hairpinLineLineStyle,    "hairpinLineLineStyle",    QVariant(int(Qt::PenStyle::CustomDashLine)) },
    ...
    { Sid::pedalLineStyle,          "pedalListStyle",          QVariant(int(Qt::PenStyle::SolidLine)) },
    ...
    { Sid::voltaLineStyle,          "voltaLineStyle",          QVariant(int(Qt::PenStyle::SolidLine)) },
    ...
    { Sid::ottavaLineStyle,         "ottavaLineStyle",         QVariant(int(Qt::PenStyle::DashLine)) },
    ...
    { Sid::letRingLineStyle,              "letRingLineStyle",             QVariant(int(Qt::PenStyle::DashLine)) },
    ...
    { Sid::palmMuteLineStyle,             "palmMuteLineStyle",             QVariant(int(Qt::PenStyle::DashLine)) },
