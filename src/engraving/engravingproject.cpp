...
Ret EngravingProject::loadMscz(const MscReader& msc, AudioSettingsCompat& audioSettingsCompat, bool ignoreVersionError)
{
    TRACEFUNC;
    MScore::setError(MsError::MS_NO_ERROR);
    ScoreReader scoreReader;
    return scoreReader.loadMscz(m_masterScore, msc, audioSettingsCompat, ignoreVersionError);
}
