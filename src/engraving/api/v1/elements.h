...
public:
    ...
    QQmlListProperty<EngravingItem> spannerFor() {
        return wrapContainerProperty(this, std::vector<mu::engraving::Spanner*>(note()->spannerFor()));
    }

    QQmlListProperty<EngravingItem> spannerBack() {
        return wrapContainerProperty(this, std::vector<mu::engraving::Spanner*>(note()->spannerBack()));
    }
