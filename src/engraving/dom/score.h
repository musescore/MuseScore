...
public:
    ...
    BracketType bracketType(const Staff* staff, size_t idx) const;
    size_t bracketSpan(const Staff* staff, size_t idx) const;
    void setBracketType(Staff* staff, size_t idx, BracketType val);
    void setBracketSpan(Staff* staff, size_t idx, size_t val);
    void setBracketVisible(Staff* staff, size_t idx, bool v);
    void changeBracketColumn(Staff* staff, size_t oldColumn, size_t newColumn);
    void addBracket(Staff* staff, BracketItem*);
    void insertBracket(Staff* staff, BracketItem* b);
    const std::vector<BracketItem*>& brackets(const Staff* staff) const;
    std::vector<BracketItem*>& brackets(const Staff* staff);
    size_t bracketLevels(const Staff* staff) const;
...
private:
    ...
    void fillBrackets(Staff* staff, size_t idx);
    void cleanBrackets(Staff* staff);
    ...
    std::map<const Staff*, std::vector<BracketItem*> > m_brackets;
