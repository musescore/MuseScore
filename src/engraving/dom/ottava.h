...
static const OttavaDefault ottavaDefault[] = {
    { OttavaType::OTTAVA_8VA,  12,  "8va",  TranslatableString("palette", "8va alta") },
    { OttavaType::OTTAVA_8VB,  -12, "8vb",  TranslatableString("palette", "8va bassa") },
    { OttavaType::OTTAVA_15MA, 24,  "15ma", TranslatableString("palette", "15ma alta") },
    { OttavaType::OTTAVA_15MB, -24, "15mb", TranslatableString("palette", "15ma bassa") },
    { OttavaType::OTTAVA_22MA, 36,  "22ma", TranslatableString("palette", "22ma alta") },
    { OttavaType::OTTAVA_22MB, -36, "22mb", TranslatableString("palette", "22ma bassa") }
};
