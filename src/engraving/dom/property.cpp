...
static constexpr PropertyMetaData propertyList[] = {
    ...
    { Pid::FBPREFIX,                true,  "prefix",                P_TYPE::INT,                PropertyGroup::APPEARANCE,      DUMMY_QT_TR_NOOP("propertyName", "prefix") },
    { Pid::FBDIGIT,                 true,  "digit",                 P_TYPE::INT,                PropertyGroup::APPEARANCE,      DUMMY_QT_TR_NOOP("propertyName", "digit") },
    { Pid::FBSUFFIX,                true,  "suffix",                P_TYPE::INT,                PropertyGroup::APPEARANCE,      DUMMY_QT_TR_NOOP("propertyName", "suffix") },
    { Pid::FBCONTINUATIONLINE,      true,  "continuationLine",      P_TYPE::INT,                PropertyGroup::APPEARANCE,      DUMMY_QT_TR_NOOP("propertyName", "continuation line") },

    { Pid::FBPARENTHESIS1,          true,  "",                      P_TYPE::INT,                PropertyGroup::APPEARANCE,      "" },
    { Pid::FBPARENTHESIS2,          true,  "",                      P_TYPE::INT,                PropertyGroup::APPEARANCE,      "" },
    { Pid::FBPARENTHESIS3,          true,  "",                      P_TYPE::INT,                PropertyGroup::APPEARANCE,      "" },
    { Pid::FBPARENTHESIS4,          true,  "",                      P_TYPE::INT,                PropertyGroup::APPEARANCE,      "" },
    { Pid::FBPARENTHESIS5,          true,  "",                      P_TYPE::INT,                PropertyGroup::APPEARANCE,      "" },
