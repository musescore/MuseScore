...
static constexpr PropertyMetaData propertyList[] = {
    ...
    { Pid::BEGIN_ARROW_HEIGHT,                  P_TYPE::SPATIUM,                   PropertyGroup::APPEARANCE, false, "beginArrowHeight",                QT_TRANSLATE_NOOP("engraving/propertyName", "begin arrow height") },
    { Pid::BEGIN_ARROW_WIDTH,                   P_TYPE::SPATIUM,                   PropertyGroup::APPEARANCE, false, "beginArrowWidth",                 QT_TRANSLATE_NOOP("engraving/propertyName", "begin arrow width") },
    ...
    { Pid::END_ARROW_HEIGHT,                    P_TYPE::SPATIUM,                   PropertyGroup::APPEARANCE, false, "endArrowHeight",                  QT_TRANSLATE_NOOP("engraving/propertyName", "end arrow height") },
    { Pid::END_ARROW_WIDTH,                     P_TYPE::SPATIUM,                   PropertyGroup::APPEARANCE, false, "endArrowWidth",                   QT_TRANSLATE_NOOP("engraving/propertyName", "end arrow width") },
