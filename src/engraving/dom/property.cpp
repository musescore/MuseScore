...
static constexpr PropertyMetaData propertyList[] = {
    ...
    { Pid::STAFF_INSTRUMENT_LABEL_VISIBILITY,   P_TYPE::INSTRUMENT_LABEL_VISIBILITY, PropertyGroup::APPEARANCE, false, "",                              QT_TRANSLATE_NOOP("engraving/propertyName", "instrument label visibility") },
    { Pid::STAFF_ENABLE_GROUP_NAMES,            P_TYPE::BOOL,                      PropertyGroup::APPEARANCE, false, "",                                QT_TRANSLATE_NOOP("engraving/propertyName", "enable group names") },
