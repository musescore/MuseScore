...
static constexpr PropertyMetaData propertyList[] = {
    ...
    { Pid::BORDER_TYPE,             false, "borderType",            P_TYPE::INT,                PropertyGroup::APPEARANCE,      DUMMY_QT_TR_NOOP("propertyName", "border type") },
    { Pid::BORDER_WIDTH,            false, "borderWidth",           P_TYPE::SPATIUM,            PropertyGroup::APPEARANCE,      DUMMY_QT_TR_NOOP("propertyName", "border width") },
    { Pid::BORDER_PADDING,          false, "borderPadding",         P_TYPE::SPATIUM,            PropertyGroup::APPEARANCE,      DUMMY_QT_TR_NOOP("propertyName", "border padding") },
    { Pid::BORDER_ROUND,            false, "borderRound",           P_TYPE::INT,                PropertyGroup::APPEARANCE,      DUMMY_QT_TR_NOOP("propertyName", "border round") },
    { Pid::BORDER_FG_COLOR,         false, "borderFgColor",         P_TYPE::COLOR,              PropertyGroup::APPEARANCE,      DUMMY_QT_TR_NOOP("propertyName", "border foreground color") },
    { Pid::BORDER_BG_COLOR,         false, "borderBgColor",         P_TYPE::COLOR,              PropertyGroup::APPEARANCE,      DUMMY_QT_TR_NOOP("propertyName", "border background color") },
