...
//                     line pOff|-lines for sharps---||---lines for flats--   |  symbol                | valid in staff group
    ...
    { ClefType::G_PETR,  2, 45, { 0, 3, -1, 2, 5, 1, 4, 4, 1, 5, 2, 6, 3, 7 }, SymId::mensuralGclefPetrucci,
      StaffGroup::STANDARD },
    { ClefType::C1_PETR, 1, 43, { 5, 1, 4, 0, 3, -1, 2, 2, 6, 3, 7, 4, 8, 5 }, SymId::mensuralCclefPetrucciPosLowest,
      StaffGroup::STANDARD },
    { ClefType::C2_PETR, 2, 41, { 3, 6, 2, 5, 1, 4, 0, 0, 4, 1, 5, 2, 6, 3 },  SymId::mensuralCclefPetrucciPosLow,
      StaffGroup::STANDARD },
    { ClefType::C3_PETR, 3, 39, { 1, 4, 0, 3, 6, 2, 5, 5, 2, 6, 3, 7, 4, 8 },  SymId::mensuralCclefPetrucciPosMiddle,
      StaffGroup::STANDARD },
    { ClefType::C4_PETR, 4, 37, { 6, 2, 5, 1, 4, 0, 3, 3, 0, 4, 1, 5, 2, 6 },  SymId::mensuralCclefPetrucciPosHigh,
      StaffGroup::STANDARD },
    { ClefType::C5_PETR, 5, 35, { 4, 0, 3, -1, 2, 5, 1, 1, 5, 2, 6, 3, 7, 4 }, SymId::mensuralCclefPetrucciPosHighest,
      StaffGroup::STANDARD },
    { ClefType::F_PETR,  4, 33, { 2, 5, 1, 4, 7, 3, 6, 6, 3, 7, 4, 8, 5, 9 },  SymId::mensuralFclefPetrucci,
      StaffGroup::STANDARD },
};
