...
public:
    ...
    void setSymId(SymId symId) { m_symId = symId; }

    QList<SymIdList> getPedalMarksPopupSet() const;

    void setPedalMark(SymId pedalMarkSymId);

    void changePedalMark(int popupPageIndex, int pageElementIndex);
