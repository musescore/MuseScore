...
public:
    ...
    DynamicFragment(CharFormat charFormat, String dynamictext, bool dynamicDisplay = true); // Pointer to CharFormat?
    ...
    void setToDynamicText();
    void setToExpressionText();
    void setDynamicTextMode(bool dynamicTextMode);
