...
public:
    Fingering(Note* parent, TextStyleType tid, ElementFlags ef = ElementFlag::HAS_TAG | ElementFlag::ON_STAFF);
    Fingering(Note* parent, ElementFlags ef= ElementFlag::HAS_TAG | ElementFlag::ON_STAFF);
