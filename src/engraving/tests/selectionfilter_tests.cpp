...
{
public:
    void testFilter(int idx, const SelectionFilterTypesVariant& filter);
    void testFilterSpanner(int idx, const SelectionFilterTypesVariant& filter);
};

void Engraving_SelectionFilterTests::testFilter(int idx, const SelectionFilterTypesVariant& filter)
{
    ...
    score->selectionFilters().setFiltered(filter, false);
...
void Engraving_SelectionFilterTests::testFilterSpanner(int idx, const SelectionFilterTypesVariant& filter)
{
