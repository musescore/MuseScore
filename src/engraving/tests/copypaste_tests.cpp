...
TEST_F(Engraving_CopyPasteTests, copypasteOnlySecondVoice)
{
    ...
    score->selectionFilters().setFiltered(VoicesSelectionFilterTypes::FIRST_VOICE, false);
    ...
    //paste to second measure
    score->deselectAll();
    score->selectionFilters().setFiltered(VoicesSelectionFilterTypes::FIRST_VOICE, true);
