...
TEST_F(MidiRenderer_Tests, hammerOnPullOff)
{
    ...
    checkEventInterval(events, 0, 479, 52, 80);
    checkEventInterval(events, 480, 959, 53, 80);

    checkEventInterval(events, 960, 1199, 52, 80);
    checkEventInterval(events, 1200, 1439, 53, 80);
    checkEventInterval(events, 1440, 1679, 55, 80);
    checkEventInterval(events, 1680, 1919, 53, 80);
}
