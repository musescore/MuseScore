...
const TextStyle frameTextStyle { {
    ...
    { TextStylePropertyType::BorderType,            Sid::borderBorderType,                         Pid::BORDER_TYPE },
    { TextStylePropertyType::BorderPadding,         Sid::borderBorderPadding,                      Pid::BORDER_PADDING },
    { TextStylePropertyType::BorderWidth,           Sid::borderBorderWidth,                        Pid::BORDER_WIDTH },
    { TextStylePropertyType::BorderRound,           Sid::borderBorderRound,                        Pid::BORDER_ROUND },
    { TextStylePropertyType::BorderColor,     Sid::borderBorderFgColor,                      Pid::BORDER_FG_COLOR },
    { TextStylePropertyType::BorderFillColor,       Sid::borderBorderBgColor,                      Pid::BORDER_BG_COLOR },
    { TextStylePropertyType::MusicalSymbolsScale,  Sid::dummyMusicalSymbolsScale,               Pid::MUSICAL_SYMBOLS_SCALE },
} };
