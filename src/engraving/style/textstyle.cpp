...
const TextStyle defaultTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::defaultOffset,                          Pid::END },
...
const TextStyle titleTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::titleOffset,                            Pid::END },
...
const TextStyle subTitleTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::subTitleOffset,                         Pid::END },
...
const TextStyle composerTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::composerOffset,                         Pid::END },
...
const TextStyle lyricistTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::lyricistOffset,                         Pid::END },
...
const TextStyle lyricsEvenTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::lyricsPosBelow,                         Pid::END },
...
const TextStyle fingeringTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::fingeringOffset,                        Pid::END },
...
const TextStyle tabFretNumberTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::tabFretNumberOffset,                  Pid::END },
...
const TextStyle lhGuitarFingeringTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::lhGuitarFingeringOffset,                Pid::END },
...
const TextStyle rhGuitarFingeringTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::rhGuitarFingeringOffset,                Pid::END },
...
const TextStyle hammerOnPullOffTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::hammerOnPullOffTappingOffset,                        Pid::END },
...
const TextStyle stringNumberTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::stringNumberOffset,                     Pid::END },
...
const TextStyle stringTuningsStyle { { // identical to staffText except for fontSize
    ...
    { TextStylePropertyType::Offset,               Sid::staffTextPosAbove,                      Pid::END },
...
const TextStyle fretDiagramFingeringStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::fretDiagramFingeringPosAbove,                      Pid::END },
...
const TextStyle fretDiagramFretNumberStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::fretDiagramFretNumberPosAbove,                      Pid::END },
...
const TextStyle harpPedalDiagramTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::harpPedalDiagramOffset,                 Pid::END },
...
const TextStyle articulationTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::articulationOffset,                        Pid::END },
...
const TextStyle harpPedalTextDiagramTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::harpPedalTextDiagramOffset,                 Pid::END },
...
const TextStyle longInstrumentTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::longInstrumentOffset,                   Pid::END },
...
const TextStyle shortInstrumentTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::shortInstrumentOffset,                  Pid::END },
...
const TextStyle partInstrumentTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::partInstrumentOffset,                   Pid::END },
...
const TextStyle dynamicsTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::expressionOffset,                       Pid::END },
...
const TextStyle tempoTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::tempoPosAbove,                          Pid::END },
...
const TextStyle tempoChangeTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::tempoChangePosAbove,                          Pid::END },
...
const TextStyle metronomeTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::metronomeOffset,                        Pid::END },
...
const TextStyle measureNumberTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::measureNumberPosAbove,                  Pid::END },
...
const TextStyle measureNumberAlternateTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::measureNumberAlternatePosAbove,                  Pid::END },
...
const TextStyle mmRestRangeTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::mmRestRangePosAbove,                    Pid::END },
...
const TextStyle translatorTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::translatorOffset,                       Pid::END },
...
const TextStyle tupletTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::tupletOffset,                           Pid::END },
...
const TextStyle systemTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::systemTextPosAbove,                     Pid::END },
...
const TextStyle chordSymbolTextStyleA { {
    ...
    { TextStylePropertyType::Offset,               Sid::chordSymbolAPosAbove,                   Pid::END },
...
const TextStyle chordSymbolTextStyleB { {
    ...
    { TextStylePropertyType::Offset,               Sid::chordSymbolBPosAbove,                   Pid::END },
...
const TextStyle romanNumeralTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::romanNumeralPosAbove,                   Pid::END },
...
const TextStyle nashvilleNumberTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::nashvilleNumberPosAbove,                Pid::END },
...
const TextStyle rehearsalMarkTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::rehearsalMarkPosAbove,                  Pid::END },
...
const TextStyle repeatPlayCountTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::repeatPlayCountPosAbove,                Pid::END },
...
const TextStyle repeatLeftTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::markerPosAbove,                         Pid::END },
...
const TextStyle repeatRightTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::jumpPosAbove,                           Pid::END },
...
const TextStyle frameTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::frameOffset,                            Pid::END },
...
const TextStyle noteLineTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::noteLineOffset,                        Pid::END },
...
const TextStyle glissandoTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::glissandoOffset,                        Pid::END },
...
const TextStyle headerTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::headerOffset,                           Pid::END },
...
const TextStyle footerTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::footerOffset,                           Pid::END },
...
const TextStyle copyrightTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::copyrightOffset,                        Pid::END },
...
const TextStyle pageNumberTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::pageNumberOffset,                       Pid::END },
...
const TextStyle instrumentChangeTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::instrumentChangeOffset,                 Pid::END },
...
const TextStyle stickingTextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::stickingOffset,                         Pid::END },
...
const TextStyle user1TextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::user1Offset,                            Pid::END },
...
const TextStyle user2TextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::user2Offset,                            Pid::END },
...
const TextStyle user3TextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::user3Offset,                            Pid::END },
...
const TextStyle user4TextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::user4Offset,                            Pid::END },
...
const TextStyle user5TextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::user5Offset,                            Pid::END },
...
const TextStyle user6TextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::user6Offset,                            Pid::END },
...
const TextStyle user7TextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::user7Offset,                            Pid::END },
...
const TextStyle user8TextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::user8Offset,                            Pid::END },
...
const TextStyle user9TextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::user9Offset,                            Pid::END },
...
const TextStyle user10TextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::user10Offset,                           Pid::END },
...
const TextStyle user11TextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::user11Offset,                           Pid::END },
...
const TextStyle user12TextStyle { {
    ...
    { TextStylePropertyType::Offset,               Sid::user12Offset,                           Pid::END },
