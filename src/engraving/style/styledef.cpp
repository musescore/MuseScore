...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    ...
    styleDef(lyricsOddBorderType,                         int(BorderType::NO_BORDER)),
    styleDef(lyricsOddBorderPadding,                      0.2),
    styleDef(lyricsOddBorderWidth,                        0.1),
    styleDef(lyricsOddBorderRound,                        0),
    styleDef(lyricsOddBorderFgColor,                      Color::BLACK),
    styleDef(lyricsOddBorderBgColor,                      Color::transparent),
    ...
    styleDef(lyricsEvenBorderType,                        int(BorderType::NO_BORDER)),
    styleDef(lyricsEvenBorderPadding,                     0.2),
    styleDef(lyricsEvenBorderWidth,                       0.1),
    styleDef(lyricsEvenBorderRound,                       0),
    styleDef(lyricsEvenBorderFgColor,                     Color::BLACK),
    styleDef(lyricsEvenBorderBgColor,                     Color::transparent),
    ...
    styleDef(hairpinBorderType,                           int(BorderType::NO_BORDER)),
    styleDef(hairpinBorderPadding,                        0.2),
    styleDef(hairpinBorderWidth,                          0.1),
    styleDef(hairpinBorderRound,                          0),
    styleDef(hairpinBorderFgColor,                        Color::BLACK),
    styleDef(hairpinBorderBgColor,                        Color::transparent),
    ...
    styleDef(pedalBorderType,                             int(BorderType::NO_BORDER)),
    styleDef(pedalBorderPadding,                          0.2),
    styleDef(pedalBorderWidth,                            0.1),
    styleDef(pedalBorderRound,                            0),
    styleDef(pedalBorderFgColor,                          Color::BLACK),
    styleDef(pedalBorderBgColor,                          Color::transparent),
    ...
    styleDef(chordSymbolABorderType,                      int(BorderType::NO_BORDER)),
    styleDef(chordSymbolABorderPadding,                   0.2),
    styleDef(chordSymbolABorderWidth,                     0.1),
    styleDef(chordSymbolABorderRound,                     0),
    styleDef(chordSymbolABorderFgColor,                   PropertyValue::fromValue(Color::BLACK)),
    styleDef(chordSymbolABorderBgColor,                   PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(chordSymbolBBorderType,                      int(BorderType::NO_BORDER)),
    styleDef(chordSymbolBBorderPadding,                   0.2),
    styleDef(chordSymbolBBorderWidth,                     0.1),
    styleDef(chordSymbolBBorderRound,                     0),
    styleDef(chordSymbolBBorderFgColor,                   PropertyValue::fromValue(Color::BLACK)),
    styleDef(chordSymbolBBorderBgColor,                   PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(romanNumeralBorderType,                      int(BorderType::NO_BORDER)),
    styleDef(romanNumeralBorderPadding,                   0.2),
    styleDef(romanNumeralBorderWidth,                     0.1),
    styleDef(romanNumeralBorderRound,                     0),
    styleDef(romanNumeralBorderFgColor,                   PropertyValue::fromValue(Color::BLACK)),
    styleDef(romanNumeralBorderBgColor,                   PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(nashvilleNumberBorderType,                   int(BorderType::NO_BORDER)),
    styleDef(nashvilleNumberBorderPadding,                0.2),
    styleDef(nashvilleNumberBorderWidth,                  0.1),
    styleDef(nashvilleNumberBorderRound,                  0),
    styleDef(nashvilleNumberBorderFgColor,                PropertyValue::fromValue(Color::BLACK)),
    styleDef(nashvilleNumberBorderBgColor,                PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(voltaBorderType,                             int(BorderType::NO_BORDER)),
    styleDef(voltaBorderPadding,                          0.2),
    styleDef(voltaBorderWidth,                            0.1),
    styleDef(voltaBorderRound,                            0),
    styleDef(voltaBorderFgColor,                          PropertyValue::fromValue(Color::BLACK)),
    styleDef(voltaBorderBgColor,                          PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(ottavaBorderType,                            int(BorderType::NO_BORDER)),
    styleDef(ottavaBorderPadding,                         0.2),
    styleDef(ottavaBorderWidth,                           0.1),
    styleDef(ottavaBorderRound,                           0),
    styleDef(ottavaBorderFgColor,                         PropertyValue::fromValue(Color::BLACK)),
    styleDef(ottavaBorderBgColor,                         PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(tupletBorderType,                            int(BorderType::NO_BORDER)),
    styleDef(tupletBorderPadding,                         0.2),
    styleDef(tupletBorderWidth,                           0.1),
    styleDef(tupletBorderRound,                           0),
    styleDef(tupletBorderFgColor,                         PropertyValue::fromValue(Color::BLACK)),
    styleDef(tupletBorderBgColor,                         PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(textLineBorderType,                          int(BorderType::NO_BORDER)),
    styleDef(textLineBorderPadding,                       0.2),
    styleDef(textLineBorderWidth,                         0.1),
    styleDef(textLineBorderRound,                         0),
    styleDef(textLineBorderFgColor,                       PropertyValue::fromValue(Color::BLACK)),
    styleDef(textLineBorderBgColor,                       PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(systemTextLineBorderType,                    int(BorderType::NO_BORDER)),
    styleDef(systemTextLineBorderPadding,                 0.2),
    styleDef(systemTextLineBorderWidth,                   0.1),
    styleDef(systemTextLineBorderRound,                   0),
    styleDef(systemTextLineBorderFgColor,                 PropertyValue::fromValue(Color::BLACK)),
    styleDef(systemTextLineBorderBgColor,                 PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(defaultBorderType,                           int(BorderType::NO_BORDER)),
    styleDef(defaultBorderPadding,                        Spatium(0.2)),
    styleDef(defaultBorderWidth,                          Spatium(0.1)),
    styleDef(defaultBorderRound,                          0),
    styleDef(defaultBorderFgColor,                        PropertyValue::fromValue(Color::BLACK)),
    styleDef(defaultBorderBgColor,                        PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(titleBorderType,                             int(BorderType::NO_BORDER)),
    styleDef(titleBorderPadding,                          0.2),
    styleDef(titleBorderWidth,                            0.1),
    styleDef(titleBorderRound,                            0),
    styleDef(titleBorderFgColor,                          PropertyValue::fromValue(Color::BLACK)),
    styleDef(titleBorderBgColor,                          PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(subTitleBorderType,                          int(BorderType::NO_BORDER)),
    styleDef(subTitleBorderPadding,                       0.2),
    styleDef(subTitleBorderWidth,                         0.1),
    styleDef(subTitleBorderRound,                         0),
    styleDef(subTitleBorderFgColor,                       PropertyValue::fromValue(Color::BLACK)),
    styleDef(subTitleBorderBgColor,                       PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(composerBorderType,                          int(BorderType::NO_BORDER)),
    styleDef(composerBorderPadding,                       0.2),
    styleDef(composerBorderWidth,                         0.1),
    styleDef(composerBorderRound,                         0),
    styleDef(composerBorderFgColor,                       PropertyValue::fromValue(Color::BLACK)),
    styleDef(composerBorderBgColor,                       PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(lyricistBorderType,                          int(BorderType::NO_BORDER)),
    styleDef(lyricistBorderPadding,                       0.2),
    styleDef(lyricistBorderWidth,                         0.1),
    styleDef(lyricistBorderRound,                         0),
    styleDef(lyricistBorderFgColor,                       PropertyValue::fromValue(Color::BLACK)),
    styleDef(lyricistBorderBgColor,                       PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(fingeringBorderType,                         int(BorderType::NO_BORDER)),
    styleDef(fingeringBorderPadding,                      0.2),
    styleDef(fingeringBorderWidth,                        0.1),
    styleDef(fingeringBorderRound,                        0),
    styleDef(fingeringBorderFgColor,                      PropertyValue::fromValue(Color::BLACK)),
    styleDef(fingeringBorderBgColor,                      PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(lhGuitarFingeringBorderType,                 int(BorderType::NO_BORDER)),
    styleDef(lhGuitarFingeringBorderPadding,              0.2),
    styleDef(lhGuitarFingeringBorderWidth,                0.1),
    styleDef(lhGuitarFingeringBorderRound,                0),
    styleDef(lhGuitarFingeringBorderFgColor,              PropertyValue::fromValue(Color::BLACK)),
    styleDef(lhGuitarFingeringBorderBgColor,              PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(rhGuitarFingeringBorderType,                 int(BorderType::NO_BORDER)),
    styleDef(rhGuitarFingeringBorderPadding,              0.2),
    styleDef(rhGuitarFingeringBorderWidth,                0.1),
    styleDef(rhGuitarFingeringBorderRound,                0),
    styleDef(rhGuitarFingeringBorderFgColor,              PropertyValue::fromValue(Color::BLACK)),
    styleDef(rhGuitarFingeringBorderBgColor,              PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(stringNumberBorderType,                      int(BorderType::CIRCLE)),
    styleDef(stringNumberBorderPadding,                   0.2),
    styleDef(stringNumberBorderWidth,                     0.1),
    styleDef(stringNumberBorderRound,                     0),
    styleDef(stringNumberBorderFgColor,                   PropertyValue::fromValue(Color::BLACK)),
    styleDef(stringNumberBorderBgColor,                   PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(harpPedalDiagramBorderType,                  int(BorderType::NO_BORDER)),
    styleDef(harpPedalDiagramBorderPadding,               0.2),
    styleDef(harpPedalDiagramBorderWidth,                 0.1),
    styleDef(harpPedalDiagramBorderRound,                 0),
    styleDef(harpPedalDiagramBorderFgColor,               PropertyValue::fromValue(Color::BLACK)),
    styleDef(harpPedalDiagramBorderBgColor,               PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(harpPedalTextDiagramBorderType,              int(BorderType::NO_BORDER)),
    styleDef(harpPedalTextDiagramBorderPadding,           0.2),
    styleDef(harpPedalTextDiagramBorderWidth,             0.1),
    styleDef(harpPedalTextDiagramBorderRound,             0),
    styleDef(harpPedalTextDiagramBorderFgColor,           PropertyValue::fromValue(Color::BLACK)),
    styleDef(harpPedalTextDiagramBorderBgColor,           PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(longInstrumentBorderType,                    int(BorderType::NO_BORDER)),
    styleDef(longInstrumentBorderPadding,                 0.2),
    styleDef(longInstrumentBorderWidth,                   0.1),
    styleDef(longInstrumentBorderRound,                   0),
    styleDef(longInstrumentBorderFgColor,                 PropertyValue::fromValue(Color::BLACK)),
    styleDef(longInstrumentBorderBgColor,                 PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(shortInstrumentBorderType,                   int(BorderType::NO_BORDER)),
    styleDef(shortInstrumentBorderPadding,                0.2),
    styleDef(shortInstrumentBorderWidth,                  0.1),
    styleDef(shortInstrumentBorderRound,                  0),
    styleDef(shortInstrumentBorderFgColor,                PropertyValue::fromValue(Color::BLACK)),
    styleDef(shortInstrumentBorderBgColor,                PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(partInstrumentBorderType,                    int(BorderType::NO_BORDER)),
    styleDef(partInstrumentBorderPadding,                 0.2),
    styleDef(partInstrumentBorderWidth,                   0.1),
    styleDef(partInstrumentBorderRound,                   0),
    styleDef(partInstrumentBorderFgColor,                 PropertyValue::fromValue(Color::BLACK)),
    styleDef(partInstrumentBorderBgColor,                 PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(dynamicsBorderType,                          int(BorderType::NO_BORDER)),
    styleDef(dynamicsBorderPadding,                       0.2),
    styleDef(dynamicsBorderWidth,                         0.1),
    styleDef(dynamicsBorderRound,                         0),
    styleDef(dynamicsBorderFgColor,                       PropertyValue::fromValue(Color::BLACK)),
    styleDef(dynamicsBorderBgColor,                       PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(expressionBorderType,                        int(BorderType::NO_BORDER)),
    styleDef(expressionBorderPadding,                     0.2),
    styleDef(expressionBorderWidth,                       0.1),
    styleDef(expressionBorderRound,                       0),
    styleDef(expressionBorderFgColor,                     PropertyValue::fromValue(Color::BLACK)),
    styleDef(expressionBorderBgColor,                     PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(tempoBorderType,                             int(BorderType::NO_BORDER)),
    styleDef(tempoBorderPadding,                          0.2),
    styleDef(tempoBorderWidth,                            0.1),
    styleDef(tempoBorderRound,                            0),
    styleDef(tempoBorderFgColor,                          PropertyValue::fromValue(Color::BLACK)),
    styleDef(tempoBorderBgColor,                          PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(tempoChangeBorderType,                       int(BorderType::NO_BORDER)),
    styleDef(tempoChangeBorderPadding,                    0.2),
    styleDef(tempoChangeBorderWidth,                      0.1),
    styleDef(tempoChangeBorderRound,                      0),
    styleDef(tempoChangeBorderFgColor,                    PropertyValue::fromValue(Color::BLACK)),
    styleDef(tempoChangeBorderBgColor,                    PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(metronomeBorderType,                         int(BorderType::NO_BORDER)),
    styleDef(metronomeBorderPadding,                      0.2),
    styleDef(metronomeBorderWidth,                        0.1),
    styleDef(metronomeBorderRound,                        0),
    styleDef(metronomeBorderFgColor,                      PropertyValue::fromValue(Color::BLACK)),
    styleDef(metronomeBorderBgColor,                      PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(measureNumberBorderType,                     int(BorderType::NO_BORDER)),
    styleDef(measureNumberBorderPadding,                  0.2),
    styleDef(measureNumberBorderWidth,                    0.1),
    styleDef(measureNumberBorderRound,                    0),
    styleDef(measureNumberBorderFgColor,                  PropertyValue::fromValue(Color::BLACK)),
    styleDef(measureNumberBorderBgColor,                  PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(mmRestRangeBorderType,                       int(BorderType::NO_BORDER)),
    styleDef(mmRestRangeBorderPadding,                    0.2),
    styleDef(mmRestRangeBorderWidth,                      0.1),
    styleDef(mmRestRangeBorderRound,                      0),
    styleDef(mmRestRangeBorderFgColor,                    PropertyValue::fromValue(Color::BLACK)),
    styleDef(mmRestRangeBorderBgColor,                    PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(translatorBorderType,                        int(BorderType::NO_BORDER)),
    styleDef(translatorBorderPadding,                     0.2),
    styleDef(translatorBorderWidth,                       0.1),
    styleDef(translatorBorderRound,                       0),
    styleDef(translatorBorderFgColor,                     PropertyValue::fromValue(Color::BLACK)),
    styleDef(translatorBorderBgColor,                     PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(systemTextBorderType,                        int(BorderType::NO_BORDER)),
    styleDef(systemTextBorderPadding,                     0.2),
    styleDef(systemTextBorderWidth,                       0.1),
    styleDef(systemTextBorderRound,                       0),
    styleDef(systemTextBorderFgColor,                     PropertyValue::fromValue(Color::BLACK)),
    styleDef(systemTextBorderBgColor,                     PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(staffTextBorderType,                         int(BorderType::NO_BORDER)),
    styleDef(staffTextBorderPadding,                      0.2),
    styleDef(staffTextBorderWidth,                        0.1),
    styleDef(staffTextBorderRound,                        0),
    styleDef(staffTextBorderFgColor,                      PropertyValue::fromValue(Color::BLACK)),
    styleDef(staffTextBorderBgColor,                      PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(fretDiagramFingeringBorderType,              int(BorderType::NO_BORDER)),
    styleDef(fretDiagramFingeringBorderPadding,           0.2),
    styleDef(fretDiagramFingeringBorderWidth,             0.1),
    styleDef(fretDiagramFingeringBorderRound,             0),
    styleDef(fretDiagramFingeringBorderFgColor,           PropertyValue::fromValue(Color::BLACK)),
    styleDef(fretDiagramFingeringBorderBgColor,           PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(fretDiagramFretNumberBorderType,             int(BorderType::NO_BORDER)),
    styleDef(fretDiagramFretNumberBorderPadding,          0.2),
    styleDef(fretDiagramFretNumberBorderWidth,            0.1),
    styleDef(fretDiagramFretNumberBorderRound,            0),
    styleDef(fretDiagramFretNumberBorderFgColor,          PropertyValue::fromValue(Color::BLACK)),
    styleDef(fretDiagramFretNumberBorderBgColor,          PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(rehearsalMarkBorderType,                     int(BorderType::SQUARE)),
    styleDef(rehearsalMarkBorderPadding,                  0.5),
    styleDef(rehearsalMarkBorderWidth,                    0.16),
    styleDef(rehearsalMarkBorderRound,                    0),
    styleDef(rehearsalMarkBorderFgColor,                  PropertyValue::fromValue(Color::BLACK)),
    styleDef(rehearsalMarkBorderBgColor,                  PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(repeatLeftBorderType,                        int(BorderType::NO_BORDER)),
    styleDef(repeatLeftBorderPadding,                     0.2),
    styleDef(repeatLeftBorderWidth,                       0.1),
    styleDef(repeatLeftBorderRound,                       0),
    styleDef(repeatLeftBorderFgColor,                     PropertyValue::fromValue(Color::BLACK)),
    styleDef(repeatLeftBorderBgColor,                     PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(repeatRightBorderType,                       int(BorderType::NO_BORDER)),
    styleDef(repeatRightBorderPadding,                    0.2),
    styleDef(repeatRightBorderWidth,                      0.1),
    styleDef(repeatRightBorderRound,                      0),
    styleDef(repeatRightBorderFgColor,                    PropertyValue::fromValue(Color::BLACK)),
    styleDef(repeatRightBorderBgColor,                    PropertyValue::fromValue(Color::transparent)),

    styleDef(borderFontFace,                              "Edwin"),
    styleDef(borderFontSize,                              10.0),
    styleDef(borderLineSpacing,                           1.0),
    styleDef(borderFontSpatiumDependent,                  false),
    styleDef(borderFontStyle,                             int(FontStyle::Normal)),
    styleDef(borderColor,                                 PropertyValue::fromValue(Color::BLACK)),
    styleDef(borderAlign,                                 Align(AlignH::LEFT, AlignV::TOP)),
    styleDef(borderOffset,                                PointF()),
    styleDef(borderBorderType,                             int(BorderType::NO_BORDER)),
    styleDef(borderBorderPadding,                          0.2),
    styleDef(borderBorderWidth,                            0.1),
    styleDef(borderBorderRound,                            0),
    styleDef(borderBorderFgColor,                          PropertyValue::fromValue(Color::BLACK)),
    styleDef(borderBorderBgColor,                          PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(noteLineBorderType,                         int(BorderType::NO_BORDER)),
    styleDef(noteLineBorderPadding,                      0.2),
    styleDef(noteLineBorderWidth,                        0.1),
    styleDef(noteLineBorderRound,                        0),
    styleDef(noteLineBorderFgColor,                      PropertyValue::fromValue(Color::BLACK)),
    styleDef(noteLineBorderBgColor,                      PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(glissandoBorderType,                         int(BorderType::NO_BORDER)),
    styleDef(glissandoBorderPadding,                      0.2),
    styleDef(glissandoBorderWidth,                        0.1),
    styleDef(glissandoBorderRound,                        0),
    styleDef(glissandoBorderFgColor,                      PropertyValue::fromValue(Color::BLACK)),
    styleDef(glissandoBorderBgColor,                      PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(bendBorderType,                              int(BorderType::NO_BORDER)),
    styleDef(bendBorderPadding,                           0.2),
    styleDef(bendBorderWidth,                             0.1),
    styleDef(bendBorderRound,                             0),
    styleDef(bendBorderFgColor,                           PropertyValue::fromValue(Color::BLACK)),
    styleDef(bendBorderBgColor,                           PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(headerBorderType,                            int(BorderType::NO_BORDER)),
    styleDef(headerBorderPadding,                         0.2),
    styleDef(headerBorderWidth,                           0.1),
    styleDef(headerBorderRound,                           0),
    styleDef(headerBorderFgColor,                         PropertyValue::fromValue(Color::BLACK)),
    styleDef(headerBorderBgColor,                         PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(footerBorderType,                            int(BorderType::NO_BORDER)),
    styleDef(footerBorderPadding,                         0.2),
    styleDef(footerBorderWidth,                           0.1),
    styleDef(footerBorderRound,                           0),
    styleDef(footerBorderFgColor,                         PropertyValue::fromValue(Color::BLACK)),
    styleDef(footerBorderBgColor,                         PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(copyrightBorderType,                         int(BorderType::NO_BORDER)),
    styleDef(copyrightBorderPadding,                      0.2),
    styleDef(copyrightBorderWidth,                        0.1),
    styleDef(copyrightBorderRound,                        0),
    styleDef(copyrightBorderFgColor,                      PropertyValue::fromValue(Color::BLACK)),
    styleDef(copyrightBorderBgColor,                      PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(pageNumberBorderType,                        int(BorderType::NO_BORDER)),
    styleDef(pageNumberBorderPadding,                     0.2),
    styleDef(pageNumberBorderWidth,                       0.1),
    styleDef(pageNumberBorderRound,                       0),
    styleDef(pageNumberBorderFgColor,                     PropertyValue::fromValue(Color::BLACK)),
    styleDef(pageNumberBorderBgColor,                     PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(instrumentChangeBorderType,                  int(BorderType::NO_BORDER)),
    styleDef(instrumentChangeBorderPadding,               0.2),
    styleDef(instrumentChangeBorderWidth,                 0.1),
    styleDef(instrumentChangeBorderRound,                 0),
    styleDef(instrumentChangeBorderFgColor,               PropertyValue::fromValue(Color::BLACK)),
    styleDef(instrumentChangeBorderBgColor,               PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(stickingBorderType,                          int(BorderType::NO_BORDER)),
    styleDef(stickingBorderPadding,                       0.2),
    styleDef(stickingBorderWidth,                         0.1),
    styleDef(stickingBorderRound,                         0),
    styleDef(stickingBorderFgColor,                       PropertyValue::fromValue(Color::BLACK)),
    styleDef(stickingBorderBgColor,                       PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(user1BorderType,                             int(BorderType::NO_BORDER)),
    styleDef(user1BorderPadding,                          0.2),
    styleDef(user1BorderWidth,                            0.1),
    styleDef(user1BorderRound,                            0),
    styleDef(user1BorderFgColor,                          PropertyValue::fromValue(Color::BLACK)),
    styleDef(user1BorderBgColor,                          PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(user2BorderType,                             int(BorderType::NO_BORDER)),
    styleDef(user2BorderPadding,                          0.2),
    styleDef(user2BorderWidth,                            0.1),
    styleDef(user2BorderRound,                            0),
    styleDef(user2BorderFgColor,                          PropertyValue::fromValue(Color::BLACK)),
    styleDef(user2BorderBgColor,                          PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(user3BorderType,                             int(BorderType::NO_BORDER)),
    styleDef(user3BorderPadding,                          0.2),
    styleDef(user3BorderWidth,                            0.1),
    styleDef(user3BorderRound,                            0),
    styleDef(user3BorderFgColor,                          PropertyValue::fromValue(Color::BLACK)),
    styleDef(user3BorderBgColor,                          PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(user4BorderType,                             int(BorderType::NO_BORDER)),
    styleDef(user4BorderPadding,                          0.2),
    styleDef(user4BorderWidth,                            0.1),
    styleDef(user4BorderRound,                            0),
    styleDef(user4BorderFgColor,                          PropertyValue::fromValue(Color::BLACK)),
    styleDef(user4BorderBgColor,                          PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(user5BorderType,                             int(BorderType::NO_BORDER)),
    styleDef(user5BorderPadding,                          0.2),
    styleDef(user5BorderWidth,                            0.1),
    styleDef(user5BorderRound,                            0),
    styleDef(user5BorderFgColor,                          PropertyValue::fromValue(Color::BLACK)),
    styleDef(user5BorderBgColor,                          PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(user6BorderType,                             int(BorderType::NO_BORDER)),
    styleDef(user6BorderPadding,                          0.2),
    styleDef(user6BorderWidth,                            0.1),
    styleDef(user6BorderRound,                            0),
    styleDef(user6BorderFgColor,                          PropertyValue::fromValue(Color::BLACK)),
    styleDef(user6BorderBgColor,                          PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(user7BorderType,                             int(BorderType::NO_BORDER)),
    styleDef(user7BorderPadding,                          0.2),
    styleDef(user7BorderWidth,                            0.1),
    styleDef(user7BorderRound,                            0),
    styleDef(user7BorderFgColor,                          PropertyValue::fromValue(Color::BLACK)),
    styleDef(user7BorderBgColor,                          PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(user8BorderType,                             int(BorderType::NO_BORDER)),
    styleDef(user8BorderPadding,                          0.2),
    styleDef(user8BorderWidth,                            0.1),
    styleDef(user8BorderRound,                            0),
    styleDef(user8BorderFgColor,                          PropertyValue::fromValue(Color::BLACK)),
    styleDef(user8BorderBgColor,                          PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(user9BorderType,                             int(BorderType::NO_BORDER)),
    styleDef(user9BorderPadding,                          0.2),
    styleDef(user9BorderWidth,                            0.1),
    styleDef(user9BorderRound,                            0),
    styleDef(user9BorderFgColor,                          PropertyValue::fromValue(Color::BLACK)),
    styleDef(user9BorderBgColor,                          PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(user10BorderType,                            int(BorderType::NO_BORDER)),
    styleDef(user10BorderPadding,                         0.2),
    styleDef(user10BorderWidth,                           0.1),
    styleDef(user10BorderRound,                           0),
    styleDef(user10BorderFgColor,                         PropertyValue::fromValue(Color::BLACK)),
    styleDef(user10BorderBgColor,                         PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(user11BorderType,                            int(BorderType::NO_BORDER)),
    styleDef(user11BorderPadding,                         0.2),
    styleDef(user11BorderWidth,                           0.1),
    styleDef(user11BorderRound,                           0),
    styleDef(user11BorderFgColor,                         PropertyValue::fromValue(Color::BLACK)),
    styleDef(user11BorderBgColor,                         PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(user12BorderType,                            int(BorderType::NO_BORDER)),
    styleDef(user12BorderPadding,                         0.2),
    styleDef(user12BorderWidth,                           0.1),
    styleDef(user12BorderRound,                           0),
    styleDef(user12BorderFgColor,                         PropertyValue::fromValue(Color::BLACK)),
    styleDef(user12BorderBgColor,                         PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(letRingBorderType,                           int(BorderType::NO_BORDER)),
    styleDef(letRingBorderPadding,                        0.2),
    styleDef(letRingBorderWidth,                          0.1),
    styleDef(letRingBorderRound,                          0),
    styleDef(letRingBorderFgColor,                        PropertyValue::fromValue(Color::BLACK)),
    styleDef(letRingBorderBgColor,                        PropertyValue::fromValue(Color::transparent)),
    ...
    styleDef(palmMuteBorderType,                          int(BorderType::NO_BORDER)),
    styleDef(palmMuteBorderPadding,                       0.2),
    styleDef(palmMuteBorderWidth,                         0.1),
    styleDef(palmMuteBorderRound,                         0),
    styleDef(palmMuteBorderFgColor,                       PropertyValue::fromValue(Color::BLACK)),
    styleDef(palmMuteBorderBgColor,                       PropertyValue::fromValue(Color::transparent)),
