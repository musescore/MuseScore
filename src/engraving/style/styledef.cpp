...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    ...
    { Sid::minStaffSpread,          "minStaffSpread",          Spatium(3.5) },
    { Sid::maxStaffSpread,          "maxStaffSpread",          Spatium(20.0) },
    ...
    { Sid::hairpinLineWidth,        "hairpinLineWidth",        Spatium(0.12) },
    ...
    { Sid::chordSymbolAPosAbove,      "chordSymbolAPosAbove",      PointF(.0, -2.5) },
    { Sid::chordSymbolAPosBelow,      "chordSymbolAPosBelow",      PointF(.0, 3.5) },
    ...
    { Sid::measureNumberAllStaves,  "measureNumberAllStaves",  false },
    ...
    { Sid::firstSystemInstNameVisibility, "firstSystemInstNameVisibility", PropertyValue(int(InstrumentLabelVisibility::LONG)) },
    ...
    { Sid::tremoloStyle,            "tremoloStyle",            int(TremoloStyle::DEFAULT) },
    ...
    { Sid::measureNumberPosAbove,         "measureNumberPosAbove",        PointF(0.0, -2.0) },
    ...
    { Sid::mmRestRangePosAbove,           "mmRestRangePosAbove",          PointF(0.0, -3.0) },
    ...
    { Sid::systemTextFontFace,            "systemTextFontFace",           "Edwin" },
    { Sid::systemTextFontSize,            "systemTextFontSize",           10.0 },
    { Sid::systemTextLineSpacing,         "systemTextLineSpacing",        1.0 },
    { Sid::systemTextFontSpatiumDependent, "systemTextFontSpatiumDependent", true },
    { Sid::systemTextFontStyle,           "systemTextFontStyle",          int(FontStyle::Normal) },
    { Sid::systemTextColor,               "systemTextColor",              PropertyValue::fromValue(Color::BLACK) },
    { Sid::systemTextAlign,               "systemTextAlign",              Align(AlignH::LEFT, AlignV::BASELINE) },
    { Sid::systemTextOffsetType,          "systemTextOffsetType",         int(OffsetType::SPATIUM) },
    { Sid::systemTextPlacement,           "systemTextPlacement",          PlacementV::ABOVE },
    { Sid::systemTextPosAbove,            "systemTextPosAbove",           PointF(.0, -2.0) },
    { Sid::systemTextPosBelow,            "systemTextPosBelow",           PointF(.0, 3.5) },
    { Sid::systemTextMinDistance,         "systemTextMinDistance",        Spatium(0.5) },
    { Sid::systemTextFrameType,           "systemTextFrameType",          int(FrameType::NO_FRAME) },
    { Sid::systemTextFramePadding,        "systemTextFramePadding",       0.2 },
    { Sid::systemTextFrameWidth,          "systemTextFrameWidth",         0.1 },
    { Sid::systemTextFrameRound,          "systemTextFrameRound",         0 },
    { Sid::systemTextFrameFgColor,        "systemTextFrameFgColor",       PropertyValue::fromValue(Color::BLACK) },
    { Sid::systemTextFrameBgColor,        "systemTextFrameBgColor",       PropertyValue::fromValue(Color::transparent) },

    { Sid::staffTextFontFace,             "staffTextFontFace",            "Edwin" },
    { Sid::staffTextFontSize,             "staffTextFontSize",            10.0 },
    { Sid::staffTextLineSpacing,          "staffTextLineSpacing",         1.0 },
    { Sid::staffTextFontSpatiumDependent, "staffTextFontSpatiumDependent", true },
    { Sid::staffTextFontStyle,            "staffTextFontStyle",           int(FontStyle::Normal) },
    { Sid::staffTextColor,                "staffTextColor",               PropertyValue::fromValue(Color::BLACK) },
    { Sid::staffTextAlign,                "staffTextAlign",               Align(AlignH::LEFT, AlignV::BASELINE) },
    { Sid::staffTextOffsetType,           "staffTextOffsetType",          int(OffsetType::SPATIUM) },
    { Sid::staffTextPlacement,            "staffTextPlacement",           PlacementV::ABOVE },
    { Sid::staffTextPosAbove,             "staffTextPosAbove",            PointF(.0, -1.0) },
    { Sid::staffTextPosBelow,             "staffTextPosBelow",            PointF(.0, 2.5) },
    { Sid::staffTextMinDistance,          "staffTextMinDistance",         Spatium(0.5) },
    { Sid::staffTextFrameType,            "staffTextFrameType",           int(FrameType::NO_FRAME) },
    { Sid::staffTextFramePadding,         "staffTextFramePadding",        0.2 },
    { Sid::staffTextFrameWidth,           "staffTextFrameWidth",          0.1 },
    { Sid::staffTextFrameRound,           "staffTextFrameRound",          0 },
    { Sid::staffTextFrameFgColor,         "staffTextFrameFgColor",        PropertyValue::fromValue(Color::BLACK) },
    { Sid::staffTextFrameBgColor,         "staffTextFrameBgColor",        PropertyValue::fromValue(Color::transparent) },
