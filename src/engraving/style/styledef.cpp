...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    ...
    { Sid::tempoChangeLineWidth,          "tempoChangeLineWidth",         Spatium(0.11) },
    ...
    { Sid::letRingDashLineLen,            "letRingDashLineLen",           4.0 },
    { Sid::letRingDashGapLen,             "letRingDashGapLen",            4.0 },
    ...
    { Sid::palmMuteDashLineLen,           "palmMuteDashLineLen",           4.0 },
    { Sid::palmMuteDashGapLen,            "palmMuteDashGapLen",            4.0 },
