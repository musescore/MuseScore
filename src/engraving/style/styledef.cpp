...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    ...
    styleDef(chordStackedModiferMag,                     PropertyValue(0.5)),
    ...
    styleDef(chordAlignmentToNotehead,                   int(AlignH::HCENTER)),
    styleDef(chordAlignmentToFretboard,                  int(AlignH::HCENTER)),
