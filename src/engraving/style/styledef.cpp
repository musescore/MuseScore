...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    ...
    { Sid::harpPedalDiagramFontSize,          "harpPedalDiagramFontSize",          20.0 },
    ...
    { Sid::harpPedalDiagramColor,             "harpPedalDiagramColor",             PropertyValue::fromValue(draw::Color::black) },
    ...
    { Sid::harpPedalDiagramFrameFgColor,      "harpPedalDiagramFrameFgColor",      PropertyValue::fromValue(draw::Color::black) },
    ...
    { Sid::harpPedalTextDiagramFrameFgColor,      "harpPedalTextDiagramFrameFgColor",      PropertyValue::fromValue(draw::Color::black) },
