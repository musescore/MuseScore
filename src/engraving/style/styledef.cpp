...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    ...
    styleDef(tabFretNumberFrameType,                     int(BorderType::NO_BORDER)),
    ...
    styleDef(hammerOnPullOffTappingFrameType,                         int(BorderType::NO_BORDER)),
    ...
    styleDef(frameBorderType,                            int(BorderType::NO_BORDER)),
    styleDef(frameBorderPadding,                         0.2),
    styleDef(frameBorderWidth,                           0.1),
    styleDef(frameBorderRound,                           0),
    styleDef(frameBorderFgColor,                         PropertyValue::fromValue(Color::BLACK)),
    styleDef(frameBorderBgColor,                         PropertyValue::fromValue(Color::transparent)),
