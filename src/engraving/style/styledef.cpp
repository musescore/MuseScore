...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    ...
    styleDef(footnoteFontFace,                           "Edwin"),
    styleDef(footnoteFontSize,                           10.0),
    styleDef(footnoteLineSpacing,                        1.0),
    styleDef(footnoteFontSpatiumDependent,               true),
    styleDef(footnoteFontStyle,                          int(FontStyle::Italic)),
    styleDef(footnoteColor,                              PropertyValue::fromValue(Color::BLACK)),
    styleDef(footnoteAlign,                              Align(AlignH::LEFT, AlignV::BASELINE)),
    styleDef(footnotePlacement,                          PlacementV::BELOW),
    styleDef(footnoteOffset,                             PointF(.0, 2.5)),
    styleDef(footnotePosAbove,                           PointF(.0, -1.5)),
    styleDef(footnotePosBelow,                           PointF(.0, 2.5)),
    styleDef(footnoteFrameType,                          int(FrameType::NO_FRAME)),
    styleDef(footnoteFramePadding,                       0.2),
    styleDef(footnoteFrameWidth,                         0.1),
    styleDef(footnoteFrameRound,                         0),
    styleDef(footnoteFrameFgColor,                       PropertyValue::fromValue(Color::BLACK)),
    styleDef(footnoteFrameBgColor,                       PropertyValue::fromValue(Color::transparent)),
    styleDef(footnoteMinDistance,                        Spatium(.5)),
