...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    ...
    styleDef(organPedalMarkFontFace,                     "Edwin"),
    styleDef(organPedalMarkFontSize,                     20.0),
    styleDef(organPedalMarkLineSpacing,                  1.0),
    styleDef(organPedalMarkFontSpatiumDependent,         true),
    styleDef(organPedalMarkFontStyle,                    int(FontStyle::Normal)),
    styleDef(organPedalMarkColor,                        PropertyValue::fromValue(Color::BLACK)),
    styleDef(organPedalMarkAlign,                        Align(AlignH::HCENTER, AlignV::VCENTER)),
    styleDef(organPedalMarkFrameType,                    int(FrameType::NO_FRAME)),
    styleDef(organPedalMarkFramePadding,                 0.2_sp),
    styleDef(organPedalMarkFrameWidth,                   0.1_sp),
    styleDef(organPedalMarkFrameRound,                   0.0_sp),
    styleDef(organPedalMarkFrameFgColor,                 PropertyValue::fromValue(Color::BLACK)),
    styleDef(organPedalMarkFrameBgColor,                 PropertyValue::fromValue(Color::transparent)),
    styleDef(organPedalMarkOffset,                       PointF()),
    styleDef(organPedalMarkPosition,                     AlignH::HCENTER),
    ...
    styleDef(organPedalMarkPlacement,                    PlacementV::ABOVE),

    styleDef(articulationMinDistance,                    0.4_sp),
    styleDef(fingeringMinDistance,                       0.5_sp),
    styleDef(organPedalMarkMinDistance,                  0.5_sp),
    ...
    styleDef(organPedalMarkMusicalSymbolSize,                     18.0),
