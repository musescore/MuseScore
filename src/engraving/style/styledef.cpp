...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    ...
    styleDef(gradualTempoChangeBeginArrowHeight,         1.0_sp),
    styleDef(gradualTempoChangeBeginArrowWidth,          1.0_sp),
    styleDef(gradualTempoChangeEndArrowHeight,           1.0_sp),
    styleDef(gradualTempoChangeEndArrowWidth,            1.0_sp),
    styleDef(hairpinBeginArrowHeight,                    1.0_sp),
    styleDef(hairpinBeginArrowWidth,                     1.0_sp),
    styleDef(hairpinEndArrowHeight,                      1.0_sp),
    styleDef(hairpinEndArrowWidth,                       1.0_sp),
    styleDef(noteLineBeginArrowHeight,                   1.0_sp),
    styleDef(noteLineBeginArrowWidth,                    1.0_sp),
    styleDef(noteLineEndArrowHeight,                     1.0_sp),
    styleDef(noteLineEndArrowWidth,                      1.0_sp),
    styleDef(ottavaBeginArrowHeight,                     1.0_sp),
    styleDef(ottavaBeginArrowWidth,                      1.0_sp),
    styleDef(ottavaEndArrowHeight,                       1.0_sp),
    styleDef(ottavaEndArrowWidth,                        1.0_sp),
    styleDef(pedalBeginArrowHeight,                      1.0_sp),
    styleDef(pedalBeginArrowWidth,                       1.0_sp),
    styleDef(pedalEndArrowHeight,                        1.0_sp),
    styleDef(pedalEndArrowWidth,                         1.0_sp),
    styleDef(textLineBeginArrowHeight,                   1.0_sp),
    styleDef(textLineBeginArrowWidth,                    1.0_sp),
    styleDef(textLineEndArrowHeight,                     1.0_sp),
    styleDef(textLineEndArrowWidth,                      1.0_sp),
    styleDef(voltaBeginArrowHeight,                      1.0_sp),
    styleDef(voltaBeginArrowWidth,                       1.0_sp),
    styleDef(voltaEndArrowHeight,                        1.0_sp),
    styleDef(voltaEndArrowWidth,                         1.0_sp),
} };
