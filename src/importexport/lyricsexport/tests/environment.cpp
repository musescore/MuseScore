...
static muse::testing::SuiteEnvironment importexport_se(
{
    ...
    new mu::iex::lrcexport::LyricsExportModule()
},
    nullptr,
    []() {
    LOGI() << "lyrics export tests suite post init";

    mu::engraving::ScoreRW::setRootPath(muse::String::fromUtf8(iex_lyricsexport_tests_DATA_ROOT));
