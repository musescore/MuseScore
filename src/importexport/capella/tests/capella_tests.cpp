...
//   TEST_F(Capella_Tests, capxTest7) { capxReadTest("test7"); } // wrong cap xml ( element double close (<head pitch="E5"/> </head>) )  // double bar missing (auto-generated by Capella programs)
...
//TEST_F(Capella_Tests, capxTestBarline) { capxReadTest("testBarline"); }
