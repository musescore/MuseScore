...
TEST_F(GuitarPro_Tests, gpHideRestsSingleVoice) {
    gpReadTest("hide_rests_single_voice", "gp");
}
TEST_F(GuitarPro_Tests, gpHideRestsMultiVoice) {
    gpReadTest("hide_rests_multi_voice", "gp");
}
