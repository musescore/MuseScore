...
public:
    ...
    void setSection(std::pair<mu::String, mu::String>&& s) { _section.swap(s); }
    const std::pair<mu::String, mu::String>& section() const { return _section; }
...
private:
    ...
    std::pair<mu::String, mu::String> _section;
