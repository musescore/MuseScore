...
private:
    ...
    bool readBeam(pugi::xml_node beamNode, engraving::Measure* measure, int track, Fraction& ticks);
    bool readBTrem(pugi::xml_node bTremNode, engraving::Measure* measure, int track, Fraction& ticks);
    bool readClef(pugi::xml_node clefNode, engraving::Measure* measure, int track, Fraction& ticks);
    bool readChord(pugi::xml_node chordNode, engraving::Measure* measure, int track, Fraction& ticks);
    bool readFTrem(pugi::xml_node fTremNode, engraving::Measure* measure, int track, Fraction& ticks);
    bool readGraceGrp(pugi::xml_node graceGrpNode, engraving::Measure* measure, int track, Fraction& ticks);
    bool readMRest(pugi::xml_node mRestNode, engraving::Measure* measure, int track, Fraction& ticks);
    bool readMRpt(pugi::xml_node mRptNode, engraving::Measure* measure, int track, Fraction& ticks);
    bool readNote(pugi::xml_node noteNode, engraving::Measure* measure, int track, Fraction& ticks, engraving::Chord* chord = nullptr);
    bool readRest(pugi::xml_node restNode, engraving::Measure* measure, int track, Fraction& ticks);
    bool readSpace(pugi::xml_node spaceNode, engraving::Measure* measure, int track, Fraction& ticks);
