...
private:
    ...
    void importMarkings(const mnx::sequence::Event& mnxEvent, engraving::ChordRest* cr, engraving::Measure* measure = nullptr);
    ...
    void importBreath(const mnx::sequence::BreathMark& breath, engraving::ChordRest* cr, engraving::Measure* measure = nullptr);
