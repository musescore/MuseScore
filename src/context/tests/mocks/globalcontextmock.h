...
{
public:
    MOCK_METHOD(void, setCurrentProject, (const mu::project::INotationProjectPtr&), (override));
    MOCK_METHOD(mu::project::INotationProjectPtr, currentProject, (), (const, override));
    MOCK_METHOD(muse::async::Notification, currentProjectChanged, (), (const, override));

    MOCK_METHOD(mu::notation::IMasterNotationPtr, currentMasterNotation, (), (const, override));
    MOCK_METHOD(muse::async::Notification, currentMasterNotationChanged, (), (const, override));

    MOCK_METHOD(void, setCurrentNotation, (const mu::notation::INotationPtr&), (override));
    MOCK_METHOD(mu::notation::INotationPtr, currentNotation, (), (const, override));
