...
const UiActionList NotationUiActions::s_actions = {
    ...
    UiAction("add-organ-pedal-mark",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_OPENED,
             TranslatableString("action", "Or&gan pedal mark"),
             TranslatableString("action", "Add organ pedal mark")
             ),
    UiAction("organ-pedal-mark-toe-2",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_ORGAN_PEDAL_MARKS_INTERACTION,
             TranslatableString("action", "Organ pedal mark: Toe 2"),
             TranslatableString("action", "Change organ pedal mark to: Toe 2")
             ),
    UiAction("organ-pedal-mark-heel-1",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_ORGAN_PEDAL_MARKS_INTERACTION,
             TranslatableString("action", "Organ pedal mark: Heel 1"),
             TranslatableString("action", "Change organ pedal mark to: Heel 1")
             ),
    UiAction("organ-pedal-mark-heel-3",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_ORGAN_PEDAL_MARKS_INTERACTION,
             TranslatableString("action", "Organ pedal mark: Heel 3"),
             TranslatableString("action", "Change organ pedal mark to: Heel 3")
             ),
    UiAction("organ-pedal-mark-toe-1",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_ORGAN_PEDAL_MARKS_INTERACTION,
             TranslatableString("action", "Organ pedal mark: Toe 1"),
             TranslatableString("action", "Change organ pedal mark to: Toe 1")
             ),
    UiAction("organ-pedal-mark-heel-2",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_ORGAN_PEDAL_MARKS_INTERACTION,
             TranslatableString("action", "Organ pedal mark: Heel 2"),
             TranslatableString("action", "Change organ pedal mark to: Heel 2")
             ),
    UiAction("previous-organ-pedal-mark",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_ORGAN_PEDAL_MARKS_INTERACTION,
             TranslatableString("action", "Previous organ pedal mark"),
             TranslatableString("action", "Go to previous organ pedal mark")
             ),
    UiAction("next-organ-pedal-mark",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_ORGAN_PEDAL_MARKS_INTERACTION,
             TranslatableString("action", "Next organ pedal mark"),
             TranslatableString("action", "Go to next organ pedal mark")
             ),
    UiAction("previous-organ-pedal-mark-skip",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_ORGAN_PEDAL_MARKS_INTERACTION,
             TranslatableString("action", "Previous organ pedal mark skip"),
             TranslatableString("action", "Go to previous organ pedal mark and skip current note")
             ),
    UiAction("next-organ-pedal-mark-skip",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_ORGAN_PEDAL_MARKS_INTERACTION,
             TranslatableString("action", "Next organ pedal mark skip"),
             TranslatableString("action", "Go to next organ pedal mark and skip current note")
             ),
    UiAction("tempo",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_OPENED,
