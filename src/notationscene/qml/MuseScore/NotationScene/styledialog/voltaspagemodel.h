...
class VoltasPageModel : public AbstractStyleDialogModel
{
    ...
    Q_PROPERTY(mu::notation::StyleItem * voltaPosAbove READ voltaPosAbove CONSTANT)
    Q_PROPERTY(mu::notation::StyleItem * voltaHook READ voltaHook CONSTANT)
    Q_PROPERTY(mu::notation::StyleItem * voltaLineWidth READ voltaLineWidth CONSTANT)
    Q_PROPERTY(mu::notation::StyleItem * voltaLineStyle READ voltaLineStyle CONSTANT)
