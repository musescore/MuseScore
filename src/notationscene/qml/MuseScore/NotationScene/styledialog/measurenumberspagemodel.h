...
class MeasureNumbersPageModel : public AbstractStyleDialogModel
{
    ...
    Q_PROPERTY(
        mu::notation::StyleItem * measureNumberPosAbove READ measureNumberPosAbove NOTIFY measureNumberPosAboveChanged FINAL)
    Q_PROPERTY(
        mu::notation::StyleItem * measureNumberPosBelow READ measureNumberPosBelow NOTIFY measureNumberPosBelowChanged FINAL)
