...
public:
    ...
    muse::async::Notification articulationDoublingChanged() const override;
    bool articulationDoubling() const override;
    void setArticulationDoubling(const bool enabled) override;
...
private:
    ...
    muse::async::Notification m_articulationDoublingChanged;
};
}
