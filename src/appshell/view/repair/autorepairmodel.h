 ...
 */
#ifndef MU_APPSHELL_AUTOREPAIRMODEL_H
#define MU_APPSHELL_AUTOREPAIRMODEL_H
...
class AutoRepairModel : public QObject, public muse::Injectable, public muse::async::Asyncable
{
    Q_OBJECT
...
public:
    explicit AutoRepairModel(QObject* parent = nullptr);
...
#endif // MU_APPSHELL_AUTOREPAIRMODEL_H
