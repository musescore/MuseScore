 ...
 */
#ifndef MU_APPSHELL_REPAIRMODEL_H
#define MU_APPSHELL_REPAIRMODEL_H
...
class RepairModel : public QAbstractItemModel, public muse::Injectable
{
    Q_OBJECT
...
#endif // MU_APPSHELL_REPAIRMODEL_H
