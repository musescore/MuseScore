...
{
    QVariantMap item1;
    item1.insert("title", muse::qtrc("appshell/welcome", "Install our free MuseSounds libraries"));
    item1.insert("imageUrl", "qrc:/resources/welcomedialog/MuseSounds.png");
    ...
    item1.insert("buttonText", muse::qtrc("appshell/welcome", "Get it on MuseHub"));
    ...
    item2.insert("destinationUrl", "https://www.youtube.com/watch?v=-I-InDHIzdQ"); // TODO: Placeholder (4.6 video does not exist yet)
...
void StartupScenario::onStartupPageOpened(StartupModeType modeType)
{
    ...
    //! NOTE: The welcome dialog should not show if the first launch setup has not been completed, or if we're
    //! going to show a MuseSounds update dialog (see ProjectActionsController::doFinishOpenProject).
