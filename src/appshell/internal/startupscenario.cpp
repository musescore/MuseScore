...
muse::async::Promise<muse::Ret> StartupScenario::runOnSplashScreen()
{
    return async::make_promise<Ret>([this](auto resolve, auto) {
        ...
        const bool canCheckMuseSamplerUpdate = museSamplerCheckForUpdateScenario() && !museSamplerCheckForUpdateScenario()->alreadyChecked();
        ...
        async::Async::call(this, [this, onUpdateCheckCompleted, canCheckAppUpdate, canCheckMuseSoundsUpdate, canCheckMuseSamplerUpdate]() {
            if (canCheckAppUpdate) {
            ...
            if (canCheckMuseSamplerUpdate) {
                muse::async::Promise<Ret> promise = museSamplerCheckForUpdateScenario()->checkForUpdate();
                promise.onResolve(this, [onUpdateCheckCompleted](Ret) {
                    onUpdateCheckCompleted();
                });
            }
...
void StartupScenario::onStartupPageOpened(StartupModeType modeType)
{
    ...
    if (showMuseSamplerUpdateDialog) {
