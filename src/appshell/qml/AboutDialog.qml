        ...
        ColumnLayout {
            ...
            StyledTextLabel {
                ...
                text: {
                    ...
                    let line1 = qsTrc("appshell", "Visit %1 for new versions and more information.")
                                .arg(`<a href="${museScoreUrl.url}">${museScoreUrl.displayName}</a>`)

                    //: The text between %1 and %2 will be a clickable link (same for %3 and %4)
                    let line2 = qsTrc("appshell", "Get %1help%2 with the program or %3contribute%4 to its development.")
            ...
            StyledTextLabel {
                ...
                text: qsTrc("appshell", "For privacy information, see our %1privacy policy%2.")
