...
DockPage {
    ...
    //! NOTE: Value found experimentally - see issue #27770
    readonly property int maximumPanelDimension: 7500
    ...
    panels: [
        DockPanel {
            ...
            maximumHeight: root.maximumPanelDimension
        ...
        DockPanel {
            ...
            maximumWidth: root.maximumPanelDimension
