...
StyledDialogView { //TODO: navigation
    id: root

    title: qsTrc("appshell", "Welcome")
    ...
    Column {
        ...
        Column {
            ...
            StyledTextLabel {
                ...
                text: model.currentItem ? model.currentItem.title : ""
            ...
            StyledTextLabel {
                ...
                text: model.currentItem ? model.currentItem.description : ""
    ...
    Rectangle {
        ...
        CheckBox {
            ...
            text: qsTrc("appshell", "Don’t show welcome dialog on startup")
