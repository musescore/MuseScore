...
BaseSection {
    ...
    title: qsTrc("preferences", "MusicXML")
    ...
    CheckBox {
        ...
        text: qsTrc("preferences", "Import layout")
    ...
    CheckBox {
        ...
        text: qsTrc("preferences", "Import system and page breaks")
    ...
    CheckBox {
        ...
        text: qsTrc("preferences", "Apply default typeface (Edwin) to imported scores")
    ...
    CheckBox {
        ...
        text: qsTrc("preferences", "Infer text type based on content where possible")
