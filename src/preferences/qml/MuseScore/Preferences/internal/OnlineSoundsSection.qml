...
BaseSection {
    ...
    title: qsTrc("preferences", "Online sounds")
    ...
    Column {
        ...
        CheckBox {
            ...
            text: qsTrc("preferences", "Show error dialog when online sounds cannot be processed")
        ...
        CheckBox {
            ...
            text: qsTrc("preferences", "Automatically process online sounds in the background")
        ...
        Row {
            ...
            StyledTextLabel {
                ...
                text: qsTrc("preferences", "To process online sounds, press ‘Process online sounds’ in the status bar at the bottom of the app window")
            }
        }
    }
    ...
    ComboBoxWithTitle {
        ...
        model: {
            ...
            if (root.autoProcessOnlineSoundsInBackground) {
                options.push({ text: qsTrc("preferences", "Only if processing is unfinished during playback"), value: 1 })
            }

            options.push({ text: qsTrc("preferences", "Never"), value: 2 })
