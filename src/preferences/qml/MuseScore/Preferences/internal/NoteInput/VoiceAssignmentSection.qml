...
BaseSection {
    ...
    title: qsTrc("preferences", "Voice assignment")

    StyledTextLabel {
        width: parent.width
        text: qsTrc("preferences", "When entered, dynamics and hairpins should affect")
    ...
    RoundedRadioButton {
        ...
        text: qsTrc("preferences", "All voices on the instrument")
    ...
    RoundedRadioButton {
        ...
        text: qsTrc("preferences", "Only the voice they are applied to")
