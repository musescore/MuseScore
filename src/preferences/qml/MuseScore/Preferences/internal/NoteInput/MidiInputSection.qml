...
BaseSection {
    ...
    title: qsTrc("preferences", "MIDI devices")
    ...
    ToggleButton {
        ...
        text: qsTrc("preferences", "Enable MIDI input")
    ...
    CheckBox {
        ...
        text: qsTrc("preferences", "When pressing a key, begin note input at the selected measure, note, or rest")
    ...
    ExpandableBlank {
        ...
        enabled: root.midiInputEnabled
        title: qsTrc("preferences", "Real-time input modes")
        isExpanded: false
        ...
        contentItemComponent: Column {
            ...
            CheckBox {
                ...
                enabled: root.midiInputEnabled
                text: qsTrc("preferences", "Advance to next note on key release")
            ...
            IncrementalPropertyControlWithTitle {
                ...
                enabled: root.midiInputEnabled
                title: qsTrc("preferences", "Delay between notes")
