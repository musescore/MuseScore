...
BaseSection {
    ...
    title: qsTrc("preferences", "Note preview")

    ToggleButton {
        id: playNotesToggle
        width: parent.width

        text: qsTrc("preferences", "Hear playback when adding, editing, and selecting notes")
    ...
    IncrementalPropertyControlWithTitle {
        ...
        title: qsTrc("preferences", "Playback duration")
    ...
    CheckBox {
        ...
        text: qsTrc("preferences", "Play chord when editing")
    ...
    CheckBox {
        ...
        text: qsTrc("preferences", "Play chord symbols and Nashville numbers")
    ...
    CheckBox {
        ...
        text: qsTrc("preferences", "Play when setting pitch (input by duration mode only)")
    ...
    CheckBox {
        ...
        text: qsTrc("preferences", "Play preview notes with score dynamics")
    ...
    CheckBox {
        ...
        text: qsTrc("preferences", "Play MIDI input")
    ...
    CheckBox {
        ...
        text: qsTrc("preferences", "Play MIDI notes with velocity and duration during note input")
