...
BaseSection {
    ...
    title: qsTrc("preferences", "Note colors")

    CheckBox {
        id: colorNotesBox
        width: parent.width

        text: qsTrc("preferences", "Color notes outside of usable pitch range")
    ...
    CheckBox {
        ...
        text: qsTrc("preferences", "Color guitar bends and hammer-ons/pull-offs outside of playable range")
