...
QVariantList GeneralPreferencesModel::startupModes() const
{
    const QVariantList result {
        QVariantMap {
            { "title", muse::qtrc("preferences", "Start empty") },
            { "value", static_cast<int>(appshell::StartupModeType::StartEmpty) },
        },
        QVariantMap {
            { "title", muse::qtrc("preferences", "Continue last session") },
            { "value", static_cast<int>(appshell::StartupModeType::ContinueLastSession) },
        },
        QVariantMap {
            { "title", muse::qtrc("preferences", "Start with new score") },
            { "value", static_cast<int>(appshell::StartupModeType::StartWithNewScore) },
        },
        QVariantMap {
            { "title", muse::qtrc("preferences", "Start with score") },
            { "value", static_cast<int>(appshell::StartupModeType::StartWithScore) },
...
void GeneralPreferencesModel::setCurrentStartupMode(int modeIndex)
{
    ...
    appshell::StartupModeType selectedType = static_cast<appshell::StartupModeType>(modeIndex);
