...
protected:
    ...
    bool isIndeterminate(const SelectionFilterTypesVariant& variant) const override;

    void notifyAboutDataChanged(const QModelIndex& index, const SelectionFilterTypesVariant& variant) override;
};
}
