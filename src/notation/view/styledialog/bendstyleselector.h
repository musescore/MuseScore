...
class BendStyleSelector : public AbstractStyleDialogModel
{
    Q_OBJECT

    Q_PROPERTY(StyleItem * useFull READ useFull CONSTANT)

public:
    explicit BendStyleSelector(QObject* parent = nullptr);
