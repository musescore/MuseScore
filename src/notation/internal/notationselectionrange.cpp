...
mu::engraving::HBox* NotationSelectionRange::rangeStartHBox() const
{
    return score()->selection().startHBox();
}
...
mu::engraving::HBox* NotationSelectionRange::rangeEndHBox() const
{
    return score()->selection().endHBox();
}
