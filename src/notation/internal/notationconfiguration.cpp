...
static const std::string BY_PITCH_INPUT_METHOD("BY_PITCH");

static const std::map<NoteInputMethod, std::string> NOTE_INPUT_METHOD_TO_STR {
    { NoteInputMethod::BY_PITCH, BY_PITCH_INPUT_METHOD },
...
void NotationConfiguration::init()
{
    ...
    settings()->setDefaultValue(DEFAULT_NOTE_INPUT_METHOD, Val(BY_PITCH_INPUT_METHOD));
...
NoteInputMethod NotationConfiguration::defaultNoteInputMethod() const
{
    ...
    return muse::key(NOTE_INPUT_METHOD_TO_STR, str, NoteInputMethod::BY_PITCH);
}
