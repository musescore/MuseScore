...
void NotationConfiguration::init()
{
    ...
    settings()->setDefaultValue(FIRST_SCORE_ORDER_LIST_KEY, Val(":/notation/instruments/orders.xml"));
...
{
    return ":/notation/instruments/instruments.xml";
}
...
{
    return ":/notation/instruments/string_tunings_presets.json";
}
