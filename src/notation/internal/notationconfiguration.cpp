...
void NotationConfiguration::init()
{
    ...
    settings()->setDefaultValue(FIRST_SCORE_ORDER_LIST_KEY, Val(":/data/instruments/orders.xml"));
...
{
    return ":/data/instruments/instruments.xml";
}
...
{
    return ":/data/instruments/string_tunings_presets.json";
}
