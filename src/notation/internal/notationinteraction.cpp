...
{
    if (shouldDrawDurationInputPreview()) {
        drawDurationInputPreview(painter);
    }
...
bool NotationInteraction::shouldDrawDurationInputPreview() const
{
    return m_noteInput->isNoteInputMode() && m_noteInput->usingNoteInputMethod(NoteInputMethod::BY_DURATION);
}

void NotationInteraction::drawDurationInputPreview(Painter* painter)
{
