...
const UiActionList NotationUiActions::m_actions = {
    ...
    UiAction("note-input-by-pitch",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_OPENED,
             TranslatableString("action", "Input by pitch"),
             TranslatableString("action", "Toggle note input mode: input by pitch"),
             IconCode::Code::EDIT
             ),
