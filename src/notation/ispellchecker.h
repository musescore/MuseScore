 ...
 */
#ifndef MU_NOTATION_ISPELLCHECKER_H
#define MU_NOTATION_ISPELLCHECKER_H
...
class ISpellChecker : MODULE_EXPORT_INTERFACE
{
    INTERFACE_ID(ISpellChecker)
...
#endif // MU_NOTATION_ISPELLCHECKER_H
