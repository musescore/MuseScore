...
FocusableItem {
    ...
    Column {
        ...
        FlatRadioButtonGroupPropertyView {
            ...
            model: [
                { iconCode: IconCode.NOTE_HEAD, value: NoteHead.NONE, title: qsTrc("inspector", "Normal notehead") },
                { iconCode: IconCode.NOTE_HEAD_PARENTHESES, value: NoteHead.BOTH, title: qsTrc("inspector", "Notehead with parentheses") }
            ]
        }
