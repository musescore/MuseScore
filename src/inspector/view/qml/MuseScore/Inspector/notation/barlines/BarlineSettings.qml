...
Column {
    ...
    DropdownPropertyView {
        ...
        model: [
            ...
            { text: qsTrc("inspector", "Start repeat barline"), value: BarlineTypes.TYPE_START_REPEAT },
            { text: qsTrc("inspector", "End repeat barline"), value: BarlineTypes.TYPE_END_REPEAT },
            { text: qsTrc("inspector", "End start repeat barline"), value: BarlineTypes.TYPE_END_START_REPEAT }
        ]
    }
    ...
    TextSection {
        ...
        visible: root.model && root.model.playCountTextSetting.value && root.model.showPlayCountSettings
