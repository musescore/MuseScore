#ifndef CHORDSYMBOLSPLAYBACKMODEL_H
#define CHORDSYMBOLSPLAYBACKMODEL_H

#include "models/abstractinspectormodel.h"

namespace mu::inspector {
class ChordSymbolsPlaybackModel : public AbstractInspectorModel
{
    Q_OBJECT
...
public:
    ChordSymbolsPlaybackModel(QObject* parent, IElementRepositoryService* repository);
...
#endif // CHORDSYMBOLSPLAYBACKMODEL_H
