...
QVariantList NoteheadSettingsModel::possibleHeadSystemTypes() const
{
    QMap<mu::engraving::NoteHeadScheme, QString> types {
        ...
        { mu::engraving::NoteHeadScheme::HEAD_PITCHNAME_NO_ACCIDENTALS, muse::qtrc("inspector", "Pitch names, no accidentals",
                                                                                   "notehead scheme") },
        { mu::engraving::NoteHeadScheme::HEAD_PITCHNAME_GERMAN,        muse::qtrc("inspector", "German pitch names", "notehead scheme") },
        { mu::engraving::NoteHeadScheme::HEAD_PITCHNAME_GERMAN_NO_ACCIDENTALS, muse::qtrc("inspector", "German pitch names, no accidentals",
                                                                                          "notehead scheme") },
