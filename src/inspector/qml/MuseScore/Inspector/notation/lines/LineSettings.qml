    ...
    StackLayout {
        ...
        Loader {
            ...
            sourceComponent: {
                ...
                switch (modelType) {
                case AbstractInspectorModel.TYPE_VOLTA: return voltaStyleSettings
                case AbstractInspectorModel.TYPE_OTTAVA: return ottavaStyleSettings
                case AbstractInspectorModel.TYPE_PEDAL: return pedalStyleSettings
                }
