...
void TestStringUtils::tst_stringutils()
      {
      QString testNormal("Test test");
      QVERIFY(stringutils::removeDiacritics(testNormal) == testNormal);
      QVERIFY(stringutils::removeLigatures(testNormal) == testNormal);
      ...
      QVERIFY(stringutils::removeLigatures(testLigatures) == QString("AAaaAEAEaeaeAOaoAUauIJijssOoOEOEoeoeOOooUEueue"));
