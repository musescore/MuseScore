...
set SRC=mmrest-1,bravura-mmrest,gonville-mmrest,jazzy-mmrest,mmrest-2,mmrest-4,mmrest-5,mmrest-6,mmrest-7,mmrest-8,mmrest-9, ^
 mmrest-10,fmrest-1,fmrest-2,fmrest-3,fmrest-4,fmrest-5,fmrest-6,measure-repeat-1, ^
 noteheadposition-1,valign-1,valign-2,valign-3,emmentaler-1,bravura-1,gonville-1,jazzy-1,emmentaler-2,bravura-2,gonville-2,jazzy-2, ^
 emmentaler-3,bravura-3,gonville-3,jazzy-3,emmentaler-4,bravura-4,gonville-4,jazzy-4,emmentaler-5,bravura-5,gonville-5,jazzy-5, ^
 emmentaler-6,bravura-6,gonville-6,jazzy-6,emmentaler-7,bravura-7,gonville-7,jazzy-7, ^
 emmentaler-8,bravura-8,gonville-8,jazzy-8,emmentaler-9,bravura-9,gonville-9,jazzy-9, ^
 emmentaler-10,bravura-10,gonville-10,jazzy-10,emmentaler-11,bravura-11,gonville-11,jazzy-11, ^
 emmentaler-text-1,gonville-text-1,bravura-text-1,musejazz-text-1,jazzy-text-1, ^
 emmentaler-text-2,gonville-text-2,bravura-text-2,musejazz-text-2,jazzy-text-2, ^
 emmentaler-text-3,gonville-text-3,bravura-text-3,musejazz-text-3,jazzy-text-3, ^
