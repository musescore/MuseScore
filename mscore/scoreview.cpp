...
void ScoreView::paintEvent(QPaintEvent* ev)
      ...
      if (aGrip.grips) {
            if (aGrip.grips == 6) {       // HACK: this are grips of a slur
                  ...
                  polygon[0] = QPointF(aGrip.grip[int(GripSlurSegment::START)].center());
                  polygon[1] = QPointF(aGrip.grip[int(GripSlurSegment::BEZIER1)].center());
                  polygon[2] = QPointF(aGrip.grip[int(GripSlurSegment::SHOULDER)].center());
                  polygon[3] = QPointF(aGrip.grip[int(GripSlurSegment::BEZIER2)].center());
                  polygon[4] = QPointF(aGrip.grip[int(GripSlurSegment::END)].center());
                  polygon[5] = QPointF(aGrip.grip[int(GripSlurSegment::DRAG)].center());
                  polygon[6] = QPointF(aGrip.grip[int(GripSlurSegment::START)].center());
