...
InspectorImage::InspectorImage(QWidget* parent)
   : InspectorElementBase(parent)
      ...
      const std::vector<InspectorItem> iiList = {
            { P_ID::AUTOSCALE,         0, 0, b.autoscale,       b.resetAutoscale       },
            { P_ID::SIZE,              0, 0, b.size,            b.resetSize            },
            { P_ID::LOCK_ASPECT_RATIO, 0, 0, b.lockAspectRatio, b.resetLockAspectRatio },
            { P_ID::SIZE_IS_SPATIUM,   0, 0, b.sizeIsSpatium,   b.resetSizeIsSpatium   }
            };
