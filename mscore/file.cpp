...
//TODO      score->lastMeasure()->setEndBarLineType(BarLineType::END, false);
      ...
      if (!title.isEmpty() || !subtitle.isEmpty() || !composer.isEmpty() || !poet.isEmpty()) {
            ...
            if (!translator.isEmpty()) {
                  Text* s = new Text(SubStyleId::TRANSLATOR, score);
      ...
      if (preferences.getBool(PREF_SCORE_WORKNUMBER_TRACK))
            preferences.setPreference(PREF_SCORE_WORKNUMBER_CURRENTNUMBER,
                                      preferences.getInt(PREF_SCORE_WORKNUMBER_CURRENTNUMBER) + 1);
