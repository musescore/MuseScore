            ...
            if (!svgFile.isEmpty()) {
                  ...
                  if (mode == QIcon::Disabled) {
                        if (Ms::preferences.globalStyle == Ms::MuseScoreStyleType::LIGHT) {
                              if (state == QIcon::On)
                                    ba.replace("fill:#373b41", "fill:#8daac7");
                              else
                                    ba.replace("fill:#373b41", "fill:#a0a0a0");
                              }
                        else {
                              if (state == QIcon::On)
                                    ba.replace("fill:#373b41", "fill:#4171a2");
			      else
                                    ba.replace("fill:#373b41", "fill:#a0a0a0");
                              }
                        }
                        ...
                        if (Ms::preferences.globalStyle == Ms::MuseScoreStyleType::LIGHT) {
                              ...
                              if (state == QIcon::On)
                                    ba.replace("fill:#373b41", "fill:#78afe6");
			      else
				    ba.replace("fill:#373b41", "fill:#eff0f1");
                              }
                        }
                  renderer->load(ba);
                  }
