...
void MuseScore::askResetOldScorePositions(Score* score)
      ...
      if (score->mscVersion() < 300) {
            ...
            if (resPref == "No")
                  ...
                  msgBox.setText(tr("To best take advantage of automatic placement in MuseScore 4 when importing '%1' from MuseScore %2, it is recommended to reset the positions of all elements.")
