...
if(EXISTS ${SF_VERSION_REMOTE_FILE} AND SF_VERSION_DL_STATUS EQUAL 0)
  ...
  if (DO_DOWNLOAD)
    ...
    file(DOWNLOAD "${DOWNLOAD_URL_ROOT}/MS_Basic_Changelog.md" "${SOUND_DIRECTORY}/MS Basic_Changelog.md" STATUS SF_CHANGELOG_DL_STATUS)
    list(GET SF_CHANGELOG_DL_STATUS 0 CHANGELOG_HTTP_STATUS)
    if (NOT CHANGELOG_HTTP_STATUS EQUAL 0)
      list(GET SF_CHANGELOG_DL_STATUS 1 CHANGELOG_HTTP_STATUS_TEXT)
      message(WARNING "Cannot download soundfont changelog. Error: ${CHANGELOG_HTTP_STATUS_TEXT}")
    endif()

    file(DOWNLOAD "${DOWNLOAD_URL_ROOT}/MS_Basic_Readme.md" "${SOUND_DIRECTORY}/MS Basic_Readme.md" STATUS SF_README_DL_STATUS)
    list(GET SF_README_DL_STATUS 0 README_HTTP_STATUS)
    if (NOT README_HTTP_STATUS EQUAL 0)
      list(GET SF_README_DL_STATUS 1 README_HTTP_STATUS_TEXT)
      message(WARNING "Cannot download soundfont readme. Error: ${README_HTTP_STATUS_TEXT}")
    endif()
