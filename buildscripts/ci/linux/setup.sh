...
if [[ ! -d "${qt_dir}" ]]; then
  mkdir -p "${qt_dir}"
  qt_url="https://github.com/cbjeukendrup/musescore_build_qt/releases/download/Qt-${qt_version}-491b27cc6fa2d9b8cc0b37cdb4cd2b9eae6dea57/Qt-${qt_version}-Linux-amd64.zip"
