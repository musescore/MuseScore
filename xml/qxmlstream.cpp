...
// no XmlStream* symbols to keep compatibility with
...
/*!  If the state() is \l StartElement, this function returns the
  ...
  The XmlStreamNamespaceDeclaration class is defined to be a QVector
...
/*!\overload
  ...
  attribute is not defined. The \a namespaceUri can be empty.
 */
QStringRef XmlStreamAttributes::value(const QString &namespaceUri, const QLatin1String &name) const
{
    for (int i = 0; i < size(); ++i) {
        const XmlStreamAttribute &attribute = at(i);
        if (attribute.name() == name && attribute.namespaceUri() == namespaceUri)
...
/*!\overload
  ...
  attribute is not defined. The \a namespaceUri can be empty.
 */
QStringRef XmlStreamAttributes::value(const QLatin1String &namespaceUri, const QLatin1String &name) const
{
    for (int i = 0; i < size(); ++i) {
        const XmlStreamAttribute &attribute = at(i);
        if (attribute.name() == name && attribute.namespaceUri() == namespaceUri)
...
/*!\overload
  ...
  local name.
 */
QStringRef XmlStreamAttributes::value(const QLatin1String &qualifiedName) const
{
    for (int i = 0; i < size(); ++i) {
        const XmlStreamAttribute &attribute = at(i);
        if (attribute.qualifiedName() == qualifiedName)
...
/*!
 ...
 Returns true if this XmlStreamAttributes has an attribute whose
...
/*!
 \fn bool XmlStreamAttributes::hasAttribute(const QLatin1String &qualifiedName) const
 \overload
 \since 4.5
*/
