...
{
    switch (idx) {
    case RMS_PEAK:  setRmsPeak(value);
        break;
    case ATTACK:    setAttack(value);
        break;
    case RELEASE:   setRelease(value);
        break;
    case THRESHOLD: setThreshold(value);
        break;
    case RATIO:     setRatio(value);
        break;
    case KNEE:      setKnee(value);
        break;
    case GAIN:      setMakeupGain(value);
        break;
    }
}
...
double Compressor::nvalue(int idx) const
{
    double v = 0.0;
    switch (idx) {
    case RMS_PEAK:  v = rmsPeak();
        break;
    case ATTACK:    v = attack();
        break;
    case RELEASE:   v = release();
        break;
    case THRESHOLD: v = threshold();
        break;
    case RATIO:     v = ratio();
        break;
    case KNEE:      v = knee();
        break;
    case GAIN:      v = makeupGain();
        break;
    }
    return v;
}
